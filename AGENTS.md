...
- The vendor-default distribution exception covers only verified original archive contents, never keys or identities generated from installation/device hardware or activation state. Keep the project ownership/free-of-charge disclaimer in repository documentation, not application UI or prompts.
