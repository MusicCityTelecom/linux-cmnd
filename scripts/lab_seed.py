...
def build(directory: Path, public_key: Path):
...
"""
    metadata = 'instance-id: cmnd-qualification-20260908\nlocal-hostname: cmnd-qualification\n'
...
if __name__ == '__main__':
    ...
    build(args.directory, args.public_key)
