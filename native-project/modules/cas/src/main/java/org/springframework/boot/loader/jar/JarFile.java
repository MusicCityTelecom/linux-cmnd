...
public class JarFile extends AbstractJarFile implements Iterable<java.util.jar.JarEntry> {
   ...
   public Stream<java.util.jar.JarEntry> stream() {
      Spliterator<java.util.jar.JarEntry> spliterator = Spliterators.spliterator(this.iterator(), this.size(), 1297);
      return StreamSupport.stream(spliterator, false);
   }

   @Override
   public Iterator<java.util.jar.JarEntry> iterator() {
      return (Iterator<java.util.jar.JarEntry>) (Iterator<?>) this.entries.iterator(this::ensureOpen);
   }
