...
public class TpvRegexRegisteredService extends CasRegisteredService {
   ...
   public boolean checkLocalHostIpAddress(final String serviceId) {
      ...
      if (isContainsLocalhost) {
         ...
         if (requestAttrs != null) {
            ...
            boolean isValidRemoteAddress = StringUtils.equalsIgnoreCase("127.0.0.1", ipAddress)
               || StringUtils.equalsIgnoreCase("0:0:0:0:0:0:0:1", ipAddress)
               || StringUtils.equalsIgnoreCase("::1", ipAddress);
         ...
         this.logger.info("serviceid:{} not installed on localhost", serviceId);
      }
