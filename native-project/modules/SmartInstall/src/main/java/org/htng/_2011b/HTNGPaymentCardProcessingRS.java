...
public class HTNGPaymentCardProcessingRS {
   ...
   protected List<HTNGPaymentCardProcessingRS.Authorization> authorization;
   ...
   public List<HTNGPaymentCardProcessingRS.Authorization> getAuthorization() {
   ...
   public static class Authorization {
      ...
      protected HTNGPaymentCardProcessingRS.Authorization.AuthorizationResult authorizationResult;
      @XmlElement(name = "Warnings")
      protected WarningsType warnings;
      ...
      public HTNGPaymentCardProcessingRS.Authorization.AuthorizationResult getAuthorizationResult() {
         return this.authorizationResult;
      }

      public void setAuthorizationResult(HTNGPaymentCardProcessingRS.Authorization.AuthorizationResult value) {
