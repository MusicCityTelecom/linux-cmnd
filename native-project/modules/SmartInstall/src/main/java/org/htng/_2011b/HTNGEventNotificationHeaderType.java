...
public class HTNGEventNotificationHeaderType {
   ...
   protected HTNGEventNotificationHeaderType.SubscriptionProducerMessages subscriptionProducerMessages;
   ...
   public HTNGEventNotificationHeaderType.SubscriptionProducerMessages getSubscriptionProducerMessages() {
      return this.subscriptionProducerMessages;
   }

   public void setSubscriptionProducerMessages(HTNGEventNotificationHeaderType.SubscriptionProducerMessages value) {
   ...
   public static class SubscriptionProducerMessages {
      ...
      public List<FreeTextType> getSubscriptionProducerMessage() {
         if (this.subscriptionProducerMessage == null) {
            this.subscriptionProducerMessage = new ArrayList<>();
         }
