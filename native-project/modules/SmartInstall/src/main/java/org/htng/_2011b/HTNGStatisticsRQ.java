...
public class HTNGStatisticsRQ {
   ...
   protected HTNGStatisticsRQ.Queries queries;
   ...
   public HTNGStatisticsRQ.Queries getQueries() {
      return this.queries;
   }

   public void setQueries(HTNGStatisticsRQ.Queries value) {
      this.queries = value;
   }
   ...
   public static class Queries {
      ...
      protected List<HTNGStatisticsRQ.Queries.Query> query;

      public List<HTNGStatisticsRQ.Queries.Query> getQuery() {
         if (this.query == null) {
      ...
      public static class Query {
         ...
         protected HTNGStatisticsRQ.Queries.Query.ResponseParameters responseParameters;
         ...
         public HTNGStatisticsRQ.Queries.Query.ResponseParameters getResponseParameters() {
            return this.responseParameters;
         }

         public void setResponseParameters(HTNGStatisticsRQ.Queries.Query.ResponseParameters value) {
