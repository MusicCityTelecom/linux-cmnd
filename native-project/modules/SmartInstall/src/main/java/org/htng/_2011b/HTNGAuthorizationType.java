...
public class HTNGAuthorizationType {
   ...
   protected HTNGAuthorizationType.CreditCardAuthorization creditCardAuthorization;
   @XmlElement(name = "BookingReferenceID")
   protected HTNGAuthorizationType.BookingReferenceID bookingReferenceID;
   @XmlAttribute(name = "PrincipalCompanyCode")
   protected String principalCompanyCode;
   @XmlAttribute(name = "RefNumber")
   protected String refNumber;

   public HTNGAuthorizationType.CreditCardAuthorization getCreditCardAuthorization() {
      return this.creditCardAuthorization;
   }

   public void setCreditCardAuthorization(HTNGAuthorizationType.CreditCardAuthorization value) {
      this.creditCardAuthorization = value;
   }

   public HTNGAuthorizationType.BookingReferenceID getBookingReferenceID() {
      return this.bookingReferenceID;
   }

   public void setBookingReferenceID(HTNGAuthorizationType.BookingReferenceID value) {
