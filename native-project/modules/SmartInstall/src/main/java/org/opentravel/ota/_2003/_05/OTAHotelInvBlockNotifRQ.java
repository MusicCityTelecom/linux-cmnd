...
@XmlType(name = "", propOrder = {"pos", "invBlocks", "tpaExtensions"})
...
public class OTAHotelInvBlockNotifRQ {
   ...
   public static class InvBlocks {
      ...
      @XmlAccessorType(XmlAccessType.FIELD)
      @XmlType(name = "", propOrder = {"guarantee", "marketCode"})
      public static class InvBlock extends InvBlockType {
