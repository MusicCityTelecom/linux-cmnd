...
@XmlType(
   name = "VehicleProfileRentalPrefType",
   propOrder = {"loyaltyPref", "vendorPref", "paymentFormPref", "coveragePref", "specialReqPref", "vehTypePref", "specialEquipPref"}
)
public class VehicleProfileRentalPrefType {
   ...
   public List<VehiclePrefType> getVehTypePref() {
      if (this.vehTypePref == null) {
         this.vehTypePref = new ArrayList<>();
      }
