...
@XmlSeeAlso({RailAvailQueryType.PassengerType.class, RailPassengerCategoryDetailType.class})
public class RailPassengerCategoryType {
   ...
   public List<RailPassengerCategoryType.PassengerQualifyingInfo> getPassengerQualifyingInfo() {
      if (this.passengerQualifyingInfo == null) {
         this.passengerQualifyingInfo = new ArrayList<>();
      }
   ...
   public List<String> getADARequirement() {
      if (this.adaRequirement == null) {
         this.adaRequirement = new ArrayList<>();
      }
