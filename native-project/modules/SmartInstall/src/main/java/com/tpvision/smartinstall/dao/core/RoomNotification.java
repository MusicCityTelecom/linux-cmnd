...
public class RoomNotification {
   ...
   private RoomNotification.EventType eventType;
   ...
   public RoomNotification.EventType getEventType() {
      return this.eventType;
   }

   public void setEventType(RoomNotification.EventType eventType) {
