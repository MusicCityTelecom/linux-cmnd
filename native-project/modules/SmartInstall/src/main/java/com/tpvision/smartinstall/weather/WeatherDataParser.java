...
public class WeatherDataParser {
   ...
   public WeatherDataParser.WeatherData wd = null;
   ...
   public WeatherDataParser(String data) {
      ...
      LOG.info(this.temp);
      Gson gson = new Gson();
      this.wd = gson.fromJson(this.temp, WeatherDataParser.WeatherData.class);
   }

   public class Forecast {
      public String day = null;
      public int pictoId = 0;
      public WeatherDataParser.Temperatures temperatures = null;
      ...
      public WeatherDataParser.Temperatures getTemperatures() {
         return this.temperatures;
      }

      public void setTemperatures(WeatherDataParser.Temperatures temp) {
      ...
      public String getWeatherIconName(boolean daytime) {
         return daytime
            ? WeatherDataParser.WeatherConstant.WEATHER_ICON_DAY_MAP.get(this.getPictoId())
            : WeatherDataParser.WeatherConstant.WEATHER_ICON_NIGHT_MAP.get(this.getPictoId());
      }

      public String getWeatherDescription(boolean daytime) {
         return daytime
            ? WeatherDataParser.WeatherConstant.WEATHER_DESC_DAY_MAP.get(this.getPictoId())
            : WeatherDataParser.WeatherConstant.WEATHER_DESC_NIGHT_MAP.get(this.getPictoId());
      }
   }
   ...
   static class WeatherConstant {
      protected static final Map<Integer, String> WEATHER_ICON_DAY_MAP = new HashMap<>();
      protected static final Map<Integer, String> WEATHER_ICON_NIGHT_MAP = new HashMap<>();
      protected static final Map<Integer, String> WEATHER_DESC_DAY_MAP = new HashMap<>();
      protected static final Map<Integer, String> WEATHER_DESC_NIGHT_MAP = new HashMap<>();
   ...
   public class WeatherData {
      ...
      public List<WeatherDataParser.Forecast> forecasts;
      ...
      public void setForecast(List<WeatherDataParser.Forecast> fc) {
         this.forecasts = fc;
      }

      public List<WeatherDataParser.Forecast> getForecast() {
