...
public class SecuredCmdControlCmd extends JapitCommand {
   ...
   public static JSONObject getCommandDetail(
      String transitCommunicationTo, String serverUrl, String caUrl, String caVersion, String caNamePassword, String secureKeySupport
   ) {
