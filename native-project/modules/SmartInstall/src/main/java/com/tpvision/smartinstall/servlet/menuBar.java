...
public class menuBar extends HttpServlet {
   ...
   protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
      ...
      String navbar = getMenuBar(request, response, cmndVersion);
   ...
   public static String getMenuBar(HttpServletRequest request, HttpServletResponse response, String cmndVersion) {
      ...
      if (null != user && !user.equalsIgnoreCase("anonymousUser")) {
         ...
         for (ProfileRole pr : prm.loadByProfileId(username)) {
            if (pr.getRoleIdrole() == rs.get(0).getIdrole()) {
               isAdminUser = true;
               break;
            }
         }
      ...
      String domainUrl = "";
      if (isSecureLink) {
         domainUrl = "https://" + request.getServerName() + ":" + Configs.getProperty("tomcat.https.port", 8443);
      } else {
         domainUrl = "http://" + request.getServerName() + ":" + Configs.getProperty("tomcat.http.port", 8080);
      }
      ...
      String cmsUrl = "";
      if (isSecureLink) {
         cmsUrl = "https://" + request.getServerName() + ":" + Configs.getProperty("cms.port.https", 8444) + "/SmartCMS/";
      } else {
         cmsUrl = "http://" + request.getServerName() + ":" + Configs.getProperty("cms.port", 8082) + "/SmartCMS/";
      }

      return "<nav class=\"navbar navbar-inverse\" role=\"navigation\" style=\"border-radius: 0px;\"><div class=\"navbar-header\"><button type=\"button\" class=\"navbar-toggle collapsed\" data-toggle=\"collapse\" data-target=\"#navbar\" aria-expanded=\"false\" aria-controls=\"navbar\"><span class=\"sr-only\">Toggle navigation</span><span class=\"icon-bar\"></span><span class=\"icon-bar\"></span><span class=\"icon-bar\"></span></button><a href=\"#\"><img alt=\"Brand\" style=\"padding-left: 3px; height:50px; float:left;\" src=\""
         + siUrl
         + "static/images/cmnd.png\"></a><p id=\"nav_sys_ver\" class=\"navbar-text\">"
         + cmndVersion
         + "</p></div><div id=\"navbar\" class=\"navbar_real collapse navbar-collapse\"><ul class=\"nav navbar-nav navbar-right\" style=\"margin-right:0px;\"><li><a id=\"nav_monitors\" href=\""
         + controlUrl
         + "\">Monitors</a></li><li><a id=\"nav_tvs\" href=\""
         + siUrl
         + "dev?type=index\"> TVs </a></li><li><a id=\"nav_files\" href=\""
         + siUrl
         + "getFile?mode=index\">Files</a></li><li><a id=\"nav_cms\" href=\""
         + cmsUrl
         + "\"> Create </a></li><li><a id=\"nav_admin\" href=\""
         + adminRef
         + "\">Admin</a></li><li><a id=\"nav_about\" href=\""
         + aboutRef
         + "\">Documentation</a></li><li><a id=\"nav_logout\" href=\""
         + siUrl
         + "logout\" onclick=\"clearls()\">Logout</a></li><li>&nbsp;&nbsp;</li></ul></div></nav><script type=\"text/javascript\" src=\""
         + hitSelectNavScript
         + "\"></script>";
   }
}
