...
public class EnablerServiceCmd extends JapitCommand {
   ...
   public JSONObject getCommandDetails() {
      ...
      if (this.applicationControlService != null) {
         enablerParameters.put("ApplicationControlService", this.applicationControlService ? "On" : "Off");
      }

      if (this.audioService != null) {
         enablerParameters.put("AudioService", this.audioService ? "On" : "Off");
      }

      if (this.channelSelectionService != null) {
         enablerParameters.put("ChannelSelectionService", this.channelSelectionService ? "On" : "Off");
      }

      if (this.powerService != null) {
         enablerParameters.put("PowerService", this.powerService ? "On" : "Off");
      }

      if (this.sourceService != null) {
         enablerParameters.put("SourceService", this.sourceService ? "On" : "Off");
      }

      if (this.mychoiceService != null) {
         enablerParameters.put("MyChoiceService", this.mychoiceService ? "On" : "Off");
      }

      if (this.professionalSettingsService != null) {
         enablerParameters.put("ProfessionalSettingsService", this.professionalSettingsService ? "On" : "Off");
      }
