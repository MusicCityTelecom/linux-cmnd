...
public class RoomCheckResult {
   ...
   private List<PlayoutInfo> currentAllPlayoutInfoList = new ArrayList<>();
   private Map<PlayoutInfo, String> partialOverlapUpdateRequiredPlayoutInfoMap = new HashMap<>();
   private List<PlayoutInfo> fullOverlapRemoveRequiredPlayoutInfoList = new ArrayList<>();
