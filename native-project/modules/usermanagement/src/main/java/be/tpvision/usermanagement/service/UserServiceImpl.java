...
public class UserServiceImpl implements UserService {
   ...
   public UserServiceImpl(final UserRepository userRepository) {
      Assert.notNull(userRepository, MessageUtilities.USER_REPOSITORY_NOT_NULL_MESSAGE);
   ...
   @Override
   public Set<User> getUsersOrderedBy(final SingularAttribute<? super User, ?> singularAttribute, final OrderDirection orderDirection) {
      this.assertUserRepositoryStateNotNull();
   ...
   @Override
   public Set<User> getUsersByRole(final Role role) {
      this.assertUserRepositoryStateNotNull();
   ...
   @Override
   public void updateUser(final User user, final boolean encodePassword) {
      this.assertUserRepositoryStateNotNull();
      Assert.notNull(user, MessageUtilities.USER_NOT_NULL_MESSAGE);
      if (encodePassword) {
         String password = user.getPassword();
