...
public class SicpHimalayaCommandFactory extends SicpCommandFactoryImpl {
   private static final Commands commands = new Commands();
   private static SicpHimalayaCommandFactory sicpCommandFactory;

   private SicpHimalayaCommandFactory() {
      super(SicpVersion._200, commands);
   }

   public static synchronized SicpHimalayaCommandFactory getInstance() {
      if (sicpCommandFactory == null) {
         sicpCommandFactory = new SicpHimalayaCommandFactory();
      }
