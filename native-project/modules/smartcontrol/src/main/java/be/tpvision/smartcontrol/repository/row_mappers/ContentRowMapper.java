...
public class ContentRowMapper implements RowMapper<Content> {
   ...
   @Autowired
   public ContentRowMapper(
      final AttributeConverter<LocalDateTime, Timestamp> localDateTimeConverter, final AttributeConverter<Content.Orientation, String> orientationConverter
   ) {
   ...
   public Content mapRow(final ResultSet resultSet, final int rowNumber) throws SQLException {
      ...
      Timestamp localChangedTimeStamp = resultSet.getTimestamp("local_changed");
