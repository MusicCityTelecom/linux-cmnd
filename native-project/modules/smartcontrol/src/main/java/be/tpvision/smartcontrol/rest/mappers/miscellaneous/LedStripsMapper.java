...
public class LedStripsMapper {
   ...
   public static LedStripsViewModel toLedStripsViewModel(final LedStrips ledStrips) {
      Assert.notNull(ledStrips, ToLedStripsViewModelMessages.LED_STRIPS_CAN_NOT_BE_NULL_MESSAGE);
   ...
   public static LedStrips toLedStrips(final LedStripsViewModel ledStripsViewModel) {
      Assert.notNull(ledStripsViewModel, ToLedStripsMessages.LED_STRIPS_VIEW_MODEL_CAN_NOT_BE_NULL);
