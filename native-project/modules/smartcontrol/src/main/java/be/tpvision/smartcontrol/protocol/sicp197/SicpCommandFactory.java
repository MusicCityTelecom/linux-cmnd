...
import be.tpvision.smartcontrol.codecs.sicp197.input_sources.FailoversCodec;
...
import be.tpvision.smartcontrol.codecs.sicp197.miscellaneous.PortStatusCodec;
...
public class SicpCommandFactory extends SicpCommandFactoryImpl {
   ...
   private SicpCommandFactory() {
      super(SicpVersion._197, commands);
   }
   ...
   static {
      ...
      commands.add(new Command(Command.Type.GET, Command.Setting.PORT_STATUS, (byte)-14, null, PortStatusCodec.getInstance()));
      commands.add(new Command(Command.Type.SET, Command.Setting.PORT_STATUS, (byte)-15, PortStatusCodec.getInstance()));
      commands.add(
         new Command(
            Command.Type.GET,
