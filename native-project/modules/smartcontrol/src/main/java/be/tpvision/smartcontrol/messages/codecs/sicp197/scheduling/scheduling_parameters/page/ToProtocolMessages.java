package be.tpvision.smartcontrol.messages.codecs.sicp197.scheduling.scheduling_parameters.page;
...
public class ToProtocolMessages {
   ...
   public static final String DOMAIN_WORKING_DAYS_COLLECTION_CAN_NOT_CONTAIN_NULL_VALUES = Messages.getCanNotContainNullValuesMessage(
      "Domain working days collection"
   );
