...
public class ColorParametersCodec extends Codec<ColorParameters> {
   ...
   public byte[] toProtocol(final ColorParameters colorParameters) {
      Assert.notNull(colorParameters, ToProtocolMessages.COLOR_PARAMETERS_CAN_NOT_BE_NULL);
   ...
   private ColorParameters.Color getDomainColor(final byte protocolGain, final byte protocolOffset) {
   ...
   public ColorParameters toDomain(final byte[] bytes) {
