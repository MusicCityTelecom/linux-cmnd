...
public class DeviceInputSourceComparator extends DelegatingComparator<Device> {
   public DeviceInputSourceComparator(final Comparator<? super InputSource> inputSourceComparator) {
