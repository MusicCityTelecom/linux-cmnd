...
public class LedStrips implements DeviceSetting {
   private LedStrips.Status status;
   ...
   public LedStrips(final LedStrips.Status status, final int redValue, final int greenValue, final int blueValue) {
      this.status = status;
   ...
   public LedStrips.Status getStatus() {
      return this.status;
   }

   public void setStatus(final LedStrips.Status status) {
      this.status = status;
   }
