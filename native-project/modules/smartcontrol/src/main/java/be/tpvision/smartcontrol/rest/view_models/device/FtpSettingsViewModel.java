...
public class FtpSettingsViewModel {
   ...
   public FtpSettingsViewModel(final boolean useDefault) {
      this(useDefault, null, null, null);
   }

   public FtpSettingsViewModel(final Integer port, final String username, final String password) {
      this(false, port, username, password);
   }

   public FtpSettingsViewModel(final boolean useDefault, final Integer port, final String username, final String password) {
