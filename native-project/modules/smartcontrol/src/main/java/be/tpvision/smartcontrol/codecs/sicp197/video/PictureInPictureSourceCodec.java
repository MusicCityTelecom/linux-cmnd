...
public class PictureInPictureSourceCodec extends Codec<PictureInPictureSource> {
   ...
   public PictureInPictureSource toDomain(final byte[] bytes) {
      if (bytes != null && bytes.length >= 2) {
         ...
         if (bytes.length >= 3 && protocolPictureInPictureSourceSourceType == pictureInPictureSourceSourceTypeInputSource) {
         ...
         if (bytes.length >= 4 && protocolPictureInPictureSourceSourceType == pictureInPictureSourceSourceTypeInputSource) {
