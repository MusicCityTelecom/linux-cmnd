...
public class AudioParametersMapper {
   ...
   public static AudioParametersViewModel toAudioParametersViewModel(final AudioParameters audioParameters) {
      Assert.notNull(audioParameters, ToAudioParametersViewModelMessages.AUDIO_PARAMETERS_CAN_NOT_BE_NULL);
      int treble = audioParameters.getTreble();
      int bass = audioParameters.getBass();
      return new AudioParametersViewModel(treble, bass);
   }

   public static AudioParameters toAudioParameters(final AudioParametersViewModel audioParametersViewModel) {
      Assert.notNull(audioParametersViewModel, ToAudioParametersMessages.AUDIO_PARAMETERS_VIEW_MODEL_CAN_NOT_BE_NULL);
