...
public class AutoRestartParameterMapper {
   ...
   public static AutoRestartParameterViewModel toAutoRestartParameterViewModel(final AutoRestartParameter autoRestartParameter) {
   ...
   public static AutoRestartParameter toAutoRestartParameter(final AutoRestartParameterViewModel autoRestartParameterViewModel) {
