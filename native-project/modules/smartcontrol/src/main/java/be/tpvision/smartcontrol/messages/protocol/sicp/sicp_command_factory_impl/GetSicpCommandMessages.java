...
public class GetSicpCommandMessages {
   ...
   public static String getEncoderNotFoundMessage(final String sicpVersion, final String type, final String setting) {
   ...
   public static String getWrongDeviceSettingMessage(final String encoderDeviceSettingClass, final String deviceSettingClass) {
