...
public class VideoParametersCodec extends Codec<VideoParameters> {
   ...
   private static final Map<VideoParameters.GammaSelection, Byte> domainGammaSelections = new EnumMap<>(VideoParameters.GammaSelection.class);
   private static final Map<Byte, VideoParameters.GammaSelection> protocolGammaSelections = MapUtilities.inverse(domainGammaSelections);
   ...
   public byte[] toProtocol(final VideoParameters videoParameters) {
      Assert.notNull(videoParameters, ToProtocolMessages.VIDEO_PARAMETERS_CAN_NOT_BE_NULL);
      ...
      Byte protocolGammaSelection = domainGammaSelections.get(domainGammaSelection);
   ...
   public VideoParameters toDomain(final byte[] bytes) {
