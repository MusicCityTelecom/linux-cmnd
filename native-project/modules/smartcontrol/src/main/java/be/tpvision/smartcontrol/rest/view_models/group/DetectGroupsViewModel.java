...
public class DetectGroupsViewModel implements DeviceListItemViewModel {
   private String name;
   ...
   public DetectGroupsViewModel(final String name, final List<DetectDevicesViewModel> devices) {
      this.name = name;
   ...
   public void setDevices(final List<DetectDevicesViewModel> devices) {
      this.devices = devices;
   }
