...
public class DisplayOrientationViewModel {
   ...
   public DisplayOrientationViewModel(
      final String autoRotate,
      final String osdRotation,
      final String imageAll,
      final String displayWindow1,
      final String displayWindow2,
      final String displayWindow3,
      final String displayWindow4
   ) {
   ...
   public void setAutoRotate(final String autoRotate) {
      this.autoRotate = autoRotate;
   }
   ...
   public void setOsdRotation(final String osdRotation) {
      this.osdRotation = osdRotation;
   }
   ...
   public void setImageAll(final String imageAll) {
      this.imageAll = imageAll;
   }
   ...
   public void setDisplayWindow1(final String displayWindow1) {
      this.displayWindow1 = displayWindow1;
   }
   ...
   public void setDisplayWindow2(final String displayWindow2) {
      this.displayWindow2 = displayWindow2;
   }
   ...
   public void setDisplayWindow3(final String displayWindow3) {
      this.displayWindow3 = displayWindow3;
   }
   ...
   public void setDisplayWindow4(final String displayWindow4) {
      this.displayWindow4 = displayWindow4;
   }
