...
public class InputSourceMapper {
   ...
   public static InputSourceViewModel toInputSourceViewModel(final InputSource inputSource) {
      Assert.notNull(inputSource, ToInputSourceViewModelMessages.INPUT_SOURCE_CAN_NOT_BE_NULL);
      InputSource.SourceType sourceType = inputSource.getSourceType();
      String sourceTypeString = String.valueOf(sourceType);
      ...
      String sourceLabelString = String.valueOf(sourceLabel);
      return new InputSourceViewModel(sourceTypeString, tagString, sourceLabelString);
   }

   public static InputSource toInputSource(final InputSourceViewModel inputSourceViewModel) {
      Assert.notNull(inputSourceViewModel, ToInputSourceMessages.INPUT_SOURCE_VIEW_MODEL_CAN_NOT_BE_NULL);
