...
public class TwaCommand extends TwaMessage {
   public static final byte DIRECTION = 0;
   private static final int COMMAND_CODE_LENGTH = 2;
   private byte[] commandCode;
   private byte[] bytes;

   public TwaCommand(final byte deviceAddressX, final byte deviceAddressY, final byte[] commandCode, final byte[] bytes) {
      this(deviceAddressX, deviceAddressY, deviceAddressX, deviceAddressY, commandCode, bytes);
   }

   public TwaCommand(
      final byte deviceAddressX, final byte deviceAddressY, final byte moduleAddressX, final byte moduleAddressY, final byte[] commandCode, final byte[] bytes
   ) {
   ...
   public void setCommandCode(final byte[] commandCode) {
      Assert.notNull(commandCode, SetCommandCodeMessages.COMMAND_CODE_CAN_NOT_BE_NULL);
      Assert.isTrue(commandCode.length == 2, "Command code has to have a length of exactly 2");
      this.commandCode = commandCode;
   }
   ...
   public void setBytes(final byte[] bytes) {
      Assert.notNull(bytes, SetBytesMessages.BYTES_CAN_NOT_BE_NULL);
   ...
   public boolean equals(final Object object) {
      ...
      return new EqualsBuilder()
         .append(super.getDirection(), that.getDirection())
         .append(super.getDeviceAddressX(), that.getDeviceAddressX())
         .append(super.getDeviceAddressY(), that.getDeviceAddressY())
         .append(super.getModuleAddressX(), that.getModuleAddressX())
         .append(super.getModuleAddressY(), that.getModuleAddressY())
   ...
   public int hashCode() {
      return Objects.hash(
         super.getDirection(),
         super.getDeviceAddressX(),
         super.getDeviceAddressY(),
         super.getModuleAddressX(),
         super.getModuleAddressY(),
         this.getCommandCode(),
         this.getBytes()
      );
   }
