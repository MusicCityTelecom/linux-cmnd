...
public class DevicePowerStateComparator extends DelegatingComparator<Device> {
   public DevicePowerStateComparator(final Comparator<? super PowerState> powerStateComparator) {
