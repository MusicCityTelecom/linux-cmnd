...
public class MessageUtilities {
   ...
   public static final String FAILOVERS_LIST_NO_NULL_ELEMENTS_MESSAGE = getCantContainNullValuesMessage("Failovers list");
   ...
   private static String getCantContainNullValuesMessage(final String input) {
