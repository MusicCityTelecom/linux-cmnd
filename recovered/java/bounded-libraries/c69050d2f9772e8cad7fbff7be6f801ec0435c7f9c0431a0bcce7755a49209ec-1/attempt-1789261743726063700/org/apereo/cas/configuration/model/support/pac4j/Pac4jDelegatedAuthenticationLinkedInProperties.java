...
public class Pac4jDelegatedAuthenticationLinkedInProperties
extends Pac4jIdentifiableClientProperties {
    ...
    @Generated
    public Pac4jDelegatedAuthenticationLinkedInProperties setScope(String scope) {
        this.scope = scope;
        return this;
    }
}
