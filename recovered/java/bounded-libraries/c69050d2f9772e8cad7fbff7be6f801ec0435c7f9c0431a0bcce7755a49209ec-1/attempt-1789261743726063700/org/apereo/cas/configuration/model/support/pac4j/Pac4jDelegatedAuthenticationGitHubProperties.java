...
public class Pac4jDelegatedAuthenticationGitHubProperties
extends Pac4jIdentifiableClientProperties {
    ...
    @Generated
    public Pac4jDelegatedAuthenticationGitHubProperties setScope(String scope) {
        this.scope = scope;
        return this;
    }
}
