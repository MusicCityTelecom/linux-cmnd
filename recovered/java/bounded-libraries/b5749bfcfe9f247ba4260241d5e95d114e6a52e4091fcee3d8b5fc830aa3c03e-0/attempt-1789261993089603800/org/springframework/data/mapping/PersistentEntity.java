...
extends Iterable<P> {
    ...
    @Deprecated
    default public boolean isConstructorArgument(PersistentProperty<?> property) {
        return this.isCreatorArgument(property);
    }

    public boolean isCreatorArgument(PersistentProperty<?> var1);
