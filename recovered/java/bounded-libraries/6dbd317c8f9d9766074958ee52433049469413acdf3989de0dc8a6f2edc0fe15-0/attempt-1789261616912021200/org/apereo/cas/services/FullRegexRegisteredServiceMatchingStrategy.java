...
implements RegisteredServiceMatchingStrategy {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FullRegexRegisteredServiceMatchingStrategy)) {
            return false;
        }
        FullRegexRegisteredServiceMatchingStrategy other = (FullRegexRegisteredServiceMatchingStrategy)o;
        return other.canEqual(this);
    }

    @Generated
    protected boolean canEqual(Object other) {
        return other instanceof FullRegexRegisteredServiceMatchingStrategy;
    }
