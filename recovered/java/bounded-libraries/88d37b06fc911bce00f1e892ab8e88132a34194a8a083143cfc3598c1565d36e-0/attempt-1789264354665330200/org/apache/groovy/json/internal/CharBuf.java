...
import org.apache.groovy.json.internal.ByteScanner;
...
import org.apache.groovy.json.internal.SimpleCache;
...
implements CharSequence {
    ...
    public final CharBuf addInt(Integer key) {
        char[] chars;
        if (this.icache == null) {
            this.icache = new SimpleCache<Integer, char[]>(20);
        }
    ...
    public final CharBuf addDouble(Double key) {
        char[] chars;
        if (this.dcache == null) {
            this.dcache = new SimpleCache<Double, char[]>(20);
        }
    ...
    public final CharBuf addFloat(Float key) {
        char[] chars;
        if (this.fcache == null) {
            this.fcache = new SimpleCache<Float, char[]>(20);
        }
    ...
    public final CharBuf addJsonFieldName(String str, boolean disableUnicodeEscaping) {
        return this.addJsonFieldName(FastStringUtils.toCharArray(str), disableUnicodeEscaping);
    }
    ...
    public CharBuf addBigDecimal(BigDecimal key) {
        ...
        if (this.bigDCache == null) {
            this.bigDCache = new SimpleCache<BigDecimal, char[]>(20);
        }
    ...
    public CharBuf addBigInteger(BigInteger key) {
        ...
        if (this.bigICache == null) {
            this.bigICache = new SimpleCache<BigInteger, char[]>(20);
        }
    ...
    public final CharBuf addLong(Long key) {
        char[] chars;
        if (this.lcache == null) {
            this.lcache = new SimpleCache<Long, char[]>(20);
        }
