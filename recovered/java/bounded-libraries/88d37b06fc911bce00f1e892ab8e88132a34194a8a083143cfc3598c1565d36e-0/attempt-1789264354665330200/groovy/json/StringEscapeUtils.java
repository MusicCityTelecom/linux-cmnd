...
public class StringEscapeUtils {
    ...
    private static String escapeJavaStyleString(String str, boolean escapeSingleQuotes, boolean escapeForwardSlash) {
        ...
        try {
            StringBuilderWriter writer = new StringBuilderWriter(str.length() * 2);
            StringEscapeUtils.escapeJavaStyleString((Writer)writer, str, escapeSingleQuotes, escapeForwardSlash);
    ...
    public static String unescapeJava(String str) {
        ...
        try {
            StringBuilderWriter writer = new StringBuilderWriter(str.length());
            StringEscapeUtils.unescapeJava((Writer)writer, str);
            return writer.toString();
        }
        catch (IOException ioe) {
            throw new RuntimeException(ioe);
