            ...
            extends StackManipulation.AbstractBase {
                ...
                public StackManipulation.Size apply(MethodVisitor methodVisitor, Implementation.Context implementationContext) {
                    ...
                    if (implementationContext.getClassFileVersion().isAtLeast(ClassFileVersion.JAVA_V6)) {
                        methodVisitor.visitFrame(4, EMPTY.length, EMPTY, INTEGER.length, INTEGER);
                    }
                    return StackManipulation.Size.ZERO;
                }
    ...
    protected static interface OffsetProvider {
        ...
        public static enum ForDynamicTypeHash implements OffsetProvider
        {
            ...
            public StackManipulation resolve(TypeDescription instrumentedType) {
                return new StackManipulation.Compound(MethodVariableAccess.loadThis(), MethodInvocation.invoke(GET_CLASS).virtual(instrumentedType), MethodInvocation.invoke(HASH_CODE).virtual(TypeDescription.CLASS));
            }
        }
