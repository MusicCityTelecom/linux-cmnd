...
implements Implementation {
    ...
    implements OwnerTypeLocatable {
        ...
        public Implementation.Composable setsValue(@MaybeNull Object value) {
            ...
            if (type == String.class) {
                return this.setsValue((StackManipulation)new TextConstant((String)value), (Type)((Object)String.class));
            }
            if (type == Class.class) {
                return this.setsValue(ClassConstant.of(TypeDescription.ForLoadedType.of((Class)value)), (Type)((Object)Class.class));
            }
            if (type == Boolean.class) {
                return this.setsValue(IntegerConstant.forValue((Boolean)value), Boolean.TYPE);
            }
            if (type == Byte.class) {
                return this.setsValue(IntegerConstant.forValue(((Byte)value).byteValue()), Byte.TYPE);
            }
            if (type == Short.class) {
                return this.setsValue(IntegerConstant.forValue(((Short)value).shortValue()), Short.TYPE);
            }
            if (type == Character.class) {
                return this.setsValue(IntegerConstant.forValue(((Character)value).charValue()), Character.TYPE);
            }
            if (type == Integer.class) {
                return this.setsValue(IntegerConstant.forValue((Integer)value), Integer.TYPE);
            }
            if (type == Long.class) {
                return this.setsValue(LongConstant.forValue((Long)value), Long.TYPE);
            }
            if (type == Float.class) {
                return this.setsValue(FloatConstant.forValue(((Float)value).floatValue()), Float.TYPE);
            }
            if (type == Double.class) {
                return this.setsValue(DoubleConstant.forValue((Double)value), Double.TYPE);
            }
            if (JavaType.METHOD_HANDLE.getTypeStub().isAssignableFrom(type)) {
                return this.setsValue((StackManipulation)new JavaConstantValue(JavaConstant.MethodHandle.ofLoaded(value)), type);
            }
            if (JavaType.METHOD_TYPE.getTypeStub().represents(type)) {
                return this.setsValue((StackManipulation)new JavaConstantValue(JavaConstant.MethodType.ofLoaded(value)), type);
            }
            return this.setsReference(value);
        }
        ...
        public Implementation.Composable setsValue(JavaConstant constant) {
            return this.setsValue((StackManipulation)new JavaConstantValue(constant), constant.getTypeDescription().asGenericType());
        }
    ...
    protected static interface FieldLocation {
        ...
        implements FieldLocation {
            ...
            public int hashCode() {
                return (this.getClass().hashCode() * 31 + this.fieldNameExtractor.hashCode()) * 31 + this.fieldLocatorFactory.hashCode();
            }
            ...
            implements net.bytebuddy.implementation.FieldAccessor$FieldLocation$Prepared {
                ...
                public int hashCode() {
                    return (this.getClass().hashCode() * 31 + this.fieldNameExtractor.hashCode()) * 31 + this.fieldLocator.hashCode();
                }
            }
        }
