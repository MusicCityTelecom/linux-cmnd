...
extends SimpleModule {
    ...
    public JSR310Module() {
        ...
        this.addSerializer(ZonedDateTime.class, JSR310Module._zonedWithZoneId());
        ...
        context.addValueInstantiators((ValueInstantiators)new ValueInstantiators.Base(){
            ...
            public ValueInstantiator findValueInstantiator(DeserializationConfig config, BeanDescription beanDesc, ValueInstantiator defaultInstantiator) {
                ...
                if (ZoneId.class.isAssignableFrom(raw) && defaultInstantiator instanceof StdValueInstantiator) {
                    ...
                    AnnotatedClass ac = raw == ZoneId.class ? beanDesc.getClassInfo() : AnnotatedClass.construct((JavaType)config.constructType(ZoneId.class), (MapperConfig)config);
