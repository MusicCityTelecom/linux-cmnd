...
extends JSR310DateTimeDeserializerBase<T> {
    ...
    protected T _fromString(JsonParser p, DeserializationContext ctxt, String string0) throws IOException {
        ...
        try {
            ...
            value = (Temporal)this._handleDateTimeException(ctxt, e, string);
        }
        return (T)value;
    }
    ...
    protected T _fromDecimal(DeserializationContext context, BigDecimal value) {
        FromDecimalArguments args = DecimalUtils.extractSecondsAndNanos(value, (s, ns) -> new FromDecimalArguments((long)s, (int)ns, this.getZone(context)));
