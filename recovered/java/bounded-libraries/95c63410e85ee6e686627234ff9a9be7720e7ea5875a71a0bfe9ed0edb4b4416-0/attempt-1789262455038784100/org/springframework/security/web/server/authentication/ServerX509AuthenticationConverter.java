...
implements ServerAuthenticationConverter {
    ...
    public Mono<Authentication> convert(ServerWebExchange exchange) {
        ...
        if (sslInfo == null) {
            this.logger.debug((Object)"No SslInfo provided with a request, skipping x509 authentication");
            return Mono.empty();
        }
        if (sslInfo.getPeerCertificates() == null || sslInfo.getPeerCertificates().length == 0) {
            this.logger.debug((Object)"No peer certificates found in SslInfo, skipping x509 authentication");
            return Mono.empty();
        }
        ...
        return Mono.just((Object)((Object)new PreAuthenticatedAuthenticationToken(principal, clientCertificate)));
    }
}
