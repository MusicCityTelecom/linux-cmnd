...
implements PersistentTokenRepository {
    ...
    public PersistentRememberMeToken getTokenForSeries(String seriesId) {
        try {
            ...
            this.logger.debug((Object)LogMessage.format((String)"Querying token for series '%s' returned no results.", (Object)seriesId), (Throwable)ex);
        }
        catch (IncorrectResultSizeDataAccessException ex) {
            this.logger.error((Object)LogMessage.format((String)"Querying token for series '%s' returned more than one value. Series should be unique", (Object)seriesId));
        }
        catch (DataAccessException ex) {
            this.logger.error((Object)("Failed to load token for series " + seriesId), (Throwable)ex);
        }
        return null;
    }
