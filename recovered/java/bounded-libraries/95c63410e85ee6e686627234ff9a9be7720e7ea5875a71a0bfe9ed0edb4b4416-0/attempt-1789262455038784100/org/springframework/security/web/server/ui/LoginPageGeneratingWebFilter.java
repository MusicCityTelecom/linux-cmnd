...
implements WebFilter {
    ...
    private byte[] createPage(ServerWebExchange exchange, String csrfTokenHtmlInput) {
        ...
        page.append(this.formLogin((MultiValueMap<String, String>)queryParams, contextPath, csrfTokenHtmlInput));
        page.append(LoginPageGeneratingWebFilter.oauth2LoginLinks((MultiValueMap<String, String>)queryParams, contextPath, this.oauth2AuthenticationUrlToClientName));
        page.append("    </div>\n");
        page.append("  </body>\n");
        page.append("</html>");
    ...
    private String formLogin(MultiValueMap<String, String> queryParams, String contextPath, String csrfTokenHtmlInput) {
        ...
        page.append(LoginPageGeneratingWebFilter.createError(isError));
        page.append(LoginPageGeneratingWebFilter.createLogoutSuccess(isLogoutSuccess));
        page.append("        <p>\n");
    ...
    private static String oauth2LoginLinks(MultiValueMap<String, String> queryParams, String contextPath, Map<String, String> oauth2AuthenticationUrlToClientName) {
        ...
        sb.append(LoginPageGeneratingWebFilter.createError(isError));
