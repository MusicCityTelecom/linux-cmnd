...
extends TemplateAwareExpressionParser {
    ...
    protected SpelExpression doParseExpression(String expressionString, @Nullable ParserContext context) throws ParseException {
        try {
            ...
            Assert.state((ast != null ? 1 : 0) != 0, (String)"No node");
            Token t = this.peekToken();
            if (t != null) {
                throw new SpelParseException(t.startPos, SpelMessage.MORE_INPUT, this.toString(this.nextToken()));
            }
            Assert.isTrue((boolean)this.constructedNodes.isEmpty(), (String)"At least one node expected");
    ...
    private SpelNodeImpl eatRelationalExpression() {
        ...
        if (relationalOperatorToken != null) {
            ...
            if (relationalOperatorToken.isNumericRelationalOperator()) {
                ...
                Assert.isTrue((tk == TokenKind.NE ? 1 : 0) != 0, (String)"Not-equals token expected");
            ...
            Assert.isTrue((tk == TokenKind.BETWEEN ? 1 : 0) != 0, (String)"Between token expected");
    ...
    private SpelNodeImpl eatProductExpression() {
        ...
        while (this.peekToken(TokenKind.STAR, TokenKind.DIV, TokenKind.MOD)) {
            ...
            Assert.isTrue((t.kind == TokenKind.MOD ? 1 : 0) != 0, (String)"Mod token expected");
    ...
    private SpelNodeImpl eatUnaryExpression() {
        if (this.peekToken(TokenKind.PLUS, TokenKind.MINUS, TokenKind.NOT)) {
            Token t = this.takeToken();
            SpelNodeImpl expr = this.eatUnaryExpression();
            Assert.state((expr != null ? 1 : 0) != 0, (String)"No node");
            ...
            Assert.isTrue((t.kind == TokenKind.MINUS ? 1 : 0) != 0, (String)"Minus token expected");
    ...
    private void consumeArguments(List<SpelNodeImpl> accumulatedArguments) {
        Token next;
        Token t = this.peekToken();
        Assert.state((t != null ? 1 : 0) != 0, (String)"Expected token");
        int pos = t.startPos;
        do {
            this.nextToken();
            t = this.peekToken();
    ...
    private boolean maybeEatTypeReference() {
        if (this.peekToken(TokenKind.IDENTIFIER)) {
            ...
            Assert.state((typeName != null ? 1 : 0) != 0, (String)"Expected token");
    ...
    private boolean maybeEatNullReference() {
        if (this.peekToken(TokenKind.IDENTIFIER)) {
            ...
            Assert.state((nullToken != null ? 1 : 0) != 0, (String)"Expected token");
    ...
    private boolean maybeEatProjection(boolean nullSafeNavigation) {
        ...
        Assert.state((t != null ? 1 : 0) != 0, (String)"No token");
    ...
    private boolean maybeEatInlineListOrMap() {
        ...
        if (this.peekToken(TokenKind.RCURLY, true)) {
            Assert.state((closingCurly != null ? 1 : 0) != 0, (String)"No token");
