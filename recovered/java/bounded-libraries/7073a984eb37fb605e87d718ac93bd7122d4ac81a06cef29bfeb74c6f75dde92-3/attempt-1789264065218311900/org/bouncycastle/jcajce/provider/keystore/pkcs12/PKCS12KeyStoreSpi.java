...
lbl48:
                            ...
                            if (var18_27.getBagAttributes() != null) {
                                ...
                                while (var23_34.hasMoreElements()) {
                                    ...
                                    if (var25_36.equals(PKCS12KeyStoreSpi.pkcs_9_at_friendlyName)) {
                                        var21_32 = ((ASN1BMPString)var27_38).getString();
                        ...
                        if (var19_30.getBagId().equals(PKCS12KeyStoreSpi.pkcs8ShroudedKeyBag)) {
                            ...
                            while (var25_36.hasMoreElements()) {
                                ...
                                if (var27_38.equals(PKCS12KeyStoreSpi.pkcs_9_at_friendlyName)) {
                                    var23_34 = ((ASN1BMPString)var29_40).getString();
            ...
            if (var12_14.getBagAttributes() != null) {
                ...
                while (var17_26.hasMoreElements()) {
                    ...
                    if (var14_18 instanceof PKCS12BagAttributeCarrier) {
                        ...
                        if (var23_34 != null) {
                            if (var19_30.equals(PKCS12KeyStoreSpi.pkcs_9_at_localKeyId)) {
                                var24_35 = Hex.toHexString(((ASN1OctetString)var21_32).getOctets());
                                if (!IgnoresCaseHashtable.access$200(this.keys).containsKey(var24_35) && !IgnoresCaseHashtable.access$200(this.localIds).containsKey(var24_35)) continue;
                            }
                    ...
                    if (var19_30.equals(PKCS12KeyStoreSpi.pkcs_9_at_friendlyName)) {
                        var16_23 /* !! */  = (byte[])((ASN1BMPString)var21_32).getString();
                        continue;
                    }
    ...
    private void doStore(OutputStream outputStream, char[] cArray, boolean bl) throws IOException {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if (object13 instanceof PKCS12BagAttributeCarrier) {
                ...
                if (object17 == null || !((ASN1BMPString)object17).getString().equals(object14)) {
        ...
        while (enumeration2.hasMoreElements()) {
            try {
                ...
                if (object8 instanceof PKCS12BagAttributeCarrier) {
                    ...
                    if (object5 == null || !((ASN1BMPString)object5).getString().equals(object9)) {
    ...
    private SafeBag createSafeBag(String string, Certificate certificate) throws CertificateEncodingException {
        ...
        if (certificate instanceof PKCS12BagAttributeCarrier) {
            ...
            ASN1BMPString aSN1BMPString = (ASN1BMPString)object.getBagAttribute(pkcs_9_at_friendlyName);
            if (!(aSN1BMPString != null && aSN1BMPString.getString().equals(string) || string == null)) {
    ...
    private static class IgnoresCaseHashtable {
        ...
        static /* synthetic */ Hashtable access$200(IgnoresCaseHashtable ignoresCaseHashtable) {
            return ignoresCaseHashtable.keys;
        }
    }
}
