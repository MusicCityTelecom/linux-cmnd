...
implements StatsCounter {
    ...
    public CaffeineStatsCounter(MeterRegistry registry, String cacheName, Iterable<Tag> extraTags) {
        ...
        this.hitCount = Counter.builder("cache.gets").tag("result", "hit").tags(this.tags).description("The number of times cache lookup methods have returned a cached (hit) or uncached (newly loaded) value (miss).").register(registry);
        this.missCount = Counter.builder("cache.gets").tag("result", "miss").tags(this.tags).description("The number of times cache lookup methods have returned a cached (hit) or uncached (newly loaded) value (miss).").register(registry);
        this.loadSuccesses = ((Timer.Builder)Timer.builder("cache.loads").tag("result", "success").tags((Iterable)this.tags)).description("The number of times cache lookup methods have successfully loaded a new value or failed to load a new value, either because no value was found or an exception was thrown while loading").register(registry);
        this.loadFailures = ((Timer.Builder)Timer.builder("cache.loads").tag("result", "failure").tags((Iterable)this.tags)).description("The number of times cache lookup methods have successfully loaded a new value or failed to load a new value, either because no value was found or an exception was thrown while loading").register(registry);
