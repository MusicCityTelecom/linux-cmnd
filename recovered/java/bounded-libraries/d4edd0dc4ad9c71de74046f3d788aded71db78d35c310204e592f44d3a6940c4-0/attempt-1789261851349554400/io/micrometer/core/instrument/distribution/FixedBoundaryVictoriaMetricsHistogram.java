...
implements Histogram {
    ...
    static {
        ...
        FixedBoundaryVictoriaMetricsHistogram.VMRANGES[1] = String.format("0...%.1fe%d", 1.0, -9);
        FixedBoundaryVictoriaMetricsHistogram.VMRANGES[2] = String.format("%.1fe%d...+Inf", 1.0, 18);
        ...
        int idx = 3;
        String start = String.format("%.1fe%d", 1.0, -9);
