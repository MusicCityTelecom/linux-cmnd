...
implements Finalizable {
    ...
    public void setPerInstanceMetaClass(Object obj, MetaClass metaClass) {
        ...
        if (metaClass != null) {
            if (this.perInstanceMetaClassMap == null) {
                this.perInstanceMetaClassMap = new ManagedIdentityConcurrentMap();
            }
    ...
    static /* synthetic */ ReferenceBundle access$400() {
        return weakBundle;
    }

    private static class GlobalClassSet {
        private final ManagedConcurrentLinkedQueue<ClassInfo> items = new ManagedConcurrentLinkedQueue(ClassInfo.access$400());
    ...
    extends LazyReference<ClassLoaderForClassArtifacts> {
        ...
        public ClassLoaderForClassArtifacts initValue() {
            return AccessController.doPrivileged(() -> new ClassLoaderForClassArtifacts((Class)this.info.classRef.get()));
        }
    }
