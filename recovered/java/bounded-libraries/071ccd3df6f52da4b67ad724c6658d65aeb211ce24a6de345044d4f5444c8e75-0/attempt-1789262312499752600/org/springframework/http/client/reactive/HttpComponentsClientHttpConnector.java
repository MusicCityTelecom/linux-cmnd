...
Closeable {
    ...
    implements FutureCallback<Message<HttpResponse, Publisher<ByteBuffer>>> {
        ...
        public void completed(Message<HttpResponse, Publisher<ByteBuffer>> result) {
            HttpComponentsClientHttpResponse response = new HttpComponentsClientHttpResponse(this.dataBufferFactory, result, this.context);
            this.sink.success((Object)response);
        }
