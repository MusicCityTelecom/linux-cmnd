...
implements io.undertow.server.HttpHandler {
    ...
    public void handleRequest(HttpServerExchange exchange) {
        ...
        try {
            request = new UndertowServerHttpRequest(exchange, this.getDataBufferFactory());
        }
        ...
        ServerHttpResponse response = new UndertowServerHttpResponse(exchange, this.getDataBufferFactory(), request);
