...
implements Servlet {
    ...
    public void service(ServletRequest request, ServletResponse response) throws ServletException, IOException {
        ...
        ServerHttpResponse httpResponse = this.createResponse((HttpServletResponse)response, asyncContext, httpRequest);
        AsyncListener responseListener = httpResponse.getAsyncListener();
    ...
    protected ServletServerHttpRequest createRequest(HttpServletRequest request, AsyncContext context) throws IOException, URISyntaxException {
        Assert.notNull((Object)this.servletPath, (String)"Servlet path is not initialized");
