...
public final class ContentDisposition {
    ...
    private static String decodeFilename(String filename, Charset charset) {
        Assert.notNull((Object)filename, (String)"'input' String` should not be null");
    ...
    private static String encodeFilename(String input, Charset charset) {
        ...
        Assert.isTrue((StandardCharsets.UTF_8.equals(charset) || StandardCharsets.ISO_8859_1.equals(charset) ? 1 : 0) != 0, (String)"Only UTF-8 and ISO-8859-1 supported.");
