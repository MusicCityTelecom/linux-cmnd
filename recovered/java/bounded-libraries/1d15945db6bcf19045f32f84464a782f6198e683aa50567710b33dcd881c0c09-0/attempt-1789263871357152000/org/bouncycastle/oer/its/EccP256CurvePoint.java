...
extends EccCurvePoint {
    ...
    public static EccP256CurvePoint getInstance(Object object) {
        ...
        return new Builder().setChoice(aSN1TaggedObject.getTagNo()).setValue((ASN1Encodable)aSN1Null).createEccP256CurvePoint();
    }
    ...
    public static class Builder {
        ...
        public EccP256CurvePoint createUncompressedP256(BigInteger bigInteger, BigInteger bigInteger2) {
            this.choice = 4;
            this.value = new DERSequence(new ASN1Encodable[]{new DEROctetString(BigIntegers.asUnsignedByteArray((int)32, (BigInteger)bigInteger)), new DEROctetString(BigIntegers.asUnsignedByteArray((int)32, (BigInteger)bigInteger2))});
            return this.createEccP256CurvePoint();
        }
