...
extends PublicKeyDataObject {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add((ASN1Encodable)new UnsignedInteger(1, this.getModulus()));
        aSN1EncodableVector.add((ASN1Encodable)new UnsignedInteger(2, this.getPublicExponent()));
