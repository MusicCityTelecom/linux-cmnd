...
extends ASN1Object {
    ...
    private PKIHeader(ASN1Sequence aSN1Sequence) {
        ...
        block11: while (enumeration.hasMoreElements()) {
            ...
            switch (aSN1TaggedObject.getTagNo()) {
                case 0: {
                    this.messageTime = ASN1GeneralizedTime.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)true);
                    continue block11;
                }
                case 1: {
                    this.protectionAlg = AlgorithmIdentifier.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)true);
                    continue block11;
                }
                case 2: {
                    this.senderKID = ASN1OctetString.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)true);
                    continue block11;
                }
                case 3: {
                    this.recipKID = ASN1OctetString.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)true);
                    continue block11;
                }
                case 4: {
                    this.transactionID = ASN1OctetString.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)true);
                    continue block11;
                }
                case 5: {
                    this.senderNonce = ASN1OctetString.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)true);
                    continue block11;
                }
                case 6: {
                    this.recipNonce = ASN1OctetString.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)true);
                    continue block11;
                }
                case 7: {
                ...
                case 8: {
                    this.generalInfo = ASN1Sequence.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)true);
                    continue block11;
                }
            }
    ...
    public static PKIHeader getInstance(Object object) {
        if (object instanceof PKIHeader) {
            return (PKIHeader)((Object)object);
        }
        if (object != null) {
            return new PKIHeader(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
