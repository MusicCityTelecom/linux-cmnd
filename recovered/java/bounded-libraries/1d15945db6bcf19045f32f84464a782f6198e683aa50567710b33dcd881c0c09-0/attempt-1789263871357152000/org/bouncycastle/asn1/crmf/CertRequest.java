...
extends ASN1Object {
    ...
    private CertRequest(ASN1Sequence aSN1Sequence) {
        this.certReqId = new ASN1Integer(ASN1Integer.getInstance((Object)aSN1Sequence.getObjectAt(0)).getValue());
    ...
    public static CertRequest getInstance(Object object) {
        if (object instanceof CertRequest) {
            return (CertRequest)((Object)object);
        }
        if (object != null) {
            return new CertRequest(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }

    public CertRequest(int n, CertTemplate certTemplate, Controls controls) {
        this(new ASN1Integer((long)n), certTemplate, controls);
    }
