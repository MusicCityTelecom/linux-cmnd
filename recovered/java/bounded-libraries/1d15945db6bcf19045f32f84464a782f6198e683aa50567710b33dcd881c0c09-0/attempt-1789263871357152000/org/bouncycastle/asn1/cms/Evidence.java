...
implements ASN1Choice {
    ...
    private Evidence(ASN1TaggedObject aSN1TaggedObject) {
        if (aSN1TaggedObject.getTagNo() == 0) {
            ...
            this.otherEvidence = ASN1Sequence.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)false);
        } else {
    ...
    public static Evidence getInstance(Object object) {
        if (object == null || object instanceof Evidence) {
            return (Evidence)((Object)object);
        }
        if (object instanceof ASN1TaggedObject) {
            return new Evidence(ASN1TaggedObject.getInstance((Object)object));
        }
