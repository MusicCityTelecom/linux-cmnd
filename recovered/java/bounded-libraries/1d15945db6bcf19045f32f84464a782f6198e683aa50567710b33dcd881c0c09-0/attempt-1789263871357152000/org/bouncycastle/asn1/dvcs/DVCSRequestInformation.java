...
extends ASN1Object {
    ...
    private DVCSRequestInformation(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.getObjectAt(0) instanceof ASN1Integer) {
            aSN1Integer = ASN1Integer.getInstance((Object)aSN1Sequence.getObjectAt(n++));
        ...
        while (n < aSN1Sequence.size()) {
            aSN1Integer = aSN1Sequence.getObjectAt(n);
            if (aSN1Integer instanceof ASN1Integer) {
                ...
                this.requestTime = DVCSTime.getInstance(aSN1Integer);
    ...
    public static DVCSRequestInformation getInstance(Object object) {
        if (object instanceof DVCSRequestInformation) {
            return (DVCSRequestInformation)((Object)object);
        }
        if (object != null) {
    ...
    public static DVCSRequestInformation getInstance(ASN1TaggedObject aSN1TaggedObject, boolean bl) {
        return DVCSRequestInformation.getInstance(ASN1Sequence.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)bl));
    }
    ...
    public String toString() {
        ...
        stringBuffer.append("service: " + (Object)((Object)this.service) + "\n");
        if (this.nonce != null) {
            stringBuffer.append("nonce: " + this.nonce + "\n");
        }
        if (this.requestTime != null) {
            stringBuffer.append("requestTime: " + (Object)((Object)this.requestTime) + "\n");
        }
