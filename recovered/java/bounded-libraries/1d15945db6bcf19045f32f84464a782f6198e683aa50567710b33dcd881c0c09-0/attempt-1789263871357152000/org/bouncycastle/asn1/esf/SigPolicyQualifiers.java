...
extends ASN1Object {
    ...
    public static SigPolicyQualifiers getInstance(Object object) {
        if (object instanceof SigPolicyQualifiers) {
            return (SigPolicyQualifiers)((Object)object);
        }
        if (object instanceof ASN1Sequence) {
            return new SigPolicyQualifiers(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
    ...
    public SigPolicyQualifiers(SigPolicyQualifierInfo[] sigPolicyQualifierInfoArray) {
        this.qualifiers = new DERSequence((ASN1Encodable[])sigPolicyQualifierInfoArray);
    }
