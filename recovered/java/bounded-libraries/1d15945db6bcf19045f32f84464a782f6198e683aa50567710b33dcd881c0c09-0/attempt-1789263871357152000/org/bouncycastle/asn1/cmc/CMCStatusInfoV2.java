...
extends ASN1Object {
    ...
    private CMCStatusInfoV2(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() > 2) {
            if (aSN1Sequence.size() == 4) {
                this.statusString = ASN1UTF8String.getInstance((Object)aSN1Sequence.getObjectAt(2));
    ...
    public static CMCStatusInfoV2 getInstance(Object object) {
        if (object instanceof CMCStatusInfoV2) {
            return (CMCStatusInfoV2)((Object)object);
        }
        if (object != null) {
            return new CMCStatusInfoV2(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
