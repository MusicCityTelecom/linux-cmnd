...
extends ASN1Object {
    ...
    private InfoTypeAndValue(ASN1Sequence aSN1Sequence) {
        this.infoType = ASN1ObjectIdentifier.getInstance((Object)aSN1Sequence.getObjectAt(0));
    ...
    public static InfoTypeAndValue getInstance(Object object) {
        if (object instanceof InfoTypeAndValue) {
            return (InfoTypeAndValue)((Object)object);
        }
        if (object != null) {
            return new InfoTypeAndValue(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
