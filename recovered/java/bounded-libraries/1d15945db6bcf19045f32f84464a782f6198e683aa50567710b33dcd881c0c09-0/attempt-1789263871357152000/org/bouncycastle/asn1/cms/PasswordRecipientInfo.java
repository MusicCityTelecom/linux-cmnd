...
extends ASN1Object {
    ...
    private PasswordRecipientInfo(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.getObjectAt(1) instanceof ASN1TaggedObject) {
            this.keyDerivationAlgorithm = AlgorithmIdentifier.getInstance((ASN1TaggedObject)((ASN1TaggedObject)aSN1Sequence.getObjectAt(1)), (boolean)false);
            ...
            this.keyEncryptionAlgorithm = AlgorithmIdentifier.getInstance((Object)aSN1Sequence.getObjectAt(1));
    ...
    public static PasswordRecipientInfo getInstance(ASN1TaggedObject aSN1TaggedObject, boolean bl) {
        return PasswordRecipientInfo.getInstance(ASN1Sequence.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)bl));
    }

    public static PasswordRecipientInfo getInstance(Object object) {
        if (object instanceof PasswordRecipientInfo) {
            return (PasswordRecipientInfo)((Object)object);
        }
        if (object != null) {
            return new PasswordRecipientInfo(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
