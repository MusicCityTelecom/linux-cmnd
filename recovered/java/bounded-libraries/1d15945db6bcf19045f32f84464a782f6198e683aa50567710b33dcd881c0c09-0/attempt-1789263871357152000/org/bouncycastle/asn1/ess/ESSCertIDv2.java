...
extends ASN1Object {
    ...
    public static ESSCertIDv2 getInstance(Object object) {
        if (object instanceof ESSCertIDv2) {
            return (ESSCertIDv2)((Object)object);
        }
        if (object != null) {
            return new ESSCertIDv2(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
    ...
    private ESSCertIDv2(ASN1Sequence aSN1Sequence) {
        ...
        int n = 0;
        this.hashAlgorithm = aSN1Sequence.getObjectAt(0) instanceof ASN1OctetString ? DEFAULT_ALG_ID : AlgorithmIdentifier.getInstance((Object)aSN1Sequence.getObjectAt(n++).toASN1Primitive());
        this.certHash = ASN1OctetString.getInstance((Object)aSN1Sequence.getObjectAt(n++).toASN1Primitive()).getOctets();
        if (aSN1Sequence.size() > n) {
            this.issuerSerial = IssuerSerial.getInstance((Object)aSN1Sequence.getObjectAt(n));
        }
    }
    ...
    public ESSCertIDv2(AlgorithmIdentifier algorithmIdentifier, byte[] byArray, IssuerSerial issuerSerial) {
        ...
        this.certHash = Arrays.clone((byte[])byArray);
