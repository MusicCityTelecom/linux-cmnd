...
implements ASN1Choice {
    ...
    public DeclarationOfMajority(int n) {
        this.declaration = new DERTaggedObject(false, 0, (ASN1Encodable)new ASN1Integer((long)n));
    }
    ...
    public DeclarationOfMajority(boolean bl, String string) {
        ...
        if (bl) {
            this.declaration = new DERTaggedObject(false, 1, (ASN1Encodable)new DERSequence((ASN1Encodable)new DERPrintableString(string, true)));
        } else {
            ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector(2);
            aSN1EncodableVector.add((ASN1Encodable)ASN1Boolean.FALSE);
            aSN1EncodableVector.add((ASN1Encodable)new DERPrintableString(string, true));
    ...
    public static DeclarationOfMajority getInstance(Object object) {
        if (object == null || object instanceof DeclarationOfMajority) {
            return (DeclarationOfMajority)((Object)object);
        }
