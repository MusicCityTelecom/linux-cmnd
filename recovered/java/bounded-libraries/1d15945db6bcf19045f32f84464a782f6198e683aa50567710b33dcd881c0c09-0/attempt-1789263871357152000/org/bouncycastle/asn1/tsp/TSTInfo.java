...
extends ASN1Object {
    ...
    public static TSTInfo getInstance(Object object) {
        if (object instanceof TSTInfo) {
            return (TSTInfo)((Object)object);
        }
        if (object != null) {
            return new TSTInfo(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if (aSN1Object instanceof ASN1TaggedObject) {
                ...
                switch (aSN1TaggedObject.getTagNo()) {
                    case 0: {
                        this.tsa = GeneralName.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)true);
                        break;
                    }
                    case 1: {
            ...
            this.nonce = ASN1Integer.getInstance((Object)aSN1Object);
        }
    }
