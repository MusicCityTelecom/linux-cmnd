...
public class EncryptedContentInfoParser {
    ...
    public EncryptedContentInfoParser(ASN1SequenceParser aSN1SequenceParser) throws IOException {
        ...
        this._contentEncryptionAlgorithm = AlgorithmIdentifier.getInstance((Object)aSN1SequenceParser.readObject().toASN1Primitive());
    ...
    public ASN1Encodable getEncryptedContent(int n) throws IOException {
        return ASN1Util.parseContextBaseUniversal((ASN1TaggedObjectParser)this._encryptedContent, (int)0, (boolean)false, (int)n);
    }
}
