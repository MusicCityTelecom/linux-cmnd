...
extends ASN1Object {
    ...
    public static SignaturePolicyId getInstance(Object object) {
        if (object instanceof SignaturePolicyId) {
            return (SignaturePolicyId)((Object)object);
        }
        if (object != null) {
            return new SignaturePolicyId(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
    ...
    private SignaturePolicyId(ASN1Sequence aSN1Sequence) {
        ...
        this.sigPolicyId = ASN1ObjectIdentifier.getInstance((Object)aSN1Sequence.getObjectAt(0));
