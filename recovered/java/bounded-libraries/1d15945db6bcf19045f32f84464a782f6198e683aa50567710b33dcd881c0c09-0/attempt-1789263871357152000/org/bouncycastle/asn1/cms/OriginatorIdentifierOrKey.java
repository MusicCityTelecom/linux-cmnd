...
implements ASN1Choice {
    ...
    public static OriginatorIdentifierOrKey getInstance(Object object) {
        if (object == null || object instanceof OriginatorIdentifierOrKey) {
            return (OriginatorIdentifierOrKey)((Object)object);
        }
        ...
        if (object instanceof ASN1TaggedObject) {
            ...
            if (aSN1TaggedObject.getTagNo() == 0) {
                return new OriginatorIdentifierOrKey(SubjectKeyIdentifier.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)false));
            }
    ...
    public SubjectKeyIdentifier getSubjectKeyIdentifier() {
        if (this.id instanceof ASN1TaggedObject && ((ASN1TaggedObject)this.id).getTagNo() == 0) {
            return SubjectKeyIdentifier.getInstance((ASN1TaggedObject)((ASN1TaggedObject)this.id), (boolean)false);
        }
        return null;
    }
