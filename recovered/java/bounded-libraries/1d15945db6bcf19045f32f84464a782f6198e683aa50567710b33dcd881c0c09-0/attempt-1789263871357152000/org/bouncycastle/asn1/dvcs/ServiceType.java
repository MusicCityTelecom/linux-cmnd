...
extends ASN1Object {
    ...
    public static ServiceType getInstance(Object object) {
        if (object instanceof ServiceType) {
            return (ServiceType)((Object)object);
        }
        if (object != null) {
            return new ServiceType(ASN1Enumerated.getInstance((Object)object));
        }
        return null;
    }

    public static ServiceType getInstance(ASN1TaggedObject aSN1TaggedObject, boolean bl) {
        return ServiceType.getInstance(ASN1Enumerated.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)bl));
    }
