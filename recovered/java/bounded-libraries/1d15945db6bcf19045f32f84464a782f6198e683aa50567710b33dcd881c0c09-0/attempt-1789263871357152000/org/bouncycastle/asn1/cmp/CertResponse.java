...
extends ASN1Object {
    ...
    private CertResponse(ASN1Sequence aSN1Sequence) {
        this.certReqId = ASN1Integer.getInstance((Object)aSN1Sequence.getObjectAt(0));
        ...
        if (aSN1Sequence.size() >= 3) {
            if (aSN1Sequence.size() == 3) {
                ...
                if (aSN1Encodable instanceof ASN1OctetString) {
                    this.rspInfo = ASN1OctetString.getInstance((Object)aSN1Encodable);
                } else {
                ...
                this.rspInfo = ASN1OctetString.getInstance((Object)aSN1Sequence.getObjectAt(3));
            }
        }
    }
    ...
    public static CertResponse getInstance(Object object) {
        if (object instanceof CertResponse) {
            return (CertResponse)((Object)object);
        }
        if (object != null) {
            return new CertResponse(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
