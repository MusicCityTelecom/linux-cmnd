...
extends ASN1Object {
    ...
    private RevDetails(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() > 1) {
            this.crlEntryDetails = Extensions.getInstance((Object)aSN1Sequence.getObjectAt(1));
        }
    }

    public static RevDetails getInstance(Object object) {
        if (object instanceof RevDetails) {
            return (RevDetails)((Object)object);
        }
        if (object != null) {
            return new RevDetails(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
    ...
    public RevDetails(CertTemplate certTemplate, X509Extensions x509Extensions) {
        this.certDetails = certTemplate;
        this.crlEntryDetails = Extensions.getInstance((Object)x509Extensions.toASN1Primitive());
    }
