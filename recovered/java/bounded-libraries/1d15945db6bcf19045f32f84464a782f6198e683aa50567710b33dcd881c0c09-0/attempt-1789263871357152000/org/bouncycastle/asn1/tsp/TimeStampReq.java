...
extends ASN1Object {
    ...
    public static TimeStampReq getInstance(Object object) {
        if (object instanceof TimeStampReq) {
            return (TimeStampReq)((Object)object);
        }
        if (object != null) {
    ...
    private TimeStampReq(ASN1Sequence aSN1Sequence) {
        ...
        int n2 = 0;
        this.version = ASN1Integer.getInstance((Object)aSN1Sequence.getObjectAt(n2));
        ...
        for (int i = ++n2; i < n; ++i) {
            if (aSN1Sequence.getObjectAt(i) instanceof ASN1ObjectIdentifier) {
                ...
                this.tsaPolicy = ASN1ObjectIdentifier.getInstance((Object)aSN1Sequence.getObjectAt(i));
                continue;
            }
            if (aSN1Sequence.getObjectAt(i) instanceof ASN1Integer) {
                this.checkOption(this.nonce, i, 3);
                this.nonce = ASN1Integer.getInstance((Object)aSN1Sequence.getObjectAt(i));
                continue;
            }
