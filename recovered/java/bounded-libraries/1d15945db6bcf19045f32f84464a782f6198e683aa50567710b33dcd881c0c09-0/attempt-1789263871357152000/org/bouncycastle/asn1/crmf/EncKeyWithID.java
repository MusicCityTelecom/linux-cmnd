...
extends ASN1Object {
    ...
    public static EncKeyWithID getInstance(Object object) {
        if (object instanceof EncKeyWithID) {
            return (EncKeyWithID)((Object)object);
        }
        if (object != null) {
            return new EncKeyWithID(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }

    private EncKeyWithID(ASN1Sequence aSN1Sequence) {
        this.privKeyInfo = PrivateKeyInfo.getInstance((Object)aSN1Sequence.getObjectAt(0));
        this.identifier = aSN1Sequence.size() > 1 ? (!(aSN1Sequence.getObjectAt(1) instanceof ASN1UTF8String) ? GeneralName.getInstance((Object)aSN1Sequence.getObjectAt(1)) : aSN1Sequence.getObjectAt(1)) : null;
    }
