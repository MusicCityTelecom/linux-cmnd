...
extends ASN1Object {
    ...
    private DVCSErrorNotice(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() > 1) {
            this.transactionIdentifier = GeneralName.getInstance((Object)aSN1Sequence.getObjectAt(1));
        }
    }

    public static DVCSErrorNotice getInstance(Object object) {
        if (object instanceof DVCSErrorNotice) {
            return (DVCSErrorNotice)((Object)object);
        }
        if (object != null) {
            return new DVCSErrorNotice(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }

    public static DVCSErrorNotice getInstance(ASN1TaggedObject aSN1TaggedObject, boolean bl) {
        return DVCSErrorNotice.getInstance(ASN1Sequence.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)bl));
    }
