...
extends ASN1Object {
    ...
    public static POPODecKeyRespContent getInstance(Object object) {
        if (object instanceof POPODecKeyRespContent) {
            return (POPODecKeyRespContent)((Object)object);
        }
        if (object != null) {
            return new POPODecKeyRespContent(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
    ...
    public ASN1Integer[] toASN1IntegerArray() {
        ...
        for (int i = 0; i != aSN1IntegerArray.length; ++i) {
            aSN1IntegerArray[i] = ASN1Integer.getInstance((Object)this.content.getObjectAt(i));
        }
