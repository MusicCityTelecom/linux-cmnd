...
implements ASN1Choice {
    ...
    public static AttrOrOID getInstance(Object object) {
        if (object instanceof AttrOrOID) {
            return (AttrOrOID)((Object)object);
        }
        if (object != null) {
            if (object instanceof ASN1Encodable) {
                ...
                if (aSN1Primitive instanceof ASN1Sequence) {
                    return new AttrOrOID(Attribute.getInstance((Object)aSN1Primitive));
                }
            }
            if (object instanceof byte[]) {
                try {
                    return AttrOrOID.getInstance(ASN1Primitive.fromByteArray((byte[])((byte[])object)));
                }
