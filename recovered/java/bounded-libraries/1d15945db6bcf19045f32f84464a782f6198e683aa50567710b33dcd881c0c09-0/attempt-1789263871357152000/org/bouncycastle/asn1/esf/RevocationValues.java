...
extends ASN1Object {
    ...
    public static RevocationValues getInstance(Object object) {
        if (object instanceof RevocationValues) {
            return (RevocationValues)((Object)object);
        }
        if (object != null) {
    ...
    public CertificateList[] getCrlVals() {
        ...
        for (int i = 0; i < certificateListArray.length; ++i) {
            certificateListArray[i] = CertificateList.getInstance((Object)this.crlVals.getObjectAt(i));
        }
    ...
    public BasicOCSPResponse[] getOcspVals() {
        ...
        for (int i = 0; i < basicOCSPResponseArray.length; ++i) {
            basicOCSPResponseArray[i] = BasicOCSPResponse.getInstance((Object)this.ocspVals.getObjectAt(i));
        }
