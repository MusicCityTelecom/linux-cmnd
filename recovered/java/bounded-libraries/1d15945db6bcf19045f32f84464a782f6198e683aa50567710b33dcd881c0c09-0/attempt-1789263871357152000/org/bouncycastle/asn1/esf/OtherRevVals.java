...
extends ASN1Object {
    ...
    public static OtherRevVals getInstance(Object object) {
        if (object instanceof OtherRevVals) {
            return (OtherRevVals)((Object)object);
        }
        if (object != null) {
            return new OtherRevVals(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
    ...
    private OtherRevVals(ASN1Sequence aSN1Sequence) {
        ...
        try {
            this.otherRevVals = ASN1Primitive.fromByteArray((byte[])aSN1Sequence.getObjectAt(1).toASN1Primitive().getEncoded("DER"));
        }
