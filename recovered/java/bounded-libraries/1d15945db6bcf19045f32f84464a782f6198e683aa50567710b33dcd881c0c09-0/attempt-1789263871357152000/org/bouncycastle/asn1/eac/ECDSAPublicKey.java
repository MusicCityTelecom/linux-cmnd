...
extends PublicKeyDataObject {
        ...
        while (enumeration.hasMoreElements()) {
            ...
            if (e instanceof ASN1TaggedObject) {
                ...
                switch (aSN1TaggedObject.getTagNo()) {
                    ...
                    case 4: {
                        this.setBasePointG(ASN1OctetString.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)false));
                        break;
                    }
                    case 5: {
                    ...
                    case 6: {
                        this.setPublicPointY(ASN1OctetString.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)false));
                        break;
                    }
                    case 7: {
    ...
    public ECDSAPublicKey(ASN1ObjectIdentifier aSN1ObjectIdentifier, byte[] byArray) throws IllegalArgumentException {
        ...
        this.setPublicPointY((ASN1OctetString)new DEROctetString(byArray));
    }
    ...
    public ECDSAPublicKey(ASN1ObjectIdentifier aSN1ObjectIdentifier, BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, byte[] byArray, BigInteger bigInteger4, byte[] byArray2, int n) {
        ...
        this.setBasePointG((ASN1OctetString)new DEROctetString(byArray));
        this.setOrderOfBasePointR(bigInteger4);
        this.setPublicPointY((ASN1OctetString)new DEROctetString(byArray2));
    ...
    public ASN1EncodableVector getASN1EncodableVector(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean bl) {
        ...
        if (!bl) {
            aSN1EncodableVector.add((ASN1Encodable)new UnsignedInteger(1, this.getPrimeModulusP()));
            aSN1EncodableVector.add((ASN1Encodable)new UnsignedInteger(2, this.getFirstCoefA()));
            aSN1EncodableVector.add((ASN1Encodable)new UnsignedInteger(3, this.getSecondCoefB()));
            aSN1EncodableVector.add((ASN1Encodable)new DERTaggedObject(false, 4, (ASN1Encodable)new DEROctetString(this.getBasePointG())));
            aSN1EncodableVector.add((ASN1Encodable)new UnsignedInteger(5, this.getOrderOfBasePointR()));
        }
        aSN1EncodableVector.add((ASN1Encodable)new DERTaggedObject(false, 6, (ASN1Encodable)new DEROctetString(this.getPublicPointY())));
        if (!bl) {
            aSN1EncodableVector.add((ASN1Encodable)new UnsignedInteger(7, this.getCofactorF()));
        }
