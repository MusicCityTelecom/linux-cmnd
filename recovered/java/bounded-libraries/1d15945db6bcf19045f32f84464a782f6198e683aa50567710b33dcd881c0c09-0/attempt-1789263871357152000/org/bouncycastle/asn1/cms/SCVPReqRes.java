...
extends ASN1Object {
    ...
    public static SCVPReqRes getInstance(Object object) {
        if (object instanceof SCVPReqRes) {
            return (SCVPReqRes)((Object)object);
        }
        if (object != null) {
            return new SCVPReqRes(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
    ...
    private SCVPReqRes(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.getObjectAt(0) instanceof ASN1TaggedObject) {
            this.request = ContentInfo.getInstance(ASN1TaggedObject.getInstance((Object)aSN1Sequence.getObjectAt(0)), true);
