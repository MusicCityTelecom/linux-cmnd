...
extends ASN1Object {
    ...
    public static OcspListID getInstance(Object object) {
        if (object instanceof OcspListID) {
            return (OcspListID)((Object)object);
        }
        if (object != null) {
            return new OcspListID(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
    ...
    public OcspListID(OcspResponsesID[] ocspResponsesIDArray) {
        this.ocspResponses = new DERSequence((ASN1Encodable[])ocspResponsesIDArray);
    }
