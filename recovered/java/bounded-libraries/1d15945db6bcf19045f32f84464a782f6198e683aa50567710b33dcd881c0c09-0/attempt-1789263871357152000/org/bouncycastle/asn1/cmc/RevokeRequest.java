...
extends ASN1Object {
    ...
    private RevokeRequest(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() > n && aSN1Sequence.getObjectAt(n).toASN1Primitive() instanceof ASN1GeneralizedTime) {
            this.invalidityDate = ASN1GeneralizedTime.getInstance((Object)aSN1Sequence.getObjectAt(n++));
        }
        if (aSN1Sequence.size() > n && aSN1Sequence.getObjectAt(n).toASN1Primitive() instanceof ASN1OctetString) {
            this.passphrase = ASN1OctetString.getInstance((Object)aSN1Sequence.getObjectAt(n++));
        }
        if (aSN1Sequence.size() > n && aSN1Sequence.getObjectAt(n).toASN1Primitive() instanceof ASN1UTF8String) {
            this.comment = ASN1UTF8String.getInstance((Object)aSN1Sequence.getObjectAt(n));
        }
    }

    public static RevokeRequest getInstance(Object object) {
        if (object instanceof RevokeRequest) {
            return (RevokeRequest)((Object)object);
        }
        if (object != null) {
            return new RevokeRequest(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
