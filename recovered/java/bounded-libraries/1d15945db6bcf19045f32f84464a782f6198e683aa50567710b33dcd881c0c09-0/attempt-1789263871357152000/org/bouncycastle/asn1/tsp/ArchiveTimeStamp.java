...
extends ASN1Object {
    ...
    public static ArchiveTimeStamp getInstance(Object object) {
        if (object instanceof ArchiveTimeStamp) {
            return (ArchiveTimeStamp)((Object)object);
        }
        if (object != null) {
            return new ArchiveTimeStamp(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
    ...
    public ArchiveTimeStamp(AlgorithmIdentifier algorithmIdentifier, Attributes attributes, PartialHashtree[] partialHashtreeArray, ContentInfo contentInfo) {
        ...
        this.reducedHashTree = partialHashtreeArray != null ? new DERSequence((ASN1Encodable[])partialHashtreeArray) : null;
    ...
    private ArchiveTimeStamp(ASN1Sequence aSN1Sequence) {
        ...
        block5: for (int i = 0; i < aSN1Sequence.size() - 1; ++i) {
            ...
            switch (aSN1TaggedObject.getTagNo()) {
                ...
                case 2: {
                    aSN1Sequence2 = ASN1Sequence.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)false);
                    continue block5;
                }
                default: {
