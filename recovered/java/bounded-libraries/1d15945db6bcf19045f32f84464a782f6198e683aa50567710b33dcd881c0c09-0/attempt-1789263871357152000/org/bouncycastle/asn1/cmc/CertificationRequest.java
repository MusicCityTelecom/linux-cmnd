...
extends ASN1Object {
    ...
    private CertificationRequest(ASN1Sequence aSN1Sequence) {
        ...
        this.certificationRequestInfo = new CertificationRequestInfo(ASN1Sequence.getInstance((Object)aSN1Sequence.getObjectAt(0)));
    ...
    public static CertificationRequest getInstance(Object object) {
        if (object instanceof CertificationRequest) {
            return (CertificationRequest)((Object)object);
        }
        if (object != null) {
            return new CertificationRequest(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
    ...
    extends ASN1Object {
        ...
        private CertificationRequestInfo(ASN1Sequence aSN1Sequence) {
            ...
            this.subject = X500Name.getInstance((Object)aSN1Sequence.getObjectAt(1));
            this.subjectPublicKeyInfo = ASN1Sequence.getInstance((Object)aSN1Sequence.getObjectAt(2));
            ...
            this.attributes = ASN1Set.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)false);
        }
