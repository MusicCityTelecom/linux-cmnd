...
extends ASN1Object {
    ...
    private Accuracy(ASN1Sequence aSN1Sequence) {
        ...
        block4: for (int i = 0; i < aSN1Sequence.size(); ++i) {
            ...
            switch (aSN1TaggedObject.getTagNo()) {
                case 0: {
                    this.millis = ASN1Integer.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)false);
                    int n = this.millis.intValueExact();
                    if (n >= 1 && n <= 999) continue block4;
                    throw new IllegalArgumentException("Invalid millis field : not in (1..999)");
                }
                case 1: {
                    this.micros = ASN1Integer.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)false);
    ...
    public static Accuracy getInstance(Object object) {
        if (object instanceof Accuracy) {
            return (Accuracy)((Object)object);
        }
        if (object != null) {
            return new Accuracy(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
