...
extends ASN1Object {
    ...
    public static ErrorMsgContent getInstance(Object object) {
        if (object instanceof ErrorMsgContent) {
            return (ErrorMsgContent)((Object)object);
        }
        if (object != null) {
            return new ErrorMsgContent(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        this.addOptional(aSN1EncodableVector, (ASN1Encodable)this.errorCode);
        this.addOptional(aSN1EncodableVector, (ASN1Encodable)this.errorDetails);
