...
extends ASN1Object {
    ...
    public static ContentIdentifier getInstance(Object object) {
        if (object instanceof ContentIdentifier) {
            return (ContentIdentifier)((Object)object);
        }
        if (object != null) {
            return new ContentIdentifier(ASN1OctetString.getInstance((Object)object));
        }
        return null;
    }
    ...
    public ContentIdentifier(byte[] byArray) {
        this((ASN1OctetString)new DEROctetString(byArray));
    }
