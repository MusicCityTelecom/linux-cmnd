...
extends ASN1Object {
    ...
    public static OtherCertID getInstance(Object object) {
        if (object instanceof OtherCertID) {
            return (OtherCertID)((Object)object);
        }
        if (object != null) {
            return new OtherCertID(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
    ...
    private OtherCertID(ASN1Sequence aSN1Sequence) {
        ...
        this.otherCertHash = aSN1Sequence.getObjectAt(0).toASN1Primitive() instanceof ASN1OctetString ? ASN1OctetString.getInstance((Object)aSN1Sequence.getObjectAt(0)) : DigestInfo.getInstance((Object)aSN1Sequence.getObjectAt(0));
        if (aSN1Sequence.size() > 1) {
            this.issuerSerial = IssuerSerial.getInstance((Object)aSN1Sequence.getObjectAt(1));
        }
    }
