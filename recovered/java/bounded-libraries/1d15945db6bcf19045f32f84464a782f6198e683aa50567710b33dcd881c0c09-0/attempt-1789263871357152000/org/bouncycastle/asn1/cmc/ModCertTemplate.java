...
extends ASN1Object {
    ...
    public static ModCertTemplate getInstance(Object object) {
        if (object instanceof ModCertTemplate) {
            return (ModCertTemplate)((Object)object);
        }
        if (object != null) {
            return new ModCertTemplate(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (!this.replace) {
            aSN1EncodableVector.add((ASN1Encodable)ASN1Boolean.getInstance((boolean)this.replace));
        }
