...
extends ASN1Object {
    ...
    public static OtherMsg getInstance(Object object) {
        if (object instanceof OtherMsg) {
            return (OtherMsg)((Object)object);
        }
        if (object != null) {
            return new OtherMsg(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }

    public static OtherMsg getInstance(ASN1TaggedObject aSN1TaggedObject, boolean bl) {
        return OtherMsg.getInstance(ASN1Sequence.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)bl));
    }
