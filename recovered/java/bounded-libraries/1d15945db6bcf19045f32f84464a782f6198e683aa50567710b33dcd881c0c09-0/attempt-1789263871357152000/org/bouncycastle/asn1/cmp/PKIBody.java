...
implements ASN1Choice {
    ...
    private PKIBody(ASN1TaggedObject aSN1TaggedObject) {
        ...
        this.body = PKIBody.getBodyForType(this.tagNo, (ASN1Encodable)aSN1TaggedObject.getObject());
    }
    ...
    private static ASN1Encodable getBodyForType(int n, ASN1Encodable aSN1Encodable) {
        switch (n) {
            ...
            case 4: {
                return CertificationRequest.getInstance((Object)aSN1Encodable);
            }
            case 5: {
