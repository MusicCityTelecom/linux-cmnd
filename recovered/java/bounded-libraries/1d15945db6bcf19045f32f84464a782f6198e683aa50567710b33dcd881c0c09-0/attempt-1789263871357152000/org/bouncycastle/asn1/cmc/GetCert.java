...
extends ASN1Object {
    ...
    private GetCert(ASN1Sequence aSN1Sequence) {
        ...
        this.issuerName = GeneralName.getInstance((Object)aSN1Sequence.getObjectAt(0));
    ...
    public static GetCert getInstance(Object object) {
        if (object instanceof GetCert) {
            return (GetCert)((Object)object);
        }
        if (object != null) {
            return new GetCert(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
