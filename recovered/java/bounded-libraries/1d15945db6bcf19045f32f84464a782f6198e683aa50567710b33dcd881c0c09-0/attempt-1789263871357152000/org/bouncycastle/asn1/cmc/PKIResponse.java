...
extends ASN1Object {
    ...
    private PKIResponse(ASN1Sequence aSN1Sequence) {
        ...
        this.controlSequence = ASN1Sequence.getInstance((Object)aSN1Sequence.getObjectAt(0));
        this.cmsSequence = ASN1Sequence.getInstance((Object)aSN1Sequence.getObjectAt(1));
        this.otherMsgSequence = ASN1Sequence.getInstance((Object)aSN1Sequence.getObjectAt(2));
    }

    public static PKIResponse getInstance(Object object) {
        if (object instanceof PKIResponse) {
            return (PKIResponse)((Object)object);
        }
        if (object != null) {
            return new PKIResponse(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }

    public static PKIResponse getInstance(ASN1TaggedObject aSN1TaggedObject, boolean bl) {
        return PKIResponse.getInstance(ASN1Sequence.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)bl));
    }
