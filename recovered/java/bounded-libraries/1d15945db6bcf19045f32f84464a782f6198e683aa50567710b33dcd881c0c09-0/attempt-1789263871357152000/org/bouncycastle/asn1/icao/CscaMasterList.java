...
extends ASN1Object {
    ...
    public static CscaMasterList getInstance(Object object) {
        if (object instanceof CscaMasterList) {
            return (CscaMasterList)((Object)object);
        }
        if (object != null) {
            return new CscaMasterList(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
    ...
    private CscaMasterList(ASN1Sequence aSN1Sequence) {
        ...
        ASN1Set aSN1Set = ASN1Set.getInstance((Object)aSN1Sequence.getObjectAt(1));
        this.certList = new Certificate[aSN1Set.size()];
        for (int i = 0; i < this.certList.length; ++i) {
            this.certList[i] = Certificate.getInstance((Object)aSN1Set.getObjectAt(i));
        }
    }
