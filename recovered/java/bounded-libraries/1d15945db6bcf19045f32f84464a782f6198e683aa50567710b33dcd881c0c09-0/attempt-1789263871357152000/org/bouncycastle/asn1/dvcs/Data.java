...
implements ASN1Choice {
    ...
    public Data(TargetEtcChain[] targetEtcChainArray) {
        this.certs = new DERSequence((ASN1Encodable[])targetEtcChainArray);
    }
    ...
    public static Data getInstance(Object object) {
        ...
        if (object instanceof ASN1Sequence) {
            return new Data(DigestInfo.getInstance((Object)object));
        }
        if (object instanceof ASN1TaggedObject) {
            return new Data(ASN1Sequence.getInstance((ASN1TaggedObject)((ASN1TaggedObject)object), (boolean)false));
        }
