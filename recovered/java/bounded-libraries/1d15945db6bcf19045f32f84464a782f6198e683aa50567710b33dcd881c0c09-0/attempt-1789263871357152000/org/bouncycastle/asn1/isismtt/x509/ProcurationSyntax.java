...
extends ASN1Object {
    ...
    public static ProcurationSyntax getInstance(Object object) {
        if (object == null || object instanceof ProcurationSyntax) {
            return (ProcurationSyntax)((Object)object);
        }
    ...
    private ProcurationSyntax(ASN1Sequence aSN1Sequence) {
        ...
        block5: while (enumeration.hasMoreElements()) {
            ...
            switch (aSN1TaggedObject.getTagNo()) {
                case 1: {
                    this.country = ASN1PrintableString.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)true).getString();
                    continue block5;
                }
                case 2: {
                    this.typeOfSubstitution = DirectoryString.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)true);
                    continue block5;
                }
                case 3: {
                    ASN1Primitive aSN1Primitive = aSN1TaggedObject.getObject();
                    if (aSN1Primitive instanceof ASN1TaggedObject) {
                        this.thirdPerson = GeneralName.getInstance((Object)aSN1Primitive);
                        continue block5;
                    }
                    this.certRef = IssuerSerial.getInstance((Object)aSN1Primitive);
                    continue block5;
                }
            }
