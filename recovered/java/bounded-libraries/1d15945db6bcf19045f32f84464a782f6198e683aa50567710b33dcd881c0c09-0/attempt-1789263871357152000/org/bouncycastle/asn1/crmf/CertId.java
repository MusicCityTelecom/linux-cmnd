...
extends ASN1Object {
    ...
    private CertId(ASN1Sequence aSN1Sequence) {
        this.issuer = GeneralName.getInstance((Object)aSN1Sequence.getObjectAt(0));
    ...
    public static CertId getInstance(Object object) {
        if (object instanceof CertId) {
            return (CertId)((Object)object);
        }
        if (object != null) {
            return new CertId(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }

    public static CertId getInstance(ASN1TaggedObject aSN1TaggedObject, boolean bl) {
        return CertId.getInstance(ASN1Sequence.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)bl));
    }
