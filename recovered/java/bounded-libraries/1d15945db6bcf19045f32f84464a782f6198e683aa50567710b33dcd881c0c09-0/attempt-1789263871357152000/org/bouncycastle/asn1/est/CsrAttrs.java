...
extends ASN1Object {
    ...
    public static CsrAttrs getInstance(Object object) {
        if (object instanceof CsrAttrs) {
            return (CsrAttrs)((Object)object);
        }
        if (object != null) {
            return new CsrAttrs(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }

    public static CsrAttrs getInstance(ASN1TaggedObject aSN1TaggedObject, boolean bl) {
        return CsrAttrs.getInstance(ASN1Sequence.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)bl));
    }
