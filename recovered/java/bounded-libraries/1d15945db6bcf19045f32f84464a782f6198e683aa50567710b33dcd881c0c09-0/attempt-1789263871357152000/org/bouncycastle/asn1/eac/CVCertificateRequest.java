...
extends ASN1Object {
    ...
    private CVCertificateRequest(ASN1ApplicationSpecific aSN1ApplicationSpecific) throws IOException {
        ...
        if (aSN1ApplicationSpecific.isConstructed() && aSN1ApplicationSpecific.getApplicationTag() == 7) {
            ASN1Sequence aSN1Sequence = ASN1Sequence.getInstance((Object)aSN1ApplicationSpecific.getObject(16));
            this.initCertBody(ASN1ApplicationSpecific.getInstance((Object)aSN1Sequence.getObjectAt(0)));
    ...
    public static CVCertificateRequest getInstance(Object object) {
        if (object instanceof CVCertificateRequest) {
            return (CVCertificateRequest)((Object)object);
        }
        if (object != null) {
            try {
                return new CVCertificateRequest(ASN1ApplicationSpecific.getInstance((Object)object));
            }
            catch (IOException iOException) {
                throw new ASN1ParsingException("unable to parse data: " + iOException.getMessage(), (Throwable)iOException);
            }
        }
        return null;
    }
