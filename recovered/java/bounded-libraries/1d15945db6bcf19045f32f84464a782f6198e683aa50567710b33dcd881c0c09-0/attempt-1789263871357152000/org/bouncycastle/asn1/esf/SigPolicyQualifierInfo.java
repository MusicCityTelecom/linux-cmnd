...
extends ASN1Object {
    ...
    private SigPolicyQualifierInfo(ASN1Sequence aSN1Sequence) {
        this.sigPolicyQualifierId = ASN1ObjectIdentifier.getInstance((Object)aSN1Sequence.getObjectAt(0));
    ...
    public static SigPolicyQualifierInfo getInstance(Object object) {
        if (object instanceof SigPolicyQualifierInfo) {
            return (SigPolicyQualifierInfo)((Object)object);
        }
        if (object != null) {
            return new SigPolicyQualifierInfo(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
