...
public class EnvelopedDataParser {
    ...
    public EnvelopedDataParser(ASN1SequenceParser aSN1SequenceParser) throws IOException {
        ...
        this._version = ASN1Integer.getInstance((Object)aSN1SequenceParser.readObject());
    }
    ...
    public ASN1SetParser getUnprotectedAttrs() throws IOException {
        ...
        if (this._nextObject != null) {
            ...
            this._nextObject = null;
            return (ASN1SetParser)ASN1Util.parseContextBaseUniversal((ASN1TaggedObjectParser)aSN1TaggedObjectParser, (int)1, (boolean)false, (int)17);
        }
        return null;
    }
}
