...
implements ASN1Choice {
    ...
    public static TaggedRequest getInstance(Object object) {
        if (object instanceof TaggedRequest) {
            return (TaggedRequest)((Object)object);
        }
        if (object != null) {
            if (object instanceof ASN1Encodable) {
                ASN1TaggedObject aSN1TaggedObject = ASN1TaggedObject.getInstance((Object)((ASN1Encodable)object).toASN1Primitive());
                switch (aSN1TaggedObject.getTagNo()) {
                    ...
                    case 2: {
                        return new TaggedRequest(ASN1Sequence.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)false));
                    }
                }
            ...
            if (object instanceof byte[]) {
                try {
                    return TaggedRequest.getInstance(ASN1Primitive.fromByteArray((byte[])((byte[])object)));
                }
