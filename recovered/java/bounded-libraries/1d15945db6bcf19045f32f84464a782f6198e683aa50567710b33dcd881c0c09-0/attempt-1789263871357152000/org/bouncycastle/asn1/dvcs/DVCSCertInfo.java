...
extends ASN1Object {
    ...
    private DVCSCertInfo(ASN1Sequence aSN1Sequence) {
        ...
        try {
            aSN1Integer = ASN1Integer.getInstance((Object)aSN1Encodable);
        ...
        aSN1Encodable = aSN1Sequence.getObjectAt(n++);
        this.messageImprint = DigestInfo.getInstance((Object)aSN1Encodable);
        aSN1Encodable = aSN1Sequence.getObjectAt(n++);
        this.serialNumber = ASN1Integer.getInstance((Object)aSN1Encodable);
        aSN1Encodable = aSN1Sequence.getObjectAt(n++);
        ...
        block10: while (n < aSN1Sequence.size()) {
            if ((aSN1Encodable = aSN1Sequence.getObjectAt(n++)) instanceof ASN1TaggedObject) {
                aSN1Integer = ASN1TaggedObject.getInstance((Object)aSN1Encodable);
                int n2 = aSN1Integer.getTagNo();
                switch (n2) {
                    case 0: {
                        this.dvStatus = PKIStatusInfo.getInstance((ASN1TaggedObject)aSN1Integer, false);
                        continue block10;
                    }
                    case 1: {
                        this.policy = PolicyInformation.getInstance((Object)ASN1Sequence.getInstance((ASN1TaggedObject)aSN1Integer, (boolean)false));
                        continue block10;
                    }
                    case 2: {
                        this.reqSignature = ASN1Set.getInstance((ASN1TaggedObject)aSN1Integer, (boolean)false);
                        continue block10;
                    }
                    case 3: {
                        this.certs = ASN1Sequence.getInstance((ASN1TaggedObject)aSN1Integer, (boolean)false);
                        continue block10;
                    }
                }
            ...
            try {
                this.extensions = Extensions.getInstance((Object)aSN1Encodable);
            }
            catch (IllegalArgumentException illegalArgumentException) {}
        }
    }
    ...
    public static DVCSCertInfo getInstance(Object object) {
        if (object instanceof DVCSCertInfo) {
            return (DVCSCertInfo)((Object)object);
        }
        if (object != null) {
            return new DVCSCertInfo(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }

    public static DVCSCertInfo getInstance(ASN1TaggedObject aSN1TaggedObject, boolean bl) {
        return DVCSCertInfo.getInstance(ASN1Sequence.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)bl));
    }
    ...
    public String toString() {
        ...
        stringBuffer.append("dvReqInfo: " + (Object)((Object)this.dvReqInfo) + "\n");
        stringBuffer.append("messageImprint: " + this.messageImprint + "\n");
        stringBuffer.append("serialNumber: " + this.serialNumber + "\n");
        stringBuffer.append("responseTime: " + (Object)((Object)this.responseTime) + "\n");
        if (this.dvStatus != null) {
            stringBuffer.append("dvStatus: " + (Object)((Object)this.dvStatus) + "\n");
        }
        if (this.policy != null) {
