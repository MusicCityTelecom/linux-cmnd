...
extends ASN1Object {
    ...
    private MQVuserKeyingMaterial(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() > 1) {
            this.addedukm = ASN1OctetString.getInstance((ASN1TaggedObject)((ASN1TaggedObject)aSN1Sequence.getObjectAt(1)), (boolean)true);
        }
    }

    public static MQVuserKeyingMaterial getInstance(ASN1TaggedObject aSN1TaggedObject, boolean bl) {
        return MQVuserKeyingMaterial.getInstance(ASN1Sequence.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)bl));
    }

    public static MQVuserKeyingMaterial getInstance(Object object) {
        if (object instanceof MQVuserKeyingMaterial) {
            return (MQVuserKeyingMaterial)((Object)object);
        }
        if (object != null) {
            return new MQVuserKeyingMaterial(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
