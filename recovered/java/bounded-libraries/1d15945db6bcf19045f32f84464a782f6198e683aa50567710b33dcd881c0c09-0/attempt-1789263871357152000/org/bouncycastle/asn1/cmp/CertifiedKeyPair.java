...
extends ASN1Object {
    ...
    private CertifiedKeyPair(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Sequence.size() >= 2) {
            if (aSN1Sequence.size() == 2) {
                ...
                this.privateKey = EncryptedKey.getInstance(ASN1TaggedObject.getInstance((Object)aSN1Sequence.getObjectAt(1)).getObject());
                this.publicationInfo = PKIPublicationInfo.getInstance(ASN1TaggedObject.getInstance((Object)aSN1Sequence.getObjectAt(2)).getObject());
            }
        }
    }
    ...
    public static CertifiedKeyPair getInstance(Object object) {
        if (object instanceof CertifiedKeyPair) {
            return (CertifiedKeyPair)((Object)object);
        }
        if (object != null) {
            return new CertifiedKeyPair(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
