...
implements ASN1Choice {
    ...
    public CMPCertificate(AttributeCertificate attributeCertificate) {
        this(1, (ASN1Object)attributeCertificate);
    }
    ...
    public static CMPCertificate getInstance(Object object) {
        if (object == null || object instanceof CMPCertificate) {
            return (CMPCertificate)((Object)object);
        }
        if (object instanceof byte[]) {
            try {
                object = ASN1Primitive.fromByteArray((byte[])((byte[])object));
            }
        ...
        if (object instanceof ASN1Sequence) {
            return new CMPCertificate(Certificate.getInstance((Object)object));
        }
