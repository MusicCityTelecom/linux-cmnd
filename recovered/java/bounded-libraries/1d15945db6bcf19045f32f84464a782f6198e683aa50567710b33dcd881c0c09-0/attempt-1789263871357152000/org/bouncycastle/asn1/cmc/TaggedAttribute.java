...
extends ASN1Object {
    ...
    public static TaggedAttribute getInstance(Object object) {
        if (object instanceof TaggedAttribute) {
            return (TaggedAttribute)((Object)object);
        }
        if (object != null) {
            return new TaggedAttribute(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
    ...
    private TaggedAttribute(ASN1Sequence aSN1Sequence) {
        ...
        this.attrValues = ASN1Set.getInstance((Object)aSN1Sequence.getObjectAt(2));
    }
