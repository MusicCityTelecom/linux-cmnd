...
extends ASN1Object {
    ...
    private MetaData(ASN1Sequence aSN1Sequence) {
        ...
        if (n < aSN1Sequence.size() && aSN1Sequence.getObjectAt(n) instanceof ASN1UTF8String) {
            this.fileName = ASN1UTF8String.getInstance((Object)aSN1Sequence.getObjectAt(n++));
        }
        if (n < aSN1Sequence.size() && aSN1Sequence.getObjectAt(n) instanceof ASN1IA5String) {
            this.mediaType = ASN1IA5String.getInstance((Object)aSN1Sequence.getObjectAt(n++));
        }
    ...
    public static MetaData getInstance(Object object) {
        ...
        if (object != null) {
            return new MetaData(ASN1Sequence.getInstance((Object)object));
        }
        return null;
    }
