    ...
    public static List<OSSession> queryUserSessions() {
        ...
        if (IS_VISTA_OR_GREATER) {
            try (ByRef.CloseablePointerByReference ppSessionInfo = new ByRef.CloseablePointerByReference();
                ...
                if (WTS.WTSEnumerateSessions(Wtsapi32.WTS_CURRENT_SERVER_HANDLE, 0, 1, (PointerByReference)ppSessionInfo, (IntByReference)pCount)) {
                    ...
                    if (pCount.getValue() > 0) {
                        ...
                        for (Wtsapi32.WTS_SESSION_INFO session : sessionInfo = (Wtsapi32.WTS_SESSION_INFO[])sessionInfoRef.toArray(pCount.getValue())) {
                            ...
                            WTS.WTSQuerySessionInformation(Wtsapi32.WTS_CURRENT_SERVER_HANDLE, session.SessionId, 16, (PointerByReference)ppBuffer, (IntByReference)pBytes);
                            ...
                            WTS.WTSQuerySessionInformation(Wtsapi32.WTS_CURRENT_SERVER_HANDLE, session.SessionId, 24, (PointerByReference)ppBuffer, (IntByReference)pBytes);
                            ...
                            WTS.WTSFreeMemory(pBuffer);
                            WTS.WTSQuerySessionInformation(Wtsapi32.WTS_CURRENT_SERVER_HANDLE, session.SessionId, 14, (PointerByReference)ppBuffer, (IntByReference)pBytes);
                            pBuffer = ppBuffer.getValue();
