...
public final class PerfmonDisabled {
    ...
    private static boolean isDisabled(String config, String service) {
        ...
        if (Util.isBlank(perfDisabled)) {
            ...
            if (Advapi32Util.registryValueExists((WinReg.HKEY)WinReg.HKEY_LOCAL_MACHINE, (String)key, (String)(value = "Disable Performance Counters"))) {
                Object disabled = Advapi32Util.registryGetValue((WinReg.HKEY)WinReg.HKEY_LOCAL_MACHINE, (String)key, (String)value);
