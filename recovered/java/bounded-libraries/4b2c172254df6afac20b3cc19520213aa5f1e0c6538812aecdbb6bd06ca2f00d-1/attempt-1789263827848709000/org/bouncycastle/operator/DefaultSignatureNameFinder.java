...
implements AlgorithmNameFinder {
    ...
    public String getAlgorithmName(AlgorithmIdentifier algorithmIdentifier) {
        ...
        if (aSN1Encodable != null && !DERNull.INSTANCE.equals(aSN1Encodable) && algorithmIdentifier.getAlgorithm().equals((ASN1Primitive)PKCSObjectIdentifiers.id_RSASSA_PSS)) {
            RSASSAPSSparams rSASSAPSSparams = RSASSAPSSparams.getInstance((Object)aSN1Encodable);
            AlgorithmIdentifier algorithmIdentifier2 = rSASSAPSSparams.getMaskGenAlgorithm();
            if (algorithmIdentifier2.getAlgorithm().equals((ASN1Primitive)PKCSObjectIdentifiers.id_mgf1)) {
                AlgorithmIdentifier algorithmIdentifier3 = rSASSAPSSparams.getHashAlgorithm();
                ASN1ObjectIdentifier aSN1ObjectIdentifier = AlgorithmIdentifier.getInstance((Object)algorithmIdentifier2.getParameters()).getAlgorithm();
                if (aSN1ObjectIdentifier.equals((ASN1Primitive)algorithmIdentifier3.getAlgorithm())) {
