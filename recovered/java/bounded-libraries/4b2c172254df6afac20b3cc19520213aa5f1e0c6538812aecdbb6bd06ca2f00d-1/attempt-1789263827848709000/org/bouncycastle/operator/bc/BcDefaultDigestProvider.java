...
implements BcDigestProvider {
    ...
    private static Map createTable() {
        ...
        hashMap.put(NISTObjectIdentifiers.id_shake128_len, new BcDigestProvider(){
            ...
            public ExtendedDigest get(AlgorithmIdentifier algorithmIdentifier) {
                return new AdjustedXof((Xof)new SHAKEDigest(128), ASN1Integer.getInstance((Object)algorithmIdentifier.getParameters()).intValueExact());
            }
        });
        hashMap.put(NISTObjectIdentifiers.id_shake256_len, new BcDigestProvider(){

            public ExtendedDigest get(AlgorithmIdentifier algorithmIdentifier) {
                return new AdjustedXof((Xof)new SHAKEDigest(256), ASN1Integer.getInstance((Object)algorithmIdentifier.getParameters()).intValueExact());
            }
        });
