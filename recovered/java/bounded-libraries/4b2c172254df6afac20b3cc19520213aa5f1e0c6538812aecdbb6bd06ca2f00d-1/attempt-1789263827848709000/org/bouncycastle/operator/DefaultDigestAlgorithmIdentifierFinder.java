...
implements DigestAlgorithmIdentifierFinder {
    ...
    private static void addDigestAlgId(ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean bl) {
        AlgorithmIdentifier algorithmIdentifier = bl ? new AlgorithmIdentifier(aSN1ObjectIdentifier, (ASN1Encodable)DERNull.INSTANCE) : new AlgorithmIdentifier(aSN1ObjectIdentifier);
    ...
    public AlgorithmIdentifier find(AlgorithmIdentifier algorithmIdentifier) {
        ...
        ASN1ObjectIdentifier aSN1ObjectIdentifier2 = aSN1ObjectIdentifier.equals((ASN1Primitive)PKCSObjectIdentifiers.id_RSASSA_PSS) ? RSASSAPSSparams.getInstance((Object)algorithmIdentifier.getParameters()).getHashAlgorithm().getAlgorithm() : (aSN1ObjectIdentifier.equals((ASN1Primitive)EdECObjectIdentifiers.id_Ed25519) ? NISTObjectIdentifiers.id_sha512 : (ASN1ObjectIdentifier)digestOids.get(algorithmIdentifier.getAlgorithm()));
