...
public class JceInputDecryptorProviderBuilder {
    ...
    public InputDecryptorProvider build(byte[] byArray) {
        final byte[] byArray2 = Arrays.clone((byte[])byArray);
            ...
            public InputDecryptor get(AlgorithmIdentifier algorithmIdentifier) throws OperatorCreationException {
                ...
                try {
                    ...
                    if (aSN1Encodable instanceof ASN1OctetString) {
                        this.cipher.init(2, (Key)secretKeySpec, new IvParameterSpec(ASN1OctetString.getInstance((Object)aSN1Encodable).getOctets()));
                    } else {
                        GOST28147Parameters gOST28147Parameters = GOST28147Parameters.getInstance((Object)aSN1Encodable);
                        this.cipher.init(2, (Key)secretKeySpec, (AlgorithmParameterSpec)new GOST28147ParameterSpec(gOST28147Parameters.getEncryptionParamSet(), gOST28147Parameters.getIV()));
                    }
                }
