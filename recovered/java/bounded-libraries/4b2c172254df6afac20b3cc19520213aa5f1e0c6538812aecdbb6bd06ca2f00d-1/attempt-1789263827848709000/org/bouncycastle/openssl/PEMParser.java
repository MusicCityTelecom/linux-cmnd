...
extends PemReader {
    ...
    implements PemObjectParser {
        ...
        public Object parseObject(PemObject pemObject) throws IOException {
            try {
                ASN1Primitive aSN1Primitive = ASN1Primitive.fromByteArray((byte[])pemObject.getContent());
                if (aSN1Primitive instanceof ASN1ObjectIdentifier) {
                    return ASN1Primitive.fromByteArray((byte[])pemObject.getContent());
                }
                if (aSN1Primitive instanceof ASN1Sequence) {
                    return X9ECParameters.getInstance((Object)aSN1Primitive);
                }
                return null;
            }
            catch (IOException iOException) {
    ...
    implements PemObjectParser {
        ...
        public Object parseObject(PemObject pemObject) throws IOException {
            ...
            for (Object object2 : list) {
                if (object2.getName().equals("Proc-Type") && object2.getValue().equals("4,ENCRYPTED")) {
                    bl = true;
                    continue;
                }
                if (!object2.getName().equals("DEK-Info")) continue;
            ...
            try {
                if (bl) {
                    ...
                    byte[] byArray = Hex.decode((String)((StringTokenizer)object2).nextToken());
