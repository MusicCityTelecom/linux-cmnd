...
public class JceOpenSSLPKCS8EncryptorBuilder {
    ...
    public OutputEncryptor build() throws OperatorCreationException {
        ...
        if (PEMUtilities.isPKCS5Scheme2(this.algOID)) {
            ...
            try {
                EncryptionScheme encryptionScheme = new EncryptionScheme(this.algOID, (ASN1Encodable)ASN1Primitive.fromByteArray((byte[])this.params.getEncoded()));
        ...
        if (PEMUtilities.isPKCS12(this.algOID)) {
            ...
            aSN1EncodableVector.add((ASN1Encodable)new ASN1Integer((long)this.iterationCount));
            algorithmIdentifier = new AlgorithmIdentifier(this.algOID, (ASN1Encodable)PKCS12PBEParams.getInstance((Object)new DERSequence(aSN1EncodableVector)));
            try {
