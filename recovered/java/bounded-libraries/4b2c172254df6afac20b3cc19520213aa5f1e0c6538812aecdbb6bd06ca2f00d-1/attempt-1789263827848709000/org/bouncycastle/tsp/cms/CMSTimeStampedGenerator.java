...
public class CMSTimeStampedGenerator {
    ...
    public void setMetaData(boolean bl, String string, String string2, Attributes attributes) {
        ...
        this.setMetaData(bl, (ASN1UTF8String)dERUTF8String, (ASN1IA5String)dERIA5String, attributes);
    }

    private void setMetaData(boolean bl, ASN1UTF8String aSN1UTF8String, ASN1IA5String aSN1IA5String, Attributes attributes) {
        this.metaData = new MetaData(ASN1Boolean.getInstance((boolean)bl), aSN1UTF8String, aSN1IA5String, attributes);
    }
