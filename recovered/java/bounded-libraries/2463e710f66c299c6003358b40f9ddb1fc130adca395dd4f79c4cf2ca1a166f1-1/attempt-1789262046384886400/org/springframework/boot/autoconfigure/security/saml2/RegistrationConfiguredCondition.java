...
extends SpringBootCondition {
    ...
    public ConditionOutcome getMatchOutcome(ConditionContext context, AnnotatedTypeMetadata metadata) {
        ...
        Map<String, Saml2RelyingPartyProperties.Registration> registrations = this.getRegistrations(context.getEnvironment());
    ...
    private Map<String, Saml2RelyingPartyProperties.Registration> getRegistrations(Environment environment) {
        return (Map)Binder.get((Environment)environment).bind(PROPERTY, STRING_REGISTRATION_MAP).orElse(Collections.emptyMap());
    }
}
