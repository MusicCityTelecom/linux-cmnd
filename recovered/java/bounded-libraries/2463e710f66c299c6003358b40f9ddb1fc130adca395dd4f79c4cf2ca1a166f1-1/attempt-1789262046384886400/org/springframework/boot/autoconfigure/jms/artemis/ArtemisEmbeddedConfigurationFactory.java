...
class ArtemisEmbeddedConfigurationFactory {
    ...
    Configuration createConfiguration() {
        ...
        if (this.properties.isDefaultClusterPassword() && logger.isDebugEnabled()) {
            logger.debug((Object)("Using default Artemis cluster password: " + this.properties.getClusterPassword()));
        }
        ...
        configuration.addAddressesSetting("#", new AddressSettings().setDeadLetterAddress(SimpleString.toSimpleString((String)"DLQ")).setExpiryAddress(SimpleString.toSimpleString((String)"ExpiryQueue")));
