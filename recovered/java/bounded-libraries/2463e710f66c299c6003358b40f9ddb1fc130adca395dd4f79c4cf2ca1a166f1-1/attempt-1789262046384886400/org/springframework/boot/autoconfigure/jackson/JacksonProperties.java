...
public class JacksonProperties {
    ...
    private final Map<JsonParser.Feature, Boolean> parser = new EnumMap<JsonParser.Feature, Boolean>(JsonParser.Feature.class);
    private final Map<JsonGenerator.Feature, Boolean> generator = new EnumMap<JsonGenerator.Feature, Boolean>(JsonGenerator.Feature.class);
