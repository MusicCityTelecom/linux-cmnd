...
implements TypeInformation<S> {
    ...
    public TypeDescriptor toTypeDescriptor() {
        return new TypeDescriptor(this.toResolvableType(), this.getType(), null);
    }
    ...
    public boolean isCollectionLike() {
        Class<S> rawType = this.getType();
        return rawType.isArray() || Iterable.class.equals(rawType) || Streamable.class.isAssignableFrom(rawType) || CustomCollections.isCollection(rawType);
    }
    ...
    protected ResolvableType toResolvableType() {
        return ResolvableType.forType((Type)this.type);
    }
