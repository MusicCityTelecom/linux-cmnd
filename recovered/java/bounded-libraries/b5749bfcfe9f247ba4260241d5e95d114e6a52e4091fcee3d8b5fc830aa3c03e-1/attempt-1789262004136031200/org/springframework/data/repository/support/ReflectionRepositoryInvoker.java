...
implements RepositoryInvoker {
    ...
    protected Object convertId(Object id) {
        ...
        TypeDescriptor idDescriptor = TypeDescriptor.forObject((Object)id);
        if (idDescriptor.isAssignableTo(this.idTypeDescriptor)) {
            return id;
        }
        Object result = this.conversionService.convert(id, idDescriptor, this.idTypeDescriptor);
        if (result == null) {
            throw new IllegalStateException(String.format("Identifier conversion of %s to %s unexpectedly returned null", id, this.idTypeDescriptor.getType()));
        }
        return result;
    }
