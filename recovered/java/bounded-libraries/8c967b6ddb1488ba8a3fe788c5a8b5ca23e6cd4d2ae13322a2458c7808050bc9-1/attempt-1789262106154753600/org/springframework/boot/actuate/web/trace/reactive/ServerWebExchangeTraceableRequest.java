...
class ServerWebExchangeTraceableRequest
implements TraceableRequest {
    ...
    ServerWebExchangeTraceableRequest(ServerWebExchange exchange) {
        ...
        this.remoteAddress = ServerWebExchangeTraceableRequest.getRemoteAddress(request);
    }
    ...
    public Map<String, List<String>> getHeaders() {
        return new LinkedHashMap<String, List<String>>(this.headers);
    }
