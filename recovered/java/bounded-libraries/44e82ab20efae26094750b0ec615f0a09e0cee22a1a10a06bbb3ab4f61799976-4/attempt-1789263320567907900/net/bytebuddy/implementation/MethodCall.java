...
implements Implementation.Composable {
    ...
    public MethodCall with(JavaConstant ... javaConstant) {
        ...
        for (JavaConstant aJavaConstant : javaConstant) {
            argumentLoaders.add(new ArgumentLoader.ForStackManipulation((StackManipulation)new JavaConstantValue(aJavaConstant), aJavaConstant.getTypeDescription()));
        }
        return this.with(argumentLoaders);
    }
        ...
        Factory {
            ...
            public static Factory of(@MaybeNull Object value) {
                ...
                if (value instanceof TypeDescription) {
                    return new ForStackManipulation(ClassConstant.of((TypeDescription)value), (Type)((Object)Class.class));
                }
                ...
                if (value instanceof JavaConstant) {
                    return new ForStackManipulation((StackManipulation)new JavaConstantValue((JavaConstant)value), ((JavaConstant)value).getTypeDescription());
                }
