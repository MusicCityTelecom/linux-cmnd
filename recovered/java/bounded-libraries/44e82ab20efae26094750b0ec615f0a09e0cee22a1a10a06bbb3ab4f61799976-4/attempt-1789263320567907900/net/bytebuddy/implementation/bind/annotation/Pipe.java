    ...
    implements TargetMethodAnnotationDrivenBinder.ParameterBinder<Pipe> {
        ...
        implements AuxiliaryType {
            ...
            protected static enum ConstructorCall implements Implementation
            {
                ...
                private final transient MethodDescription.InDefinedShape objectTypeDefaultConstructor = (MethodDescription.InDefinedShape)((MethodList)TypeDescription.OBJECT.getDeclaredMethods().filter(ElementMatchers.isConstructor())).getOnly();
