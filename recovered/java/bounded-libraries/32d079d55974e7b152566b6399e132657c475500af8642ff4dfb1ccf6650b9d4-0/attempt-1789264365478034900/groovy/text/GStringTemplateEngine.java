...
extends TemplateEngine {
    ...
    private static final boolean REUSE_CLASS_LOADER = SystemUtil.getBooleanSafe((String)"groovy.GStringTemplateEngine.reuseClassLoader");
    ...
    implements Template {
        ...
        GStringTemplate(Reader reader, ClassLoader parentLoader) throws CompilationFailedException, ClassNotFoundException, IOException {
            Class groovyClass;
            int c;
            ...
            templateExpressions.append("}}");
            GroovyClassLoader loader = REUSE_CLASS_LOADER && parentLoader instanceof GroovyClassLoader ? (GroovyClassLoader)parentLoader : this.createClassLoader(parentLoader);
            try {
            ...
            try {
                GroovyObject script = (GroovyObject)groovyClass.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
        ...
        private static void parseSection(int pendingC, Reader reader, boolean writingString, StringBuilder templateExpressions) throws IOException {
            ...
            GStringTemplate.readAndAppend(reader, templateExpressions);
            templateExpressions.append(";\n ");
        }
        ...
        public Writable make(Map map) {
            Closure templateClosure = ((Closure)this.template.clone()).asWritable();
            Binding binding = new Binding(map);
            templateClosure.setDelegate((Object)binding);
