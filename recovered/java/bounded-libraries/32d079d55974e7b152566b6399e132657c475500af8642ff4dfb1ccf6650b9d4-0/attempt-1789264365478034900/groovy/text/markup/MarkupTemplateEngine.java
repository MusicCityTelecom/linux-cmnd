...
extends TemplateEngine {
    ...
    public MarkupTemplateEngine(ClassLoader parentLoader, TemplateConfiguration tplConfig, TemplateResolver resolver) {
        ...
        this.groovyClassLoader = MarkupTemplateEngine.doPrivileged(() -> new TemplateGroovyClassLoader(parentLoader, this.compilerConfiguration));
        if (DEBUG_BYTECODE) {
            this.compilerConfiguration.setBytecodePostprocessor((BytecodeProcessor)BytecodeDumper.STANDARD_ERR);
        }
        this.templateResolver = resolver == null ? new DefaultTemplateResolver() : resolver;
        this.templateResolver.configure((ClassLoader)((Object)this.groovyClassLoader), this.templateConfiguration);
    }

    public MarkupTemplateEngine(final ClassLoader parentLoader, final File templateDirectory, TemplateConfiguration tplConfig) {
        this((ClassLoader)MarkupTemplateEngine.doPrivileged(new PrivilegedAction<URLClassLoader>(){
