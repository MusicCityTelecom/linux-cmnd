...
public class GroovyCodeSource {
    ...
    public GroovyCodeSource(File infile, String encoding) throws IOException {
        ...
        this.cachable = true;
        try {
            Object[] info = this.doPrivileged(() -> {
                this.scriptText = encoding != null ? ResourceGroovyMethods.getText(infile, encoding) : ResourceGroovyMethods.getText(infile);
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.codeSource, that.codeSource);
    }
