...
implements Comparable<ItemHint> {
    ...
    public ItemHint(String name, List<ValueHint> values, List<ValueProvider> providers) {
        this.name = this.toCanonicalName(name);
        this.values = values != null ? new ArrayList<ValueHint>(values) : new ArrayList();
        this.providers = providers != null ? new ArrayList<ValueProvider>(providers) : new ArrayList();
    }
