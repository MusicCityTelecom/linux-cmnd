...
class ReflectionWrapper {
    ...
    ReflectionWrapper(String type, Object instance) {
        this.type = ReflectionWrapper.findClass(instance.getClass().getClassLoader(), type);
    ...
    protected Class<?> findClass(String name) {
        return ReflectionWrapper.findClass(this.getInstance().getClass().getClassLoader(), name);
    }

    protected Method findMethod(String name, Class<?> ... parameterTypes) {
        return ReflectionWrapper.findMethod(this.type, name, parameterTypes);
    }
