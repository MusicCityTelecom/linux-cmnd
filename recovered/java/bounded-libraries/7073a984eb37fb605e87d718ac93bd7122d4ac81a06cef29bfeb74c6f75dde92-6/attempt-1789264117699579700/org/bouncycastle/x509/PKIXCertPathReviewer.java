...
extends CertPathValidatorUtilities {
    ...
    protected Collection getTrustAnchors(X509Certificate x509Certificate, Set set) throws CertPathReviewerException {
        ...
        try {
            ...
            if (object3 != null && (bigInteger = ((AuthorityKeyIdentifier)(object2 = AuthorityKeyIdentifier.getInstance(ASN1Primitive.fromByteArray(((ASN1OctetString)(object = (ASN1OctetString)ASN1Primitive.fromByteArray((byte[])object3))).getOctets())))).getAuthorityCertSerialNumber()) != null) {
                x509CertSelector.setSerialNumber(((AuthorityKeyIdentifier)object2).getAuthorityCertSerialNumber());
            }
        }
        catch (IOException iOException) {
        ...
        while (iterator.hasNext()) {
            ...
            if (((TrustAnchor)object3).getCAName() == null || ((TrustAnchor)object3).getCAPublicKey() == null || !((X500Principal)(object = PKIXCertPathReviewer.getEncodedIssuerPrincipal(x509Certificate))).equals(object2 = new X500Principal(((TrustAnchor)object3).getCAName()))) continue;
            arrayList.add(object3);
        }
        return arrayList;
    }
