...
import groovyjarjarantlr4.v4.runtime.CommonTokenFactory;
...
import groovyjarjarantlr4.v4.runtime.UnicodeCharStream;
...
implements TokenSource {
    ...
    public void setInputStream(CharStream input) {
        this.validateInputStream(((LexerATNSimulator)this.getInterpreter()).atn, input);
        this._input = null;
        this._tokenFactorySourcePair = Tuple.create(this, this._input);
        this.reset();
        this._input = input;
        this._tokenFactorySourcePair = Tuple.create(this, this._input);
    }
