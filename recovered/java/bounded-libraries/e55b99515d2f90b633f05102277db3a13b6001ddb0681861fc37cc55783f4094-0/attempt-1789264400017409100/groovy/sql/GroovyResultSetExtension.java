...
extends GroovyObjectSupport {
    ...
    public Object invokeMethod(String name, Object args) {
        try {
            return InvokerHelper.invokeMethod((Object)this.getResultSet(), (String)name, (Object)args);
        }
        catch (SQLException se) {
            throw new InvokerInvocationException((Throwable)se);
        }
    }
    ...
    public Object getProperty(String columnName) {
        try {
            ...
            throw new MissingPropertyException(columnName, GroovyResultSetProxy.class, (Throwable)e);
        }
    }
