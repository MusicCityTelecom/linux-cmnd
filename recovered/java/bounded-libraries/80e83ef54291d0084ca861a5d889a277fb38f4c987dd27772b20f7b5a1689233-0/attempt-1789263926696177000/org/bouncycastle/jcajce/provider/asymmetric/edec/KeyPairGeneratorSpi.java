...
extends java.security.KeyPairGeneratorSpi {
    ...
    public KeyPair generateKeyPair() {
        ...
        switch (this.algorithmInitialized) {
            case 1: 
            case 2: {
                return new KeyPair(new BC15EdDSAPublicKey(asymmetricCipherKeyPair.getPublic()), new BC15EdDSAPrivateKey(asymmetricCipherKeyPair.getPrivate()));
            }
            case 3: 
            case 4: {
    ...
    private static String getNameFromParams(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidAlgorithmParameterException {
        ...
        return ECUtil.getNameFrom((AlgorithmParameterSpec)algorithmParameterSpec);
    }
