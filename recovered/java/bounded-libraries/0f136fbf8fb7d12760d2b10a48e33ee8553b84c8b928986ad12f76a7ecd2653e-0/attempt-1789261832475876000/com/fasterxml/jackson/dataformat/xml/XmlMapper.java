...
extends ObjectMapper {
    ...
    public XmlMapper(XmlFactory xmlFactory, JacksonXmlModule module) {
        super((JsonFactory)xmlFactory, (DefaultSerializerProvider)new XmlSerializerProvider(new XmlRootNameLookup()), (DefaultDeserializationContext)new XmlDeserializationContext((DeserializerFactory)BeanDeserializerFactory.instance));
        this._xmlModule = module;
        if (module != null) {
            this.registerModule((Module)module);
        }
        this._serializationConfig = this._serializationConfig.withDefaultPrettyPrinter((PrettyPrinter)DEFAULT_XML_PRETTY_PRINTER);
