...
extends DefaultSerializerProvider {
    ...
    public void serializeValue(JsonGenerator gen, Object value, JavaType rootType, JsonSerializer<Object> ser) throws IOException {
        ...
        if ((xgen = this._asXmlGenerator(gen)) == null) {
            ...
            QName rootName = this._rootNameFromConfig();
            if (rootName == null) {
                rootName = rootType == null ? this._rootNameLookup.findRootName(value.getClass(), (MapperConfig<?>)this._config) : this._rootNameLookup.findRootName(rootType, (MapperConfig<?>)this._config);
            }
            this._initWithRootName(xgen, rootName);
    ...
    protected void _serializeUnwrappedObjectNode(ToXmlGenerator xgen, Object value, JsonSerializer<Object> ser) throws IOException {
        ...
        Map.Entry entry = (Map.Entry)root.fields().next();
        ...
        try {
            ser.serialize((Object)newRoot, (JsonGenerator)xgen, (SerializerProvider)this);
        }
        catch (Exception e) {
            throw this._wrapAsIOE((JsonGenerator)xgen, e);
        }
    }
    ...
    protected ToXmlGenerator _asXmlGenerator(JsonGenerator gen) throws JsonMappingException {
        if (!(gen instanceof ToXmlGenerator)) {
            ...
            throw JsonMappingException.from((JsonGenerator)gen, (String)("XmlMapper does not work with generators of type other than `ToXmlGenerator`; got: `" + gen.getClass().getName() + "`"));
        }
