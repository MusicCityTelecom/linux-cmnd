...
extends ParserMinimalBase {
            ...
            switch (token) {
                ...
                case 5: {
                    ...
                    if (this._mayBeLeaf) {
                        ...
                        if (token != 1) {
                            throw new JsonParseException((JsonParser)this, String.format("Internal error: Expected END_ELEMENT (%d) or START_ELEMENT (%d), got event of type %d", 2, 1, token));
                        }
    ...
    protected final void _checkNumericValue(int expType) throws IOException {
        ...
        this._reportError("Current token (" + this.currentToken() + ") not numeric, can not use numeric value accessors");
    }
    ...
    protected int _nextToken() throws IOException {
        try {
            ...
            return (Integer)StaxUtil.throwAsParseException(e, (JsonParser)this);
        }
