...
extends Loader {
    ...
    public void childElement(UnmarshallingContext.State state, TagName arg) throws SAXException {
        ...
        if (child == null) {
            ...
            backupWithParentNamespace = backupWithParentNamespace != null ? backupWithParentNamespace : Boolean.parseBoolean(Utils.getSystemProperty("com.sun.xml.bind.backupWithParentNamespace"));
