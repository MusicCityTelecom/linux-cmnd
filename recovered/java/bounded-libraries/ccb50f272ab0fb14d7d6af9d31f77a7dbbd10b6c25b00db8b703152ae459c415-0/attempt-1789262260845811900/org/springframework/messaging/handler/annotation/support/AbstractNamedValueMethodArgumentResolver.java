...
implements HandlerMethodArgumentResolver {
    ...
    public Object resolveArgument(MethodParameter parameter, Message<?> message) throws Exception {
        ...
        this.handleResolvedValue(arg, namedValueInfo.name, parameter, message);
        return arg;
    }
    ...
    @Nullable
    protected abstract Object resolveArgumentInternal(MethodParameter var1, Message<?> var2, String var3) throws Exception;
