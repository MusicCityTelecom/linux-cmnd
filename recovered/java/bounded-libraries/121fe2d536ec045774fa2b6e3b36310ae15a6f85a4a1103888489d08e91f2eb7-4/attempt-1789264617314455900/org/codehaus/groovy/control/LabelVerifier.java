        ...
        if (labels != null) {
            for (String label : labels) {
                if (this.breakLabels != null) {
                    this.breakLabels.removeIf(breakStatement -> breakStatement.getLabel().equals(label));
                }
                if (this.continueLabels != null) {
                    this.continueLabels.removeIf(continueStatement -> continueStatement.getLabel().equals(label));
                }
