...
public class CallSiteWriter {
    ...
    public void makeSiteEntry() {
        if (this.controller.isNotClinit()) {
            ...
            mv.visitInsn(0);
            mv.visitMethodInsn(184, this.controller.getInternalClassName(), GET_CALLSITE_METHOD, GET_CALLSITE_DESC, false);
            this.controller.getOperandStack().push(CALLSITE_ARRAY_TYPE);
            this.callSiteArrayVarIndex = this.controller.getCompileStack().defineTemporaryVariable("$local$callSiteArray", CALLSITE_ARRAY_TYPE, true);
        }
    }
    ...
    public void makeSingleArgumentCall(Expression receiver, String message, Expression arguments, boolean safe) {
        ...
        this.controller.getMethodVisitor().visitMethodInsn(185, CALLSITE_CLASS, safe ? "callSafe" : "call", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", true);
