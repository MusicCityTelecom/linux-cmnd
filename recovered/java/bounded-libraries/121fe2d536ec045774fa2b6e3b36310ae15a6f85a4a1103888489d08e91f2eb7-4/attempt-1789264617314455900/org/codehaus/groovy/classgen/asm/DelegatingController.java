...
extends WriterController {
    ...
    public LambdaWriter getLambdaWriter() {
        return this.delegationController.getLambdaWriter();
    }

    @Override
    public MethodPointerExpressionWriter getMethodPointerExpressionWriter() {
        return this.delegationController.getMethodPointerExpressionWriter();
    }

    @Override
    public MethodReferenceExpressionWriter getMethodReferenceExpressionWriter() {
        return this.delegationController.getMethodReferenceExpressionWriter();
    }
    ...
    public boolean isInGeneratedFunction() {
        return this.delegationController.isInGeneratedFunction();
    }

    @Override
    public boolean isInGeneratedFunctionConstructor() {
        return this.delegationController.isInGeneratedFunctionConstructor();
    }
