...
extends AbstractASTTransformation {
    ...
    public void visit(ASTNode[] nodes, SourceUnit source) {
        ...
        if (parent instanceof ClassNode) {
            ...
            code.addStatement(GeneralUtils.stmt(GeneralUtils.callX((Expression)GeneralUtils.propX((Expression)GeneralUtils.classX(annotatedClass), "metaClass"), "mixin", useClasses)));
        }
    }
}
