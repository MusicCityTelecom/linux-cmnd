...
public interface GroovyCodeVisitor {
    ...
    default public void visitEmptyStatement(EmptyStatement statement) {
    }
    ...
    public void visitLambdaExpression(LambdaExpression var1);
    ...
    public void visitMethodReferenceExpression(MethodReferenceExpression var1);
    ...
    default public void visitEmptyExpression(EmptyExpression expression) {
    }

    default public void visitListOfExpressions(List<? extends Expression> list) {
        if (list != null) {
            list.forEach(expr -> expr.visit(this));
        }
    }

    default public void visit(Expression expression) {
        if (expression != null) {
