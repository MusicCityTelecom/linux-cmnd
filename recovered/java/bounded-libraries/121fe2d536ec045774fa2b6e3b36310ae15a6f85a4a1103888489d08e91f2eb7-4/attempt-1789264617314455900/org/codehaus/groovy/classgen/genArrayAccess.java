...
extends Script {
    ...
    public static void main(String ... args) {
        CallSite[] callSiteArray = genArrayAccess.$getCallSiteArray();
        callSiteArray[0].callStatic(InvokerHelper.class, genArrayAccess.class, args);
    }
    ...
    public Object genInners() {
        ...
        public final class _genInners_closure1
        extends Closure
