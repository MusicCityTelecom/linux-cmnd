...
import org.codehaus.groovy.classgen.asm.sc.StaticTypesLambdaWriter;
import org.codehaus.groovy.classgen.asm.sc.StaticTypesMethodReferenceExpressionWriter;
...
extends DelegatingController {
    ...
    public void init(AsmClassGenerator asmClassGenerator, GeneratorContext gcon, ClassVisitor cv, ClassNode cn) {
        ...
        this.binaryExprHelper = config.isIndyEnabled() ? new IndyStaticTypesMultiTypeDispatcher(this) : new StaticTypesBinaryExpressionMultiTypeDispatcher(this);
    }
    ...
    private void updateStaticCompileFlag(MethodNode mn) {
        ...
        boolean isStaticCompileNode = classNode.getNodeMetaData((Object)StaticCompilationMetadataKeys.STATIC_COMPILE_NODE) != null;
        this.isInStaticallyCheckedMethod = mn != null && (StaticCompilationVisitor.isStaticallyCompiled(node) || implementsGeneratedClosureOrGeneratedLambdaInterface && isStaticCompileNode);
    }
