...
implements Serializable {
    ...
    public ConcurrentReferenceHashMap(int initialCapacity, ReferenceType keyType, ReferenceType valueType, EnumSet<Option> options) {
        this(initialCapacity, 0.75f, 16, keyType, valueType, options);
    }
    ...
    public Set<Map.Entry<K, V>> cachedEntrySet() {
        EntrySet es = this.entrySet;
        return es != null ? es : (this.entrySet = new EntrySet(true));
    }
