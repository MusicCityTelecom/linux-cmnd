    ...
    private void createPreparedStatementCaches() throws SQLException {
        ...
        synchronized (object) {
            ...
            try {
                ...
                SQLException sqlEx = SQLError.createSQLException(Messages.getString("Connection.CantFindCacheFactory", new Object[]{queryInfoCacheFactory, PropertyKey.queryInfoCacheFactory}), this.getExceptionInterceptor());
                sqlEx.initCause(e);
                throw sqlEx;
            }
            catch (Exception e) {
                SQLException sqlEx = SQLError.createSQLException(Messages.getString("Connection.CantLoadCacheFactory", new Object[]{queryInfoCacheFactory, PropertyKey.queryInfoCacheFactory}), this.getExceptionInterceptor());
                sqlEx.initCause(e);
                throw sqlEx;
            }
            if (this.useServerPrepStmts.getValue().booleanValue()) {
