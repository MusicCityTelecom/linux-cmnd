...
public class Constants {
    ...
    public static final String CJ_FULL_NAME = "mysql-connector-java-8.0.30";
    public static final String CJ_REVISION = "1de2fe873fe26189564c030a343885011412976a";
    public static final String CJ_VERSION = "8.0.30";
