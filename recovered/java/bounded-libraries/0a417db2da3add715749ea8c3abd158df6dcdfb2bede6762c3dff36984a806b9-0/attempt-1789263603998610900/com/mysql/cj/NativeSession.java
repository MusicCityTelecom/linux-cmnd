    ...
    private void createConfigCacheIfNeeded(Object syncMutex) {
        ...
        synchronized (object) {
            ...
            try {
                ...
                throw ExceptionFactory.createException(Messages.getString("Connection.CantFindCacheFactory", new Object[]{this.getPropertySet().getStringProperty(PropertyKey.queryInfoCacheFactory).getValue(), PropertyKey.queryInfoCacheFactory}), e, this.getExceptionInterceptor());
            }
            catch (CJException | IllegalAccessException | InstantiationException e) {
                throw ExceptionFactory.createException(Messages.getString("Connection.CantLoadCacheFactory", new Object[]{this.getPropertySet().getStringProperty(PropertyKey.queryInfoCacheFactory).getValue(), PropertyKey.queryInfoCacheFactory}), e, this.getExceptionInterceptor());
            }
        }
    }
