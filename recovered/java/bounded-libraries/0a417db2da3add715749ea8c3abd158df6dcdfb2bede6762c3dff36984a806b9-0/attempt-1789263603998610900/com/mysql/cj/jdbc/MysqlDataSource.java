...
JdbcPropertySet {
    ...
    public void setAuthenticationFidoCallbackHandler(String string) throws SQLException {
        this.setStringRuntimeProperty("authenticationFidoCallbackHandler", string);
    }
    ...
    public void setSocksProxyRemoteDns(boolean bl) throws SQLException {
        this.setBooleanRuntimeProperty("socksProxyRemoteDns", bl);
    }
