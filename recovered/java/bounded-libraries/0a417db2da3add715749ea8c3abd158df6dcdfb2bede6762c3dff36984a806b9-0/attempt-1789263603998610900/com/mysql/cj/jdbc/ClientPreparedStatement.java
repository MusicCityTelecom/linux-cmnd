...
implements JdbcPreparedStatement {
    ...
    public boolean execute() throws SQLException {
        try {
            ...
            synchronized (object) {
                ...
                Object sendPacket = ((PreparedQuery)this.query).fillSendPacket(((PreparedQuery)this.query).getQueryBindings());
                String oldDb = null;
            ...
            try {
                ...
                if (!this.batchHasPlainStatements && ((Boolean)this.rewriteBatchedStatements.getValue()).booleanValue()) {
                    if (this.getQueryInfo().isRewritableWithMultiValuesClause()) {
                        long[] lArray = this.executeBatchWithMultiValuesClause(batchTimeout);
                        return lArray;
                    }
    ...
    public ResultSet executeQuery() throws SQLException {
        try {
            ...
            synchronized (object) {
                ...
                JdbcConnection locallyScopedConn = this.connection;
                if (!this.doPingInstead && (queryReturnType = this.getQueryInfo().getQueryReturnType()) != QueryReturnType.PRODUCES_RESULT_SET && queryReturnType != QueryReturnType.MAY_PRODUCE_RESULT_SET) {
    ...
    public String getPreparedSql() {
        ...
        synchronized (object) {
            ...
            return this.getQueryInfo().getSqlForBatch();
        }
    }
