...
extends BaseMessageQueueCommand {
    ...
    @JsonCreator
    public UpdateTicketMessageQueueCommand(@JsonProperty(value="id") PublisherIdentifier id, @JsonProperty(value="ticket") String ticket, @JsonProperty(value="ticketType") String ticketType) {
        super(id);
        this.ticket = ticket;
    ...
    public void execute(TicketRegistry registry) throws Exception {
        ...
        Ticket result = UpdateTicketMessageQueueCommand.deserializeTicket(this.ticket, this.ticketType);
