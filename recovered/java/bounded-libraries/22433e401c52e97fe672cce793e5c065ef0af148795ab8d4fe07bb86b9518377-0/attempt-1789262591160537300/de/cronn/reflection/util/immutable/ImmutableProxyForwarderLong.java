...
public final class ImmutableProxyForwarderLong {
    ...
    public static Long forward(@Origin Method method, @FieldValue(value="$delegate") Object delegate, @AllArguments Object[] args) throws InvocationTargetException, IllegalAccessException {
