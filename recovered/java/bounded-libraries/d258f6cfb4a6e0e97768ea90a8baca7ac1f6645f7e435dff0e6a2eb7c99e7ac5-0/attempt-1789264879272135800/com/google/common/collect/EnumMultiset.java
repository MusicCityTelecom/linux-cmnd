...
implements Serializable {
    ...
    void checkIsE(@Nullable Object element) {
        ...
        if (!this.isActuallyE(element)) {
            ...
            throw new ClassCastException(new StringBuilder(21 + String.valueOf(string).length() + String.valueOf(string2).length()).append("Expected an ").append(string).append(" but got ").append(string2).toString());
        }
    }
