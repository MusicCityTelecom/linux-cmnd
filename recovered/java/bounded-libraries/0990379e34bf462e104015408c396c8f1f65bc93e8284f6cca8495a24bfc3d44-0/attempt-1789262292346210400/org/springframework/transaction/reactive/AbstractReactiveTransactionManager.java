...
Serializable {
    ...
    protected abstract Object doGetTransaction(TransactionSynchronizationManager var1) throws TransactionException;

    protected boolean isExistingTransaction(Object transaction) throws TransactionException {
        return false;
    }

    protected abstract Mono<Void> doBegin(TransactionSynchronizationManager var1, Object var2, TransactionDefinition var3) throws TransactionException;
    ...
    protected abstract Mono<Void> doCommit(TransactionSynchronizationManager var1, GenericReactiveTransaction var2) throws TransactionException;

    protected abstract Mono<Void> doRollback(TransactionSynchronizationManager var1, GenericReactiveTransaction var2) throws TransactionException;
