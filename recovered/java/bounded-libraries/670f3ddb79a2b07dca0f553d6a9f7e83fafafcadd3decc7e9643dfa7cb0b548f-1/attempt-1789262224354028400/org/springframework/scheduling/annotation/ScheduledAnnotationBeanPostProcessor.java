    ...
    public Object postProcessAfterInitialization(Object bean, String beanName) {
        ...
        if (!this.nonAnnotatedClasses.contains(targetClass) && AnnotationUtils.isCandidateClass((Class)targetClass, Arrays.asList(Scheduled.class, Schedules.class))) {
            ...
            if (annotatedMethods.isEmpty()) {
                ...
                annotatedMethods.forEach((method, scheduledAnnotations) -> scheduledAnnotations.forEach(scheduled -> this.processScheduled((Scheduled)scheduled, (Method)method, bean)));
                if (this.logger.isTraceEnabled()) {
