...
extends PatternNode {
    ...
    public AnnotationPatternList() {
        this.typePatterns = AnnotationTypePattern.NONE;
    ...
    public AnnotationPatternList(AnnotationTypePattern[] arguments) {
        ...
        for (AnnotationTypePattern argument : arguments) {
            if (argument != AnnotationTypePattern.ELLIPSIS) continue;
            ++this.ellipsisCount;
        }
    }
    ...
    public void resolve(World inWorld) {
        for (AnnotationTypePattern typePattern : this.typePatterns) {
    ...
    public FuzzyBoolean matches(ResolvedType[] someArgs) {
        ...
        for (AnnotationTypePattern typePattern : this.typePatterns) {
            ...
            if (typePattern == AnnotationTypePattern.ANY) {
                ++argsIndex;
                continue;
            }
