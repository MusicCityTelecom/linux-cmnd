...
extends ReflectionBasedReferenceTypeDelegate {
    ...
    private ResolvedMember createGenericFieldMember(Field forField) {
        ReflectionBasedResolvedMemberImpl ret = new ReflectionBasedResolvedMemberImpl(Member.FIELD, (UnresolvedType)this.getGenericResolvedType(), forField.getModifiers(), (UnresolvedType)this.typeConverter.fromType(forField.getType()), forField.getName(), UnresolvedType.NONE, forField);
        ret.setAnnotationFinder(this.annotationFinder);
        ret.setGenericSignatureInformationProvider(new Java15GenericSignatureInformationProvider(this.getWorld()));
        return ret;
    }
