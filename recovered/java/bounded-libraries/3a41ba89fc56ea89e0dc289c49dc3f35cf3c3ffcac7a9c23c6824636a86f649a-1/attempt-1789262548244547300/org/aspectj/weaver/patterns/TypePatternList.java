...
extends PatternNode {
    ...
    public TypePatternList(TypePattern[] arguments) {
        ...
        for (TypePattern argument : arguments) {
            if (argument != TypePattern.ELLIPSIS) continue;
            ++this.ellipsisCount;
        }
    }
    ...
    public FuzzyBoolean matches(ResolvedType[] types, TypePattern.MatchKind kind) {
        return this.matches(types, kind, null);
    }
    ...
    public void postRead(ResolvedType enclosingType) {
        for (TypePattern p : this.typePatterns) {
    ...
    public int hashCode() {
        int result = 41;
        for (TypePattern typePattern : this.typePatterns) {
    ...
    public boolean areAllExactWithNoSubtypesAllowed() {
        for (TypePattern array_element : this.typePatterns) {
