...
public class ReflectionBasedReferenceTypeDelegateFactory {
    public static ReflectionBasedReferenceTypeDelegate createDelegate(ReferenceType forReferenceType, World inWorld, ClassLoader usingClassLoader) {
        try {
            ...
            ReflectionBasedReferenceTypeDelegate rbrtd = ReflectionBasedReferenceTypeDelegateFactory.create15Delegate(forReferenceType, c, usingClassLoader, inWorld);
            if (rbrtd != null) {
                return rbrtd;
            }
    ...
    public static ReflectionBasedReferenceTypeDelegate createDelegate(ReferenceType forReferenceType, World inWorld, Class<?> clazz) {
        ReflectionBasedReferenceTypeDelegate rbrtd = ReflectionBasedReferenceTypeDelegateFactory.create15Delegate(forReferenceType, clazz, clazz.getClassLoader(), inWorld);
        if (rbrtd != null) {
            return rbrtd;
        }
    ...
    private static ReflectionBasedReferenceTypeDelegate create15Delegate(ReferenceType forReferenceType, Class forClass, ClassLoader usingClassLoader, World inWorld) {
        try {
            ...
            ReflectionBasedReferenceTypeDelegate ret = (ReflectionBasedReferenceTypeDelegate)delegateClass.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
            ...
            throw new IllegalStateException("Attempted to create Java 1.5 reflection based delegate but NoSuchMethodException: " + nsMethEx + " occured");
        }
        catch (InvocationTargetException invTargEx) {
            throw new IllegalStateException("Attempted to create Java 1.5 reflection based delegate but InvocationTargetException: " + invTargEx + " occured");
        }
    }
    ...
    public static ResolvedMember createStaticInitMember(Class forType, World inWorld) {
        return new ResolvedMemberImpl(Member.STATIC_INITIALIZATION, ReflectionBasedReferenceTypeDelegateFactory.toResolvedType(forType, (IReflectionWorld)((Object)inWorld)), 8, UnresolvedType.VOID, "<clinit>", UnresolvedType.NONE, UnresolvedType.NONE);
    }
    ...
    public static ResolvedMember createResolvedField(Field aField, World inWorld) {
        ReflectionBasedResolvedMemberImpl ret = new ReflectionBasedResolvedMemberImpl(Member.FIELD, (UnresolvedType)ReflectionBasedReferenceTypeDelegateFactory.toResolvedType(aField.getDeclaringClass(), (IReflectionWorld)((Object)inWorld)), aField.getModifiers(), (UnresolvedType)ReflectionBasedReferenceTypeDelegateFactory.toResolvedType(aField.getType(), (IReflectionWorld)((Object)inWorld)), aField.getName(), UnresolvedType.NONE, aField);
        if (inWorld instanceof IReflectionWorld) {
            ret.setAnnotationFinder(((IReflectionWorld)((Object)inWorld)).getAnnotationFinder());
        }
        ret.setGenericSignatureInformationProvider(ReflectionBasedReferenceTypeDelegateFactory.createGenericSignatureProvider(inWorld));
