...
extends NameBindingPointcut {
    ...
    public List<BindingPattern> getBindingAnnotationTypePatterns() {
        AnnotationTypePattern[] pats;
        ArrayList<BindingPattern> l = new ArrayList<BindingPattern>();
        for (AnnotationTypePattern pat : pats = this.arguments.getAnnotationPatterns()) {
            if (!(pat instanceof BindingAnnotationTypePattern)) continue;
            l.add((BindingPattern)((Object)pat));
        }
        return l;
    }
