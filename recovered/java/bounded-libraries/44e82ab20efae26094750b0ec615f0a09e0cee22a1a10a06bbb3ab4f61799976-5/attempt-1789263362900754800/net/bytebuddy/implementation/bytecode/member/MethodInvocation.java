...
public enum MethodInvocation {
    ...
    implements WithImplicitInvocationTargetType {
        ...
        public StackManipulation dynamic(String methodName, TypeDescription returnType, List<? extends TypeDescription> methodType, List<? extends JavaConstant> arguments) {
            return this.methodDescription.isInvokeBootstrap() ? new DynamicInvocation(methodName, returnType, new TypeList.Explicit(methodType), (MethodDescription.InDefinedShape)this.methodDescription.asDefined(), arguments) : StackManipulation.Illegal.INSTANCE;
        }
