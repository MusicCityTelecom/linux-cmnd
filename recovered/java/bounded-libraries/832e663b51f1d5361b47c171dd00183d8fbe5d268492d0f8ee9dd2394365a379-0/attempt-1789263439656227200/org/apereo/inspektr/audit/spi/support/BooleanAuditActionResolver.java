...
public class BooleanAuditActionResolver
extends AbstractSuffixAwareAuditActionResolver {
    public BooleanAuditActionResolver(String successSuffix, String failureSuffix) {
        super(successSuffix, failureSuffix);
    }

    @Override
    public String resolveFrom(JoinPoint auditableTarget, Object retval, Audit audit) {
        Boolean bool = (Boolean)retval;
        String action = audit.action();
        return action + (bool != false ? this.getSuccessSuffix() : this.getFailureSuffix());
    }
