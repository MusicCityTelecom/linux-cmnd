    ...
    protected PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        if (keySpec instanceof OpenSSHPrivateKeySpec) {
            ...
            if (asymmetricKeyParameter instanceof Ed25519PrivateKeyParameters) {
                return new BCEdDSAPrivateKey((AsymmetricKeyParameter)((Ed25519PrivateKeyParameters)asymmetricKeyParameter));
            }
        ...
        if (keySpec instanceof X509EncodedKeySpec) {
            ...
            if (keySpec instanceof RawEncodedKeySpec) {
                ...
                switch (this.specificBase) {
                    ...
                    case 113: {
                        return new BCEdDSAPublicKey((AsymmetricKeyParameter)new Ed448PublicKeyParameters(byArray));
                    }
                    case 112: {
                        return new BCEdDSAPublicKey((AsymmetricKeyParameter)new Ed25519PublicKeyParameters(byArray));
                    }
                }
