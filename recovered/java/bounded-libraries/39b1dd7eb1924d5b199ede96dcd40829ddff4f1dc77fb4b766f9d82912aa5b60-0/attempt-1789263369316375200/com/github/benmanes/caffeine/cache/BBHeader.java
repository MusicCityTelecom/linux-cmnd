...
final class BBHeader {
    ...
    extends PadWriteCounter {
        ...
        static {
            ...
            try {
                READ = lookup.findVarHandle(ReadCounterRef.class, "readCounter", Long.TYPE);
                WRITE = lookup.findVarHandle(ReadAndWriteCounterRef.class, "writeCounter", Long.TYPE);
            }
