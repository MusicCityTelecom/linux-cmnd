...
implements NodeFactory<K, V> {
    ...
    public final K getKey() {
        References.WeakValueReference weakValueReference = VALUE.get(this);
        Reference reference = (Reference)weakValueReference.getKeyReference();
    ...
    public final void retire() {
        ...
        Reference reference = (Reference)weakValueReference.getKeyReference();
        reference.clear();
        weakValueReference.setKeyReference(RETIRED_WEAK_KEY);
    ...
    public final void die() {
        ...
        Reference reference = (Reference)weakValueReference.getKeyReference();
        reference.clear();
        weakValueReference.setKeyReference(DEAD_WEAK_KEY);
        weakValueReference.clear();
    }
    ...
    static {
        ...
        try {
            VALUE = lookup.findVarHandle(FW.class, "value", References.WeakValueReference.class);
        }
