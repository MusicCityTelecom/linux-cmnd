...
extends AsyncCache<K, V> {
    ...
    @Override
    default public CompletableFuture<Map<K, V>> getAll(Iterable<? extends K> keys, Function<? super Set<? extends K>, ? extends Map<? extends K, ? extends V>> mappingFunction) {
        Objects.requireNonNull(mappingFunction);
        return this.getAll(keys, (? super Set<? extends K> keysToLoad, ? super Executor executor) -> CompletableFuture.supplyAsync(() -> (Map)mappingFunction.apply((Object)keysToLoad), executor));
    }

    @Override
    default public CompletableFuture<Map<K, V>> getAll(Iterable<? extends K> keys, BiFunction<? super Set<? extends K>, ? super Executor, ? extends CompletableFuture<? extends Map<? extends K, ? extends V>>> mappingFunction) {
        Objects.requireNonNull(mappingFunction);
        Objects.requireNonNull(keys);
        int initialCapacity = Caffeine.calculateHashMapCapacity(keys);
        LinkedHashMap<K, CompletableFuture<V>> futures = new LinkedHashMap<K, CompletableFuture<V>>(initialCapacity);
        HashMap proxies = new HashMap(initialCapacity);
        for (K key : keys) {
        ...
        try {
            ...
            loader.whenComplete((BiConsumer)completer);
            return LocalAsyncCache.composeResult(futures);
        }
        catch (Throwable t) {
        ...
        valueFuture.whenComplete((value, error) -> {
            ...
            if (value == null) {
                if (error != null && !(error instanceof CancellationException) && !(error instanceof TimeoutException)) {
                    logger.log(System.Logger.Level.WARNING, "Exception thrown during asynchronous load", (Throwable)error);
                }
                ...
                this.cache().replace(key, castedFuture, castedFuture);
    ...
    implements ConcurrentMap<K, V> {
        ...
        public boolean remove(Object key, Object value) {
            ...
            do {
                CompletableFuture<V> completableFuture = future = future == null ? (CompletableFuture<V>)this.delegate.get(key) : this.delegate.getIfPresentQuietly(castedKey);
        ...
        public @Nullable V replace(K key, V value) {
            ...
            do {
                ...
                if ((future = this.delegate.getIfPresentQuietly(key)) == null || future.isCompletedExceptionally()) {
                    return null;
                }
                Async.getWhenSuccessful(future);
        ...
        public @Nullable V compute(K key, BiFunction<? super K, ? super V, ? extends V> remappingFunction) {
            ...
            do {
                ...
                valueFuture = this.delegate.compute(key, (k, oldValueFuture) -> {
                    ...
                    Object oldValue = Async.getIfReady(oldValueFuture);
                    BiFunction function = this.delegate.statsAware(remappingFunction, true, true);
        ...
        public String toString() {
            ...
            while (iterator.hasNext()) {
                Object entry = iterator.next();
                result.append((Object)(entry.getKey() == this ? "(this Map)" : entry.getKey()));
                result.append('=');
                result.append((Object)(entry.getValue() == this ? "(this Map)" : entry.getValue()));
    ...
    Serializable {
        ...
        public Map<K, V> getAllPresent(Iterable<? extends K> keys) {
            ...
            while (iter.hasNext()) {
                ...
                CompletableFuture future = (CompletableFuture)this.asyncCache().cache().get(entry.getKey());
        ...
        public void accept(@Nullable Map<? extends K, ? extends V> result, @Nullable Throwable error) {
            ...
            if (result == null) {
                ...
                if (!(error instanceof CancellationException) && !(error instanceof TimeoutException)) {
                    logger.log(System.Logger.Level.WARNING, "Exception thrown during asynchronous load", error);
                }
            } else {
