...
final class BLCHeader {
    ...
    static abstract class DrainStatusRef
    extends PadDrainStatus {
        ...
        int drainStatus() {
            return DRAIN_STATUS.getOpaque(this);
        }
        ...
        static {
            try {
                DRAIN_STATUS = MethodHandles.lookup().findVarHandle(DrainStatusRef.class, "drainStatus", Integer.TYPE);
            }
