...
extends PWAWR<K, V> {
    ...
    PWAWRMW(K k, ReferenceQueue<K> referenceQueue, V v, ReferenceQueue<V> referenceQueue2, int n, long l) {
        super(k, referenceQueue, v, referenceQueue2, n, l);
        this.weight = n;
    }

    PWAWRMW(Object object, V v, ReferenceQueue<V> referenceQueue, int n, long l) {
    ...
    public Node<K, V> newNode(K k, ReferenceQueue<K> referenceQueue, V v, ReferenceQueue<V> referenceQueue2, int n, long l) {
        return new PWAWRMW<K, V>(k, referenceQueue, v, referenceQueue2, n, l);
    }

    @Override
    public Node<K, V> newNode(Object object, V v, ReferenceQueue<V> referenceQueue, int n, long l) {
        return new PWAWRMW<K, V>(object, v, referenceQueue, n, l);
    }
}
