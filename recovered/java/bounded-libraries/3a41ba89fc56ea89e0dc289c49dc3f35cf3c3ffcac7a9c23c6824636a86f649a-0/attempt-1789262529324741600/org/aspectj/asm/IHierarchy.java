...
extends Serializable {
    ...
    public void setFileMap(Map<String, IProgramElement> var1);

    default public void setFileMap(HashMap<String, IProgramElement> fileMap) {
        this.setFileMap((Map<String, IProgramElement>)fileMap);
    }
