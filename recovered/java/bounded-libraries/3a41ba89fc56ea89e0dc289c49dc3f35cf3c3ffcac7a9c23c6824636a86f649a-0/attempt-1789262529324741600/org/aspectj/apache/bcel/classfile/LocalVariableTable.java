...
extends Attribute {
    ...
    public final synchronized void setLocalVariableTable(LocalVariable[] local_variable_table) {
        this.data = null;
    ...
    public synchronized LocalVariableTable copyFromPackedState() {
        ...
        try {
            return new LocalVariableTable(this.nameIndex, this.length, new DataInputStream(new ByteArrayInputStream(this.data)), this.getConstantPool());
        }
        catch (IOException e) {
