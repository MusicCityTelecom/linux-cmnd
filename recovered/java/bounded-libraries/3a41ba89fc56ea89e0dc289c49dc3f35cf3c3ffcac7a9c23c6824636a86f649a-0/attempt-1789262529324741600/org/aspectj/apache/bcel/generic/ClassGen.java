...
implements Cloneable {
    ...
    public ClassGen(JavaClass clazz) {
        ...
        for (Attribute attribute : attributes) {
            ...
            if (attribute instanceof RuntimeVisAnnos) {
                RuntimeVisAnnos rva = (RuntimeVisAnnos)attribute;
            ...
            if (attribute instanceof RuntimeInvisAnnos) {
                RuntimeInvisAnnos ria = (RuntimeInvisAnnos)attribute;
        ...
        for (Node node : methods) {
            this.addMethod((Method)node);
        }
        for (Node node : fields) {
            this.addField((Field)node);
        }
    }
    ...
    public JavaClass getJavaClass() {
        ...
        return new JavaClass(this.classnameIndex, this.superclassnameIndex, this.filename, this.major, this.minor, this.modifiers, cp, interfaces, fields, methods, attributes.toArray(Attribute.NoAttributes));
    }
