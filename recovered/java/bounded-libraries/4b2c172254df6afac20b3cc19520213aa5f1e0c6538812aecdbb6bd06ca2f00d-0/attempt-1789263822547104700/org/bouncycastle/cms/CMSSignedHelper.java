    ...
    Store getCertificates(ASN1Set aSN1Set) {
        if (aSN1Set != null) {
            ...
            while (enumeration.hasMoreElements()) {
                ...
                arrayList.add(new X509CertificateHolder(Certificate.getInstance((Object)aSN1Primitive)));
            }
    ...
    Store getAttributeCertificates(ASN1Set aSN1Set) {
        if (aSN1Set != null) {
            ...
            while (enumeration.hasMoreElements()) {
                ...
                arrayList.add(new X509AttributeCertificateHolder(AttributeCertificate.getInstance((Object)((ASN1TaggedObject)aSN1Primitive).getObject())));
            }
            return new CollectionStore(arrayList);
        }
        return new CollectionStore(new ArrayList());
    ...
    Store getCRLs(ASN1Set aSN1Set) {
        if (aSN1Set != null) {
            ...
            while (enumeration.hasMoreElements()) {
                ASN1Primitive aSN1Primitive = ((ASN1Encodable)enumeration.nextElement()).toASN1Primitive();
                if (!(aSN1Primitive instanceof ASN1Sequence)) continue;
                arrayList.add(new X509CRLHolder(CertificateList.getInstance((Object)aSN1Primitive)));
            }
            return new CollectionStore(arrayList);
        }
        return new CollectionStore(new ArrayList());
    ...
    Store getOtherRevocationInfo(ASN1ObjectIdentifier aSN1ObjectIdentifier, ASN1Set aSN1Set) {
        if (aSN1Set != null) {
            ...
            while (enumeration.hasMoreElements()) {
                ...
                ASN1Primitive aSN1Primitive = ((ASN1Encodable)enumeration.nextElement()).toASN1Primitive();
                if (!(aSN1Primitive instanceof ASN1TaggedObject) || (aSN1TaggedObject = ASN1TaggedObject.getInstance((Object)aSN1Primitive)).getTagNo() != 1 || !aSN1ObjectIdentifier.equals((ASN1Primitive)(otherRevocationInfoFormat = OtherRevocationInfoFormat.getInstance((ASN1TaggedObject)aSN1TaggedObject, (boolean)false)).getInfoFormat())) continue;
