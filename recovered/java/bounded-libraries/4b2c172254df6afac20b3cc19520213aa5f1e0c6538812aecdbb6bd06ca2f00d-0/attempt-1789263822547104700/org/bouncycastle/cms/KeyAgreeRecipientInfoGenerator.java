...
implements RecipientInfoGenerator {
    ...
    public RecipientInfo generate(GenericKey genericKey) throws CMSException {
        ...
        if (byArray != null) {
            return new RecipientInfo(new KeyAgreeRecipientInfo(originatorIdentifierOrKey, (ASN1OctetString)new DEROctetString(byArray), algorithmIdentifier2, aSN1Sequence));
        }
