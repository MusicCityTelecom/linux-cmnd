...
extends CMSSignedGenerator {
    ...
    public CMSSignedData generate(CMSTypedData cMSTypedData, boolean bl) throws CMSException {
        ...
        for (SignerInformation signerInformation2 : this._signers) {
            CMSUtils.addDigestAlgs(linkedHashSet, signerInformation2, this.digestAlgIdFinder);
            aSN1EncodableVector.add((ASN1Encodable)signerInformation2.toASN1Structure());
        }
        ...
        if (cMSTypedData.getContent() != null) {
            ...
            if (bl) {
                signerInformation2 = new BEROctetString(((ByteArrayOutputStream)object3).toByteArray());
            }
        }
        ...
        signerInfo = new ContentInfo(aSN1ObjectIdentifier, (ASN1Encodable)signerInformation2);
        object = new SignedData(CMSUtils.convertToBERSet(linkedHashSet), (ContentInfo)signerInfo, (ASN1Set)object3, (ASN1Set)object22, (ASN1Set)new DERSet(aSN1EncodableVector));
