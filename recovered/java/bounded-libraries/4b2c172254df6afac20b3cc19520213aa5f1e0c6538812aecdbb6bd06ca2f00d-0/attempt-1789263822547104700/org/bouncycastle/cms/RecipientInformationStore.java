    ...
    public Collection<RecipientInformation> getRecipients(RecipientId recipientId) {
        ...
        if (recipientId instanceof KeyTransRecipientId) {
            ...
            if (x500Name != null && byArray != null) {
                ...
                Collection<RecipientInformation> collection2 = this.getRecipients(new KeyTransRecipientId(x500Name, ((KeyTransRecipientId)object).getSerialNumber()));
                if (collection2 != null) {
        ...
        return (object = (ArrayList)this.table.get(recipientId)) == null ? new ArrayList<RecipientInformation>() : new ArrayList(object);
    }
