...
implements Encodable {
    ...
    public CMSAuthEnvelopedData(ContentInfo contentInfo) throws CMSException {
        ...
        AuthEnvelopedData authEnvelopedData = AuthEnvelopedData.getInstance((Object)contentInfo.getContent());
        ...
        CMSSecureReadable cMSSecureReadable = new CMSSecureReadable(){
            ...
            public InputStream getInputStream() throws IOException, CMSException {
                return new ByteArrayInputStream(Arrays.concatenate((byte[])encryptedContentInfo.getEncryptedContent().getOctets(), (byte[])CMSAuthEnvelopedData.this.mac));
            }
        };
