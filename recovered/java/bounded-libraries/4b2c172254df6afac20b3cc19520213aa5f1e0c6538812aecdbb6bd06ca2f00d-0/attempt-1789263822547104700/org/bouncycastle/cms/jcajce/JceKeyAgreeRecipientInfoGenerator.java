...
extends KeyAgreeRecipientInfoGenerator {
    ...
    public JceKeyAgreeRecipientInfoGenerator(ASN1ObjectIdentifier aSN1ObjectIdentifier, PrivateKey privateKey, PublicKey publicKey, ASN1ObjectIdentifier aSN1ObjectIdentifier2) {
        super(aSN1ObjectIdentifier, SubjectPublicKeyInfo.getInstance((Object)publicKey.getEncoded()), aSN1ObjectIdentifier2);
    ...
    public JceKeyAgreeRecipientInfoGenerator setUserKeyingMaterial(byte[] byArray) {
        this.userKeyingMaterial = Arrays.clone((byte[])byArray);
        return this;
    }
    ...
    public ASN1Sequence generateRecipientEncryptedKeys(AlgorithmIdentifier algorithmIdentifier, AlgorithmIdentifier algorithmIdentifier2, GenericKey genericKey) throws CMSException {
        ...
        for (int i = 0; i != this.recipientIDs.size(); ++i) {
            ...
            try {
                ...
                byte[] byArray;
                Object object;
                MQVParameterSpec mQVParameterSpec;
                ...
                if (CMSUtils.isMQV(aSN1ObjectIdentifier)) {
                    ...
                    mQVParameterSpec = new UserKeyingMaterialSpec((byte[])object);
                ...
                ((KeyAgreement)object).init(privateKey, (AlgorithmParameterSpec)mQVParameterSpec, this.random);
                ...
                if (aSN1ObjectIdentifier2.equals((ASN1Primitive)CryptoProObjectIdentifiers.id_Gost28147_89_None_KeyWrap) || aSN1ObjectIdentifier2.equals((ASN1Primitive)CryptoProObjectIdentifiers.id_Gost28147_89_CryptoPro_KeyWrap)) {
                    cipher.init(3, (Key)secretKey, (AlgorithmParameterSpec)new GOST28147WrapParameterSpec(CryptoProObjectIdentifiers.id_Gost28147_89_CryptoPro_A_ParamSet, this.userKeyingMaterial));
                    byArray = cipher.wrap(this.helper.getJceKey(genericKey));
                    Gost2814789EncryptedKey gost2814789EncryptedKey = new Gost2814789EncryptedKey(Arrays.copyOfRange((byte[])byArray, (int)0, (int)(byArray.length - 4)), Arrays.copyOfRange((byte[])byArray, (int)(byArray.length - 4), (int)byArray.length));
    ...
    private void init(ASN1ObjectIdentifier aSN1ObjectIdentifier) throws CMSException {
        ...
        if (CMSUtils.isMQV(aSN1ObjectIdentifier) && this.ephemeralKP == null) {
            try {
                SubjectPublicKeyInfo subjectPublicKeyInfo = SubjectPublicKeyInfo.getInstance((Object)this.senderPublicKey.getEncoded());
