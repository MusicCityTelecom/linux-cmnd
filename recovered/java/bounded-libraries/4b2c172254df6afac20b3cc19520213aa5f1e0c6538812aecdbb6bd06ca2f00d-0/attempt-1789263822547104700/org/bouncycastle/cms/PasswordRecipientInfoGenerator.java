...
implements RecipientInfoGenerator {
    ...
    public RecipientInfo generate(GenericKey genericKey) throws CMSException {
        ...
        AlgorithmIdentifier algorithmIdentifier = new AlgorithmIdentifier(this.kekAlgorithm, (ASN1Encodable)new DEROctetString(byArray));
        ...
        aSN1EncodableVector.add((ASN1Encodable)new DEROctetString(byArray));
