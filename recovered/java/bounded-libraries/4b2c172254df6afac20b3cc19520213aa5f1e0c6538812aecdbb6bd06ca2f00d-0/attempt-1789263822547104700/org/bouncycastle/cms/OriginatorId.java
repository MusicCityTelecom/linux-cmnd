...
implements Selector {
    ...
    public boolean equals(Object object) {
        ...
        return Arrays.areEqual((byte[])this.subjectKeyId, (byte[])originatorId.subjectKeyId) && this.equalsObj(this.serialNumber, originatorId.serialNumber) && this.equalsObj(this.issuer, originatorId.issuer);
    }
