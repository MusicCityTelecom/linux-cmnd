...
implements Encodable {
    ...
    public CMSAuthenticatedData(ContentInfo contentInfo, DigestCalculatorProvider digestCalculatorProvider) throws CMSException {
        ...
        CMSProcessableByteArray cMSProcessableByteArray = new CMSProcessableByteArray(contentInfo2.getContentType(), ASN1OctetString.getInstance((Object)contentInfo2.getContent()).getOctets());
        if (this.authAttrs != null) {
            ...
            if (aSN1EncodableVector.size() > 0) {
                object = Attribute.getInstance((Object)aSN1EncodableVector.get(0));
                if (object.getAttrValues().size() != 1) {
                    throw new CMSException("A cmsAlgorithmProtect attribute MUST contain exactly one value");
                }
                CMSAlgorithmProtection cMSAlgorithmProtection = CMSAlgorithmProtection.getInstance((Object)object.getAttributeValues()[0]);
