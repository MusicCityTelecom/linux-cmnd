...
public class ESTService {
    ...
    public static X509CertificateHolder[] storeToArray(Store<X509CertificateHolder> store, Selector<X509CertificateHolder> selector) {
        Collection collection = store.getMatches(selector);
        ...
        try {
            ...
            if (var1_1.getStatusCode() == 200) {
                ...
                try {
                    ...
                    var12_16 = new SimplePKIResponse(ContentInfo.getInstance((Object)((ASN1Sequence)var11_14.readObject())));
            ...
            ESTRequestBuilder eSTRequestBuilder = new ESTRequestBuilder("POST", uRL).withClient(eSTClient).withConnectionListener(new ESTSourceConnectionListener(){
                ...
                public ESTRequest onConnection(Source source, ESTRequest eSTRequest) throws IOException {
                    if (source instanceof TLSUniqueProvider && ((TLSUniqueProvider)((Object)source)).isTLSUniqueAvailable()) {
                        ...
                        pKCS10CertificationRequestBuilder2.setAttribute(PKCSObjectIdentifiers.pkcs_9_at_challengePassword, (ASN1Encodable)new DERPrintableString(Base64.toBase64String((byte[])byArray)));
                ...
                case 200: {
                    try {
                        if (var1_1.getContentLength() != null && var1_1.getContentLength() > 0L) {
                            ...
                            var8_11 = ASN1Sequence.getInstance((Object)var7_9.readObject());
                            var2_2 = new CSRAttributesResponse(CsrAttrs.getInstance((Object)var8_11));
                            ** break;
                        }
lbl20:
                        // 3 sources
    ...
    private String annotateRequest(byte[] byArray) {
        ...
        do {
            if (n + 48 < byArray.length) {
                printWriter.print(Base64.toBase64String((byte[])byArray, (int)n, (int)48));
                n += 48;
            } else {
                printWriter.print(Base64.toBase64String((byte[])byArray, (int)n, (int)(byArray.length - n)));
                n = byArray.length;
            }
            printWriter.print('\n');
