...
public class ESTResponse {
    ...
    public ESTResponse(ESTRequest eSTRequest, Source source) throws IOException {
        ...
        this.inputStream = (set = Properties.asKeySet((String)"org.bouncycastle.debug.est")).contains("input") || set.contains("all") ? new PrintingInputStream(source.getInputStream()) : source.getInputStream();
    ...
    private void process() throws IOException {
        ...
        while (string.length() > 0) {
            ...
            if (n > -1) {
                String string2 = Strings.toLowerCase((String)string.substring(0, n).trim());
