...
public class JcaJceUtils {
    ...
    public static void validateServerCertUsage(X509Certificate x509Certificate) throws CertificateException {
        try {
            ...
            KeyUsage keyUsage = KeyUsage.fromExtensions((Extensions)x509CertificateHolder.getExtensions());
            if (keyUsage != null) {
            ...
            if (!((extendedKeyUsage = ExtendedKeyUsage.fromExtensions((Extensions)x509CertificateHolder.getExtensions())) == null || extendedKeyUsage.hasKeyPurposeId(KeyPurposeId.id_kp_serverAuth) || extendedKeyUsage.hasKeyPurposeId(KeyPurposeId.id_kp_msSGC) || extendedKeyUsage.hasKeyPurposeId(KeyPurposeId.id_kp_nsSGC))) {
