...
public class JcaEACSignerBuilder {
    ...
    private static byte[] reencode(byte[] byArray) {
        ...
        BigInteger bigInteger = ASN1Integer.getInstance((Object)aSN1Sequence.getObjectAt(0)).getValue();
        BigInteger bigInteger2 = ASN1Integer.getInstance((Object)aSN1Sequence.getObjectAt(1)).getValue();
