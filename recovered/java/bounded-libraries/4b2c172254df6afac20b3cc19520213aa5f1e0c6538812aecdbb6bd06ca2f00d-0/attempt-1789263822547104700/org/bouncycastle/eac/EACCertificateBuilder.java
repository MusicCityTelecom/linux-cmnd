...
public class EACCertificateBuilder {
    ...
    private CertificateBody buildBody() {
        ...
        CertificateBody certificateBody = new CertificateBody((ASN1ApplicationSpecific)dERApplicationSpecific, this.certificationAuthorityReference, this.publicKey, this.certificateHolderReference, this.certificateHolderAuthorization, this.certificateEffectiveDate, this.certificateExpirationDate);
