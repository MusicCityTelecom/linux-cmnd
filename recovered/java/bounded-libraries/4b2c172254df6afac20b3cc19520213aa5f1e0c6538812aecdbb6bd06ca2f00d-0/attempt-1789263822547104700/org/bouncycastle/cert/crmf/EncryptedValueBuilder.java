...
public class EncryptedValueBuilder {
    ...
    public EncryptedValue build(char[] cArray) throws CRMFException {
        return this.encryptData(this.padData(Strings.toUTF8ByteArray((char[])cArray)));
    }
    ...
    public EncryptedValue build(PrivateKeyInfo privateKeyInfo) throws CRMFException {
        ...
        try {
            ...
            return new EncryptedValue(algorithmIdentifier, algorithmIdentifier2, (ASN1BitString)dERBitString, algorithmIdentifier3, aSN1OctetString, (ASN1BitString)new DERBitString(pKCS8EncryptedPrivateKeyInfo.getEncryptedData()));
        }
    ...
    private EncryptedValue encryptData(byte[] byArray) throws CRMFException {
        ...
        return new EncryptedValue(algorithmIdentifier, algorithmIdentifier2, (ASN1BitString)dERBitString, algorithmIdentifier3, aSN1OctetString, (ASN1BitString)dERBitString2);
    }
