...
public class OCSPReqBuilder {
    ...
    private OCSPReq generateRequest(ContentSigner contentSigner, X509CertificateHolder[] x509CertificateHolderArray) throws OCSPException {
        ...
        if (contentSigner != null) {
            ...
            outputStream = new DERBitString(contentSigner.getSignature());
            ...
            if (x509CertificateHolderArray != null && x509CertificateHolderArray.length > 0) {
                ...
                signature = new Signature(algorithmIdentifier, (DERBitString)outputStream, (ASN1Sequence)new DERSequence(aSN1EncodableVector2));
            } else {
                signature = new Signature(algorithmIdentifier, (DERBitString)outputStream);
            }
        }
