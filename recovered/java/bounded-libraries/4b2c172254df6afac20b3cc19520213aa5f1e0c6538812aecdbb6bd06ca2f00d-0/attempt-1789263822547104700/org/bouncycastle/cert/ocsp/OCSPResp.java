...
public class OCSPResp {
    ...
    public Object getResponseObject() throws OCSPException {
        ...
        if (responseBytes.getResponseType().equals((ASN1Primitive)OCSPObjectIdentifiers.id_pkix_ocsp_basic)) {
            try {
                ASN1Primitive aSN1Primitive = ASN1Primitive.fromByteArray((byte[])responseBytes.getResponse().getOctets());
                return new BasicOCSPResp(BasicOCSPResponse.getInstance((Object)aSN1Primitive));
            }
    ...
    public boolean equals(Object object) {
        ...
        return this.resp.equals((Object)oCSPResp.resp);
    }
