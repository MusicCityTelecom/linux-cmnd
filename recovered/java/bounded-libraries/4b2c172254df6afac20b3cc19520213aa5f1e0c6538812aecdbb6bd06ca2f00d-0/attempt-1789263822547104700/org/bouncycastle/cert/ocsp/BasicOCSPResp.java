...
implements Encodable {
    ...
    public BasicOCSPResp(BasicOCSPResponse basicOCSPResponse) {
        ...
        this.extensions = Extensions.getInstance((Object)basicOCSPResponse.getTbsResponseData().getResponseExtensions());
    }
    ...
    public SingleResp[] getResponses() {
        ...
        for (int i = 0; i != singleRespArray.length; ++i) {
            singleRespArray[i] = new SingleResp(SingleResponse.getInstance((Object)aSN1Sequence.getObjectAt(i)));
        }
        ...
        if (this.resp.getCerts() != null) {
            ...
            if (aSN1Sequence != null) {
                ...
                for (int i = 0; i != x509CertificateHolderArray.length; ++i) {
                    x509CertificateHolderArray[i] = new X509CertificateHolder(Certificate.getInstance((Object)aSN1Sequence.getObjectAt(i)));
                }
    ...
    public boolean equals(Object object) {
        ...
        return this.resp.equals((Object)basicOCSPResp.resp);
    }
