...
implements Selector {
    ...
    public boolean equals(Object object) {
        ...
        return Arrays.areEqual((byte[])this.subjectKeyId, (byte[])x509CertificateHolderSelector.subjectKeyId) && this.equalsObj(this.serialNumber, x509CertificateHolderSelector.serialNumber) && this.equalsObj(this.issuer, x509CertificateHolderSelector.issuer);
    }
    ...
    public boolean match(Object object) {
        if (object instanceof X509CertificateHolder) {
            ...
            if (this.getSerialNumber() != null) {
                ...
                return issuerAndSerialNumber.getName().equals((Object)this.issuer) && issuerAndSerialNumber.getSerialNumber().hasValue(this.serialNumber);
            }
            if (this.subjectKeyId != null) {
                Extension extension = x509CertificateHolder.getExtension(Extension.subjectKeyIdentifier);
                if (extension == null) {
                    return Arrays.areEqual((byte[])this.subjectKeyId, (byte[])MSOutlookKeyIdCalculator.calculateKeyId(x509CertificateHolder.getSubjectPublicKeyInfo()));
                }
                byte[] byArray = ASN1OctetString.getInstance((Object)extension.getParsedValue()).getOctets();
