...
implements Selector {
    ...
    public boolean match(Object object) {
        ...
        if (!(this.targetNames.isEmpty() && this.targetGroups.isEmpty() || (extension = x509AttributeCertificateHolder.getExtension(Extension.targetInformation)) == null)) {
            ...
            try {
                targetInformation = TargetInformation.getInstance((Object)extension.getParsedValue());
            }
            ...
            if (!this.targetNames.isEmpty()) {
                ...
                block2: for (n2 = 0; n2 < targetsArray.length; ++n2) {
                    ...
                    for (n = 0; n < targetArray.length; ++n) {
                        if (!this.targetNames.contains(GeneralName.getInstance((Object)targetArray[n].getTargetName()))) continue;
                        bl = true;
                        continue block2;
                    }
                }
            ...
            if (!this.targetGroups.isEmpty()) {
                ...
                block4: for (n2 = 0; n2 < targetsArray.length; ++n2) {
                    ...
                    targetArray = targets.getTargets();
                    for (n = 0; n < targetArray.length; ++n) {
                        if (!this.targetGroups.contains(GeneralName.getInstance((Object)targetArray[n].getTargetGroup()))) continue;
                        bl = true;
                        continue block4;
                    }
                }
