...
class MSOutlookKeyIdCalculator {
    ...
    extends GeneralDigest {
        ...
        public int doFinal(byte[] byArray, int n) {
            this.finish();
            Pack.intToBigEndian((int)this.H1, (byte[])byArray, (int)n);
            Pack.intToBigEndian((int)this.H2, (byte[])byArray, (int)(n + 4));
            Pack.intToBigEndian((int)this.H3, (byte[])byArray, (int)(n + 8));
            Pack.intToBigEndian((int)this.H4, (byte[])byArray, (int)(n + 12));
            Pack.intToBigEndian((int)this.H5, (byte[])byArray, (int)(n + 16));
            this.reset();
            return 20;
        }
