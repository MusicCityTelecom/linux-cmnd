...
public class JcaX500NameUtil {
    public static X500Name getIssuer(X509Certificate x509Certificate) {
        if (x509Certificate instanceof BCX509Certificate) {
            return JcaX500NameUtil.notNull(((BCX509Certificate)x509Certificate).getIssuerX500Name());
        }
    ...
    public static X500Name getIssuer(X500NameStyle x500NameStyle, X509Certificate x509Certificate) {
        if (x509Certificate instanceof BCX509Certificate) {
            return X500Name.getInstance((X500NameStyle)x500NameStyle, (Object)JcaX500NameUtil.notNull(((BCX509Certificate)x509Certificate).getIssuerX500Name()));
        }
    ...
    public static X500Name getSubject(X509Certificate x509Certificate) {
        if (x509Certificate instanceof BCX509Certificate) {
            return JcaX500NameUtil.notNull(((BCX509Certificate)x509Certificate).getSubjectX500Name());
        }
    ...
    public static X500Name getSubject(X500NameStyle x500NameStyle, X509Certificate x509Certificate) {
        if (x509Certificate instanceof BCX509Certificate) {
            return X500Name.getInstance((X500NameStyle)x500NameStyle, (Object)JcaX500NameUtil.notNull(((BCX509Certificate)x509Certificate).getSubjectX500Name()));
        }
    ...
    public static X500Name getX500Name(X500Principal x500Principal) {
        return X500Name.getInstance((Object)JcaX500NameUtil.getEncoded(x500Principal));
    }

    public static X500Name getX500Name(X500NameStyle x500NameStyle, X500Principal x500Principal) {
        return X500Name.getInstance((X500NameStyle)x500NameStyle, (Object)JcaX500NameUtil.getEncoded(x500Principal));
    }
