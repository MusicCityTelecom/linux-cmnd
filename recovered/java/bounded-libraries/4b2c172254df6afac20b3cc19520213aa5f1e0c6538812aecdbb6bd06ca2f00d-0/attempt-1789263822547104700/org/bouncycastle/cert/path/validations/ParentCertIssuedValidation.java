...
implements CertPathValidation {
    ...
    public void validate(CertPathValidationContext certPathValidationContext, X509CertificateHolder x509CertificateHolder) throws CertPathValidationException {
        ...
        if (this.workingPublicKey != null) {
            try {
                SubjectPublicKeyInfo subjectPublicKeyInfo = this.workingPublicKey.getAlgorithm().equals((Object)this.workingAlgId) ? this.workingPublicKey : new SubjectPublicKeyInfo(this.workingAlgId, (ASN1Encodable)this.workingPublicKey.parsePublicKey());
