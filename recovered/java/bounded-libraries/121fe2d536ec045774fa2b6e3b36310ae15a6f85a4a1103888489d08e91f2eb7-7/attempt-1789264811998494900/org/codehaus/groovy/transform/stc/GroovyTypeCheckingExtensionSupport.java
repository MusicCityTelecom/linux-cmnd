        ...
        block17: {
            ...
            try {
                ...
                if (TypeCheckingDSL.class.isAssignableFrom(clazz)) {
                    script = (TypeCheckingDSL)clazz.getDeclaredConstructor(new Class[0]).newInstance(new Object[0]);
                    break block17;
                }
                if (!TypeCheckingExtension.class.isAssignableFrom(clazz)) break block17;
                try {
    ...
    extends Script {
        ...
        public Object invokeMethod(String name, Object args) {
            ...
            if (args instanceof Object[] && ((Object[])args).length == 1 && ((Object[])args)[0] instanceof Closure) {
                ...
                List closures = this.extension.eventHandlers.computeIfAbsent(methodName, k -> new LinkedList());
