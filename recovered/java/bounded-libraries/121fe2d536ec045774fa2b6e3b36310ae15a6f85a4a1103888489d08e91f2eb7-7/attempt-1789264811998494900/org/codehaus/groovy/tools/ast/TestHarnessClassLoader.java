...
implements GroovyObject {
    ...
    protected CompilationUnit createCompilationUnit(CompilerConfiguration config, CodeSource codeSource) {
        CallSite[] callSiteArray = TestHarnessClassLoader.$getCallSiteArray();
        CompilationUnit cu = (CompilationUnit)ScriptBytecodeAdapter.castToType(ScriptBytecodeAdapter.invokeMethodOnSuperN(TestHarnessClassLoader.class, this, "createCompilationUnit", new Object[]{config, codeSource}), CompilationUnit.class);
        callSiteArray[0].call(cu, callSiteArray[1].callConstructor(TestHarnessOperation.class, this.transform), callSiteArray[2].callGetProperty((Object)this.phase));
        return cu;
    }
