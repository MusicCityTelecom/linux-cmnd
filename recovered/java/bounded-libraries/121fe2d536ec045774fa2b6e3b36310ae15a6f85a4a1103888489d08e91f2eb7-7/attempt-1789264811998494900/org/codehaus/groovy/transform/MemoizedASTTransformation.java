...
extends AbstractASTTransformation {
    ...
    public void visit(ASTNode[] nodes, SourceUnit source) {
        ...
        if (MY_TYPE.equals(annotationNode.getClassNode()) && annotatedNode instanceof MethodNode) {
            ...
            MethodNode delegatingMethod = MemoizedASTTransformation.buildDelegatingMethod(methodNode, ownerClassNode);
            ClassNodeUtils.addGeneratedMethod(ownerClassNode, delegatingMethod);
            int modifiers = 18;
            ...
            MethodCallExpression memoizeClosureCallExpression = MemoizedASTTransformation.buildMemoizeClosureCallExpression(delegatingMethod, protectedCacheSize, maxCacheSize);
    ...
    private static MethodNode buildDelegatingMethod(MethodNode annotatedMethod, ClassNode ownerClassNode) {
    ...
    private static MethodCallExpression buildMemoizeClosureCallExpression(MethodNode privateMethod, int protectedCacheSize, int maxCacheSize) {
