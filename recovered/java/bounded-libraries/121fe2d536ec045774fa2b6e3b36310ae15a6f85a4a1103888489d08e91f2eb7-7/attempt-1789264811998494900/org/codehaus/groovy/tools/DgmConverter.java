...
public class DgmConverter {
    public static void main(String[] args) throws IOException {
        ...
        CachedMethod[] cachedMethods = cachedMethodsList.toArray(CachedMethod.EMPTY_ARRAY);
        ...
        for (CachedMethod method : cachedMethods) {
            if (!method.isStatic() || !method.isPublic() || method.getAnnotation(Deprecated.class) != null || method.getParameterTypes().length == 0) continue;
            ...
            cw.visit(CompilerConfiguration.DEFAULT.getBytecodeVersion(), 1, className, null, "org/codehaus/groovy/reflection/GeneratedMetaMethod", null);
