...
public class MethodCallExpressionTransformer {
    ...
    Expression transformMethodCallExpression(MethodCallExpression expr) {
        ...
        if (MethodCallExpressionTransformer.isCallOnClosure(expr) && this.staticCompilationTransformer.getClassNode() != null && (field = this.staticCompilationTransformer.getClassNode().getField(expr.getMethodAsString())) != null) {
