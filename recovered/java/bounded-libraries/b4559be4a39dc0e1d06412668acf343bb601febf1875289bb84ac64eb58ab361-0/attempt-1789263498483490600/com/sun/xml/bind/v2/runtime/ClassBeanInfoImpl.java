    ...
    public void serializeBody(BeanT bean, XMLSerializer target) throws SAXException, IOException, XMLStreamException {
        ...
        try {
            for (Property<BeanT> p : this.properties) {
                ...
                if (!isThereAnOverridingProperty || com.sun.xml.bind.v2.runtime.Utils.REFLECTION_NAVIGATOR.getDeclaredField(beanSuperClass = bean.getClass().getSuperclass(), p.getFieldName()) != null) continue;
                p.serializeBody(bean, target, null);
            }
        }
        catch (AccessorException e) {
