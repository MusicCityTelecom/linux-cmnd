...
implements Receiver {
    ...
    public final <T> Accessor<BeanT, T> adapt(Adapter<Type, Class> adapter) {
        return new AdaptedAccessor((Class)com.sun.xml.bind.v2.runtime.reflect.Utils.REFLECTION_NAVIGATOR.erasure((Type)adapter.defaultType), this, (Class)adapter.adapterType);
    }
