...
public class ContextFactory {
    ...
    public static JAXBContext createContext(Class[] classes, Map<String, Object> properties) throws JAXBException {
        ...
        if ((improvedXsiTypeHandling = ContextFactory.getPropertyValue(properties, "com.sun.xml.bind.improvedXsiTypeHandling", Boolean.class)) == null) {
            String improvedXsiSystemProperty = Utils.getSystemProperty("com.sun.xml.bind.improvedXsiTypeHandling");
        ...
        Integer maxErrorsCount = ContextFactory.getPropertyValue(properties, "com.sun.xml.bind.maxErrorsCount", Integer.class);
