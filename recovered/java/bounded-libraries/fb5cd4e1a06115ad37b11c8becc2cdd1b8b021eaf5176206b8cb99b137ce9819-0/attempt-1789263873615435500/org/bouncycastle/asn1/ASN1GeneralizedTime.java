...
extends ASN1Primitive {
    ...
    private String pruneFractionalSeconds(String object) {
        char c;
        int n;
        Object object2 = ((String)object).substring(14);
        for (n = 1; n < ((String)object2).length() && '0' <= (c = ((String)object2).charAt(n)) && c <= '9'; ++n) {
        }
        if (n - 1 > 3) {
            object2 = ((String)object2).substring(0, 4) + ((String)object2).substring(n);
            object = ((String)object).substring(0, 14) + (String)object2;
        } else if (n - 1 == 1) {
            object2 = ((String)object2).substring(0, n) + "00" + ((String)object2).substring(n);
            object = ((String)object).substring(0, 14) + (String)object2;
        } else if (n - 1 == 2) {
            object2 = ((String)object2).substring(0, n) + "0" + ((String)object2).substring(n);
            object = ((String)object).substring(0, 14) + (String)object2;
        }
        return object;
    }
