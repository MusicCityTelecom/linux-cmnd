...
public @interface Router {
    ...
    public String defaultOutputChannel() default "";

    public String[] channelMappings() default {};

    public String prefix() default "";

    public String suffix() default "";

    public String resolutionRequired() default "";

    public String applySequence() default "";

    public String ignoreSendFailures() default "";
