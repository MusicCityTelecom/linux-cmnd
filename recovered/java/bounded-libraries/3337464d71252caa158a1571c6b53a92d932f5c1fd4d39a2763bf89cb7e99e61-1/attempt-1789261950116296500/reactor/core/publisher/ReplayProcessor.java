...
InternalManySink<T> {
    ...
    public static <E> ReplayProcessor<E> create() {
        return ReplayProcessor.create(Queues.SMALL_BUFFER_SIZE, true);
    }
    ...
    public static <T> ReplayProcessor<T> createTimeout(Duration maxAge) {
        return ReplayProcessor.createTimeout(maxAge, Schedulers.parallel());
    }

    @Deprecated
    public static <T> ReplayProcessor<T> createTimeout(Duration maxAge, Scheduler scheduler) {
        return ReplayProcessor.createSizeAndTimeout(Integer.MAX_VALUE, maxAge, scheduler);
    }

    @Deprecated
    public static <T> ReplayProcessor<T> createSizeAndTimeout(int size, Duration maxAge) {
        return ReplayProcessor.createSizeAndTimeout(size, maxAge, Schedulers.parallel());
    }
    ...
    public void subscribe(CoreSubscriber<? super T> actual) {
        ...
        ReplayInner<T> rs = new ReplayInner<T>(actual, this);
