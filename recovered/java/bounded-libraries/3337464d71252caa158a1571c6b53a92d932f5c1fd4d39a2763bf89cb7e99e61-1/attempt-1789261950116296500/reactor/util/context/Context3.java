...
implements CoreContext {
    ...
    public Context delete(Object key) {
        ...
        if (this.key3.equals(key)) {
            return new Context2(this.key1, this.value1, this.key2, this.value2);
        }
        return this;
    }
    ...
    public Stream<Map.Entry<Object, Object>> stream() {
        return Stream.of(new AbstractMap.SimpleImmutableEntry<Object, Object>(this.key1, this.value1), new AbstractMap.SimpleImmutableEntry<Object, Object>(this.key2, this.value2), new AbstractMap.SimpleImmutableEntry<Object, Object>(this.key3, this.value3));
    }
