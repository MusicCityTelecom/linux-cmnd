...
implements CoreContext {
    ...
    public Context put(Object key, Object value) {
        ...
        if (this.key5.equals(key)) {
            return new Context5(this.key1, this.value1, this.key2, this.value2, this.key3, this.value3, this.key4, this.value4, key, value);
        }
        return new ContextN(this.key1, this.value1, this.key2, this.value2, this.key3, this.value3, this.key4, this.value4, this.key5, this.value5, key, value);
    }
    ...
    public Context delete(Object key) {
        ...
        if (this.key5.equals(key)) {
            return new Context4(this.key1, this.value1, this.key2, this.value2, this.key3, this.value3, this.key4, this.value4);
        }
        return this;
    }
    ...
    public Stream<Map.Entry<Object, Object>> stream() {
        return Stream.of(new AbstractMap.SimpleImmutableEntry<Object, Object>(this.key1, this.value1), new AbstractMap.SimpleImmutableEntry<Object, Object>(this.key2, this.value2), new AbstractMap.SimpleImmutableEntry<Object, Object>(this.key3, this.value3), new AbstractMap.SimpleImmutableEntry<Object, Object>(this.key4, this.value4), new AbstractMap.SimpleImmutableEntry<Object, Object>(this.key5, this.value5));
    }
    ...
    public void forEach(BiConsumer<Object, Object> action) {
        ...
        action.accept(this.key3, this.value3);
        action.accept(this.key4, this.value4);
        action.accept(this.key5, this.value5);
    }
