...
extends Tuple4<T1, T2, T3, T4> {
    ...
    public <R> Tuple5<R, T2, T3, T4, T5> mapT1(Function<T1, R> mapper) {
        return new Tuple5<R, Object, Object, Object, T5>(mapper.apply(this.t1), this.t2, this.t3, this.t4, this.t5);
    }

    public <R> Tuple5<T1, R, T3, T4, T5> mapT2(Function<T2, R> mapper) {
        return new Tuple5<Object, R, Object, Object, T5>(this.t1, mapper.apply(this.t2), this.t3, this.t4, this.t5);
    }

    public <R> Tuple5<T1, T2, R, T4, T5> mapT3(Function<T3, R> mapper) {
        return new Tuple5<Object, Object, R, Object, T5>(this.t1, this.t2, mapper.apply(this.t3), this.t4, this.t5);
    }

    public <R> Tuple5<T1, T2, T3, R, T5> mapT4(Function<T4, R> mapper) {
        return new Tuple5<Object, Object, Object, R, T5>(this.t1, this.t2, this.t3, mapper.apply(this.t4), this.t5);
    }

    public <R> Tuple5<T1, T2, T3, T4, R> mapT5(Function<T5, R> mapper) {
        return new Tuple5<Object, Object, Object, Object, R>(this.t1, this.t2, this.t3, this.t4, mapper.apply(this.t5));
    }
