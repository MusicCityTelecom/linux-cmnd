...
extends Tuple5<T1, T2, T3, T4, T5> {
    ...
    public <R> Tuple6<R, T2, T3, T4, T5, T6> mapT1(Function<T1, R> mapper) {
        return new Tuple6<R, Object, Object, Object, Object, T6>(mapper.apply(this.t1), this.t2, this.t3, this.t4, this.t5, this.t6);
    }

    public <R> Tuple6<T1, R, T3, T4, T5, T6> mapT2(Function<T2, R> mapper) {
        return new Tuple6<Object, R, Object, Object, Object, T6>(this.t1, mapper.apply(this.t2), this.t3, this.t4, this.t5, this.t6);
    }

    public <R> Tuple6<T1, T2, R, T4, T5, T6> mapT3(Function<T3, R> mapper) {
        return new Tuple6<Object, Object, R, Object, Object, T6>(this.t1, this.t2, mapper.apply(this.t3), this.t4, this.t5, this.t6);
    }

    public <R> Tuple6<T1, T2, T3, R, T5, T6> mapT4(Function<T4, R> mapper) {
        return new Tuple6<Object, Object, Object, R, Object, T6>(this.t1, this.t2, this.t3, mapper.apply(this.t4), this.t5, this.t6);
    }

    public <R> Tuple6<T1, T2, T3, T4, R, T6> mapT5(Function<T5, R> mapper) {
        return new Tuple6<Object, Object, Object, Object, R, T6>(this.t1, this.t2, this.t3, this.t4, mapper.apply(this.t5), this.t6);
    }

    public <R> Tuple6<T1, T2, T3, T4, T5, R> mapT6(Function<T6, R> mapper) {
        return new Tuple6<Object, Object, Object, Object, Object, R>(this.t1, this.t2, this.t3, this.t4, this.t5, mapper.apply(this.t6));
    }
