...
extends Tuple3<T1, T2, T3> {
    ...
    public <R> Tuple4<R, T2, T3, T4> mapT1(Function<T1, R> mapper) {
        return new Tuple4<R, Object, Object, T4>(mapper.apply(this.t1), this.t2, this.t3, this.t4);
    }

    public <R> Tuple4<T1, R, T3, T4> mapT2(Function<T2, R> mapper) {
        return new Tuple4<Object, R, Object, T4>(this.t1, mapper.apply(this.t2), this.t3, this.t4);
    }

    public <R> Tuple4<T1, T2, R, T4> mapT3(Function<T3, R> mapper) {
        return new Tuple4<Object, Object, R, T4>(this.t1, this.t2, mapper.apply(this.t3), this.t4);
    }

    public <R> Tuple4<T1, T2, T3, R> mapT4(Function<T4, R> mapper) {
        return new Tuple4<Object, Object, Object, R>(this.t1, this.t2, this.t3, mapper.apply(this.t4));
    }
