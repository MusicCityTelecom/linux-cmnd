...
extends BaseObject {
    ...
    String getStatsString() {
        return String.format("activeTimes=%s, blockWhenExhausted=%s, borrowedCount=%,d, closed=%s, createdCount=%,d, destroyedByBorrowValidationCount=%,d, destroyedByEvictorCount=%,d, evictorShutdownTimeoutDuration=%s, fairness=%s, idleTimes=%s, lifo=%s, maxBorrowWaitDuration=%s, maxTotal=%s, maxWaitDuration=%s, minEvictableIdleDuration=%s, numTestsPerEvictionRun=%s, returnedCount=%s, softMinEvictableIdleDuration=%s, testOnBorrow=%s, testOnCreate=%s, testOnReturn=%s, testWhileIdle=%s, durationBetweenEvictionRuns=%s, waitTimes=%s", this.activeTimes.getCurrentValues(), this.blockWhenExhausted, this.borrowedCount.get(), this.closed, this.createdCount.get(), this.destroyedByBorrowValidationCount.get(), this.destroyedByEvictorCount.get(), this.evictorShutdownTimeoutDuration, this.fairness, this.idleTimes.getCurrentValues(), this.lifo, this.maxBorrowWaitDuration.get(), this.maxTotal, this.maxWaitDuration, this.minEvictableIdleDuration, this.numTestsPerEvictionRun, this.returnedCount, this.softMinEvictableIdleDuration, this.testOnBorrow, this.testOnCreate, this.testOnReturn, this.testWhileIdle, this.durationBetweenEvictionRuns, this.waitTimes.getCurrentValues());
    }
    ...
    protected void setConfig(BaseObjectPoolConfig<T> config) {
        ...
        this.setMinEvictableIdle(config.getMinEvictableIdleDuration());
        this.setTimeBetweenEvictionRuns(config.getDurationBetweenEvictionRuns());
        this.setSoftMinEvictableIdle(config.getSoftMinEvictableIdleDuration());
    ...
    private class StatsStore {
        ...
        public String toString() {
            ...
            builder.append(this.getCurrentValues());
            builder.append("], size=");
