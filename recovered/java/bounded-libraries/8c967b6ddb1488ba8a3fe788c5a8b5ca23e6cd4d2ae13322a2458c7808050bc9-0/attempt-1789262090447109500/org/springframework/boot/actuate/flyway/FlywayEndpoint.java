...
public class FlywayEndpoint {
    ...
    public ApplicationFlywayBeans flywayBeans() {
        ...
        HashMap<String, ContextFlywayBeans> contextFlywayBeans = new HashMap<String, ContextFlywayBeans>();
        while (target != null) {
            HashMap flywayBeans = new HashMap();
    ...
    public static class FlywayDescriptor {
        ...
        private FlywayDescriptor(MigrationInfo[] migrations) {
            this.migrations = Stream.of(migrations).map(x$0 -> new FlywayMigration((MigrationInfo)x$0)).collect(Collectors.toList());
        }
