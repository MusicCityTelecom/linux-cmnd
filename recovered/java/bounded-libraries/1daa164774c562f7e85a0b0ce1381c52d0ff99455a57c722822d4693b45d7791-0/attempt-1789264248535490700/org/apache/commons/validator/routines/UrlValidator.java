...
implements Serializable {
    ...
    public UrlValidator(String[] schemes, RegexValidator authorityValidator, long options) {
        this(schemes, authorityValidator, options, DomainValidator.getInstance(UrlValidator.isOn(8L, options)));
    }
    ...
    public UrlValidator(String[] schemes, RegexValidator authorityValidator, long options, DomainValidator domainValidator) {
        ...
        if (domainValidator.isAllowLocal() != (options & 8L) > 0L) {
    ...
    public boolean isValid(String value) {
        ...
        if (!this.isValidPath(uri.getRawPath())) {
            return false;
        }
        if (!this.isValidQuery(uri.getRawQuery())) {
            return false;
        }
    ...
    protected boolean isValidAuthority(String authority) {
        ...
        if (ipv6 != null) {
            ...
            if (!this.domainValidator.isValid(hostLocation) && !(inetAddressValidator = InetAddressValidator.getInstance()).isValidInet4Address(hostLocation)) {
                return false;
            }
