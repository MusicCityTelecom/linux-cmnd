...
implements Serializable {
    ...
    private DomainValidator(boolean allowLocal, List<Item> items) {
        this.allowLocal = allowLocal;
        Object[] ccMinus = countryCodeTLDsMinus;
        Object[] ccPlus = countryCodeTLDsPlus;
        Object[] genMinus = genericTLDsMinus;
        Object[] genPlus = genericTLDsPlus;
        Object[] localMinus = localTLDsMinus;
        Object[] localPlus = localTLDsPlus;
        for (Item item : items) {
            Object[] copy = new String[item.values.length];
    ...
    public boolean isValidGenericTld(String gTld) {
        ...
        return (DomainValidator.arrayContains(GENERIC_TLDS, key) || DomainValidator.arrayContains(this.mygenericTLDsPlus, key)) && !DomainValidator.arrayContains(this.mygenericTLDsMinus, key);
    }

    public boolean isValidCountryCodeTld(String ccTld) {
        String key = this.chompLeadingDot(DomainValidator.unicodeToASCII(ccTld).toLowerCase(Locale.ENGLISH));
        return (DomainValidator.arrayContains(COUNTRY_CODE_TLDS, key) || DomainValidator.arrayContains(this.mycountryCodeTLDsPlus, key)) && !DomainValidator.arrayContains(this.mycountryCodeTLDsMinus, key);
    }

    public boolean isValidLocalTld(String lTld) {
        String key = this.chompLeadingDot(DomainValidator.unicodeToASCII(lTld).toLowerCase(Locale.ENGLISH));
        return (DomainValidator.arrayContains(LOCAL_TLDS, key) || DomainValidator.arrayContains(this.mylocalTLDsPlus, key)) && !DomainValidator.arrayContains(this.mylocalTLDsMinus, key);
    }
    ...
    public static synchronized void updateTLDOverride(ArrayType table, String[] tlds) {
        ...
        switch (table) {
            ...
            default: {
                throw new IllegalArgumentException(UNEXPECTED_ENUM_VALUE + (Object)((Object)table));
            }
        }
    }
