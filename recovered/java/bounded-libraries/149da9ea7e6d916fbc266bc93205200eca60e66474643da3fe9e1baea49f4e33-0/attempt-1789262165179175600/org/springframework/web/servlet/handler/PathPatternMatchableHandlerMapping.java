...
implements MatchableHandlerMapping {
    ...
    public PathPatternMatchableHandlerMapping(MatchableHandlerMapping delegate) {
        Assert.notNull((Object)delegate, (String)"Delegate MatchableHandlerMapping is required.");
        Assert.notNull((Object)delegate.getPatternParser(), (String)"PatternParser is required.");
