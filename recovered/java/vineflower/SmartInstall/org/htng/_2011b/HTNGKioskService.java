...
public class HTNGKioskService extends Service {
   public static final URL WSDL_LOCATION;
   public static final QName SERVICE = new QName("http://htng.org/2011B", "HTNG_KioskService");
   public static final QName FolioManagement = new QName("http://htng.org/2011B", "FolioManagement");
   ...
   static {
      ...
      if (url == null) {
         Logger.getLogger(HTNGKioskService.class.getName())
            .log(Level.INFO, "Can not initialize the default wsdl from {0}", "classpath:HTNG/services/HTNG_KioskService.wsdl");
      }
