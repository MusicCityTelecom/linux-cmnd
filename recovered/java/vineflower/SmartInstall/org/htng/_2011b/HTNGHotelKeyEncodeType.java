...
public class HTNGHotelKeyEncodeType {
   ...
   protected HTNGHotelKeyEncodeType.AccessAreas accessAreas;
   ...
   public HTNGHotelKeyEncodeType.AccessAreas getAccessAreas() {
      return this.accessAreas;
   }

   public void setAccessAreas(HTNGHotelKeyEncodeType.AccessAreas value) {
