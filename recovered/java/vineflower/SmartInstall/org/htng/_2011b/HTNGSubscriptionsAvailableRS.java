...
public class HTNGSubscriptionsAvailableRS {
   ...
   protected HTNGSubscriptionsAvailableRS.AvailableEventTypes availableEventTypes;
   ...
   public HTNGSubscriptionsAvailableRS.AvailableEventTypes getAvailableEventTypes() {
      return this.availableEventTypes;
   }

   public void setAvailableEventTypes(HTNGSubscriptionsAvailableRS.AvailableEventTypes value) {
   ...
   public static class AvailableEventTypes {
      ...
      protected List<HTNGSubscriptionsAvailableRS.AvailableEventTypes.AvailableEventType> availableEventType;

      public List<HTNGSubscriptionsAvailableRS.AvailableEventTypes.AvailableEventType> getAvailableEventType() {
         if (this.availableEventType == null) {
            this.availableEventType = new ArrayList<>();
         }
