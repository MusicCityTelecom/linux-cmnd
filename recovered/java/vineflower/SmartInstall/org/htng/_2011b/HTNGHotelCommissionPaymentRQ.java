...
public class HTNGHotelCommissionPaymentRQ {
   ...
   protected HTNGHotelCommissionPaymentRQ.CommissionRecipients commissionRecipients;
   ...
   public HTNGHotelCommissionPaymentRQ.CommissionRecipients getCommissionRecipients() {
      return this.commissionRecipients;
   }

   public void setCommissionRecipients(HTNGHotelCommissionPaymentRQ.CommissionRecipients value) {
   ...
   public static class CommissionRecipients {
      ...
      protected List<HTNGHotelCommissionPaymentRQ.CommissionRecipients.CommissionRecipient> commissionRecipient;

      public List<HTNGHotelCommissionPaymentRQ.CommissionRecipients.CommissionRecipient> getCommissionRecipient() {
         if (this.commissionRecipient == null) {
            this.commissionRecipient = new ArrayList<>();
         }
      ...
      public static class CommissionRecipient {
         ...
         protected HTNGHotelCommissionPaymentRQ.CommissionRecipients.CommissionRecipient.CommissionableReservations commissionableReservations;
         ...
         public HTNGHotelCommissionPaymentRQ.CommissionRecipients.CommissionRecipient.CommissionableReservations getCommissionableReservations() {
            return this.commissionableReservations;
         }

         public void setCommissionableReservations(HTNGHotelCommissionPaymentRQ.CommissionRecipients.CommissionRecipient.CommissionableReservations value) {
         ...
         public static class CommissionableReservations {
            ...
            protected HTNGHotelCommissionPaymentRQ.CommissionRecipients.CommissionRecipient.CommissionableReservations.CommissionableReservation commissionableReservation;

            public HTNGHotelCommissionPaymentRQ.CommissionRecipients.CommissionRecipient.CommissionableReservations.CommissionableReservation getCommissionableReservation() {
               return this.commissionableReservation;
            }

            public void setCommissionableReservation(
               HTNGHotelCommissionPaymentRQ.CommissionRecipients.CommissionRecipient.CommissionableReservations.CommissionableReservation value
            ) {
            ...
            public static class CommissionableReservation extends HotelReservationType {
