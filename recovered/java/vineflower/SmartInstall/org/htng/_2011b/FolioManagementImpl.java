...
@WebService(
   serviceName = "HTNG_KioskService",
   portName = "FolioManagement",
   targetNamespace = "http://htng.org/2011B",
   wsdlLocation = "classpath:/HTNG/services/HTNG_KioskService.wsdl",
   endpointInterface = "org.htng._2011b.FolioManagement"
)
public class FolioManagementImpl implements FolioManagement {
   ...
   public HTNGHotelFolioRS retrieveFolio(HTNGHotelFolioRQ htngHotelFolioRQ) {
      ...
      try {
         ...
         List<HTNGHotelFolioRS.Folios.Folio> _returnFoliosFolio = new ArrayList<>();
