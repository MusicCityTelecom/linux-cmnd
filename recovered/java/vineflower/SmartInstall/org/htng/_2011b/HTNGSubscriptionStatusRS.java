...
public class HTNGSubscriptionStatusRS {
   ...
   protected HTNGSubscriptionStatusRS.Subscriptions subscriptions;
   ...
   public HTNGSubscriptionStatusRS.Subscriptions getSubscriptions() {
      return this.subscriptions;
   }

   public void setSubscriptions(HTNGSubscriptionStatusRS.Subscriptions value) {
   ...
   public static class Subscriptions {
      ...
      protected List<HTNGSubscriptionStatusRS.Subscriptions.Subscription> subscription;

      public List<HTNGSubscriptionStatusRS.Subscriptions.Subscription> getSubscription() {
