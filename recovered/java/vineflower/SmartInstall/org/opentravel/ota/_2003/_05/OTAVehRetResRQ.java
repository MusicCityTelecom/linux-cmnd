...
@XmlType(name = "", propOrder = {"pos", "vehRetResRQCore", "vehRetResRQInfo"})
...
public class OTAVehRetResRQ {
   ...
   @XmlAccessorType(XmlAccessType.FIELD)
   @XmlType(name = "")
   public static class VehRetResRQCore extends VehicleRetrieveResRQCoreType {
   ...
   @XmlAccessorType(XmlAccessType.FIELD)
   @XmlType(name = "")
   public static class VehRetResRQInfo extends VehicleRetrieveResRQAdditionalInfoType {
   }
}
