...
@XmlType(
   name = "HotelDescriptiveContentType",
   propOrder = {
...
@XmlSeeAlso(OTANotifReportRQ.NotifDetails.HotelNotifReport.HotelDescriptiveContents.HotelDescriptiveContent.class)
   ...
   public static class EffectivePeriods {
      ...
      public List<HotelDescriptiveContentType.EffectivePeriods.EffectivePeriod> getEffectivePeriod() {
         if (this.effectivePeriod == null) {
            this.effectivePeriod = new ArrayList<>();
         }
