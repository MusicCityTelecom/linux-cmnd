...
@XmlType(
   name = "BasicPropertyInfoType",
   propOrder = {"vendorMessages", "position", "address", "contactNumbers", "award", "relativePosition", "hotelAmenity", "recreation", "service", "policy"}
)
@XmlSeeAlso(PropertyValueMatchType.class)
