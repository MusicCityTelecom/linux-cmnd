...
@XmlType(
   name = "HotelReservationType",
   propOrder = {"pos", "uniqueID", "roomStays", "services", "billingInstructionCode", "resGuests", "resGlobalInfo", "writtenConfInst", "queue", "tpaExtensions"}
)
@XmlSeeAlso(
   {
         HotelReservationsType.HotelReservation.class,
         HTNGHotelCommissionPaymentRQ.CommissionRecipients.CommissionRecipient.CommissionableReservations.CommissionableReservation.class,
         OTANotifReportRQ.NotifDetails.HotelNotifReport.HotelReservations.HotelReservation.class,
...
public class HotelReservationType {
   ...
   public List<HotelReservationType.BillingInstructionCode> getBillingInstructionCode() {
      if (this.billingInstructionCode == null) {
         this.billingInstructionCode = new ArrayList<>();
      }
