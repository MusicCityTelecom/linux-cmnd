...
@WebServlet("/remote")
public class RemoteControlServlet extends BaseHttpServlet {
      ...
      try {
         ...
         switch (settingType) {
            ...
            case ApplicationList:
               resp = this.successStatus(helper.getValueList(RemoteControlServlet.RemoteControlType.ApplicationList.name()));
               break;
            case ChannelList:
