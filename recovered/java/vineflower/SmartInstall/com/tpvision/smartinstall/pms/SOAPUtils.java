...
public class SOAPUtils {
   ...
   private static String getRequestMessage(SOAPUtils.SOAPAction soapAction, String msg) {
      String msgTpl = "<%s xmlns=\"http://tigergenericinterface.org/\"><XMLString>%s</XMLString></%s>";
      String requestMsg = String.format(Locale.ENGLISH, msgTpl, soapAction.name(), escape(msg), soapAction.name());
      return String.format(
         Locale.ENGLISH,
         "<?xml version=\"1.0\" encoding=\"utf-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\">    <soap:Body>%s    </soap:Body></soap:Envelope>",
         requestMsg
      );
   }

   public static String getResponseMessage(String msg) {
      String responseMsg = "<SendMessageToExternalInterfaceResponse xmlns=\"http://tigergenericinterface.org/\"><SendMessageToExternalInterfaceResult>"
         + msg
         + "</SendMessageToExternalInterfaceResult></SendMessageToExternalInterfaceResponse>";
      return String.format(
         Locale.ENGLISH,
         "<?xml version=\"1.0\" encoding=\"utf-8\"?><soap:Envelope xmlns:soap=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\">    <soap:Body>%s    </soap:Body></soap:Envelope>",
         responseMsg
   ...
   public String requestBillMsg(String roomId) {
      ...
      return getRequestMessage(SOAPUtils.SOAPAction.requestBill, msg);
   }
   ...
   public String requestRefreshMsg(String roomId) {
      ...
      String msg = String.format(Locale.ENGLISH, msgTpl, this.site, roomId, this.key);
      return getRequestMessage(SOAPUtils.SOAPAction.requestRefresh, msg);
   }
   ...
   public String requestCheckoutMsg(String roomId, String balance) {
      ...
      return getRequestMessage(SOAPUtils.SOAPAction.requestCheckout, msg);
   }
   ...
   public String requestDeleteMessage(String roomId, String msgId) {
      ...
      return getRequestMessage(SOAPUtils.SOAPAction.deleteMessageText, msg);
   }
   ...
   public String responseWakeupStatus(String roomId, String resno, String date, String time, String status) {
      ...
      return getRequestMessage(SOAPUtils.SOAPAction.wakeupStatus, msg);
   }
