...
public enum ApiErrorCode {
   ...
   SERVER_API_NOT_COMPATIBLE_WITH_CLINET_API_VERSION(
      -8, "server api version incompatible with the request api version, please upgrade your client", HttpStatus.NOT_ACCEPTABLE
   ),
   ...
   ApiErrorCode(int code, String msg, HttpStatus status) {
      this.code = code;
      this.msg = msg;
      this.status = status;
   }
   ...
   public static class JsonConverter extends AbstractHttpMessageConverter<ApiErrorCode> {
