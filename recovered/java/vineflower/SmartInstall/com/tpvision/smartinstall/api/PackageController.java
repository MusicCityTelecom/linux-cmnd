...
public class PackageController {
   @GetMapping("/packages")
   public Object query(
      @RequestParam(value = "package_type", defaultValue = "") String packageType, @RequestParam(value = "platform", defaultValue = "") String platform
   ) {
      ...
      if (isAllPackageType || StringUtils.equalsIgnoreCase("Firmware", packageType)) {
         for (UpgSetting upgSetting : JpaManager.getUpgSettingManager().loadAll()) {
            ...
            if (isAllPlatforms || StringUtils.equalsIgnoreCase(upgPlatform, platform)) {
      ...
      if (isAllPackageType || StringUtils.equalsIgnoreCase("Clone", packageType)) {
         for (Setting setting : JpaManager.getSettingManager().loadAll()) {
            ...
            if (isAllPlatforms || StringUtils.equalsIgnoreCase(settingPlatform, platform)) {
               JSONObject obj = this.makeCloneItemObject(
                  setting.getId(), setting.getClonerename(), "Clone", TpvDateUtils.getIdentifierFormatTime(setting.getLastUpdatedDate()), settingPlatform
               );
               result.put(obj);
            }
         }
      ...
      if (isAllPackageType || StringUtils.equalsIgnoreCase("Settings", packageType)) {
         for (SettingPackage settingPackage : JpaManager.getSettingPackageManager().loadAll()) {
            ...
            if (isAllPlatforms || StringUtils.equalsIgnoreCase(settingPackagePlatform, platform)) {
               result.put(
                  this.makeCloneItemObject(settingPackage.getId(), settingPackage.getName(), "Settings", settingPackage.getLastEdit(), settingPackagePlatform)
               );
            }
         }
      }
      ...
      if (isAllPackageType || StringUtils.equalsIgnoreCase("Channels", packageType)) {
         for (ChannelPackage channelPackage : JpaManager.getChannelPackageManager().loadAll()) {
            ...
            if (isAllPlatforms || StringUtils.equalsIgnoreCase(channelPackagePlatform, platform)) {
               result.put(
                  this.makeCloneItemObject(channelPackage.getId(), channelPackage.getName(), "Channels", channelPackage.getLastEdit(), channelPackagePlatform)
               );
            }
         }
      }
      ...
      if (isAllPackageType || StringUtils.equalsIgnoreCase("Welcome", packageType)) {
         for (Welcome welcome : JpaManager.getWelcomeManager().loadAll()) {
            ...
            if (isAllPlatforms || StringUtils.equalsIgnoreCase(welcomePlatform, platform)) {
      ...
      if (isAllPackageType || StringUtils.equalsIgnoreCase("Apps", packageType)) {
         for (AppPackage app : JpaManager.getAppPackageManager().loadAll()) {
            ...
            if (isAllPlatforms || StringUtils.equalsIgnoreCase(appPlatform, platform)) {
      ...
      if (isAllPackageType || StringUtils.equalsIgnoreCase("Content", packageType)) {
         ...
         if (!isAllPlatforms) {
            isSupportQuery = PlatformUtils.getSupportCloneItems(PlatformUtils.convertToFullPlatformData(platform))
               .contains(CommonConstants.CloneItemType.SmartInfoBrowser);
         }
      ...
      if (isAllPackageType || StringUtils.equalsIgnoreCase("Banners", packageType)) {
         ...
         if (!isAllPlatforms) {
            isSupportQuery = PlatformUtils.getSupportCloneItems(PlatformUtils.convertToFullPlatformData(platform))
               .contains(CommonConstants.CloneItemType.Banner);
         }
      ...
      if (isAllPackageType || StringUtils.equalsIgnoreCase("UI", packageType)) {
         for (UiCustomizations uiCustomizations : JpaManager.getUiCustomizationsManager().loadAll()) {
            ...
            if (isAllPlatforms || StringUtils.equalsIgnoreCase(uiCustomizationsPlatform, platform)) {
               result.put(
                  this.makeCloneItemObject(uiCustomizations.getId(), uiCustomizations.getName(), "UI", uiCustomizations.getLastEdit(), uiCustomizationsPlatform)
               );
            }
         }
      }
      ...
      if (isAllPackageType || StringUtils.equalsIgnoreCase("Schedules", packageType)) {
         for (Schedule schedule : JpaManager.getScheduleManager().loadAll()) {
            ...
            if (isAllPlatforms || StringUtils.equalsIgnoreCase(schedulePlatform, platform)) {
