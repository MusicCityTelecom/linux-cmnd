...
public class UploadException extends Exception {
   ...
   private final UploadException.ExceptionType type;

   public UploadException(UploadException.ExceptionType type) {
      this.type = type;
   }
   ...
   public enum ExceptionType {
      ...
      MultiplePfInZipFile(
         "Multiple platforms detected in the Zip file: Please upload only one Platform at a time and make sure folder in zip file is named exactly as the TV has output. Note! If you are uploading files for a 2013 MediaSuite (xxHFL5008) or Signature (xxHFL7x08) from a SmartInstall server please use the Q554B-2K13PSMS and rename it to Q554B folder."
      ),
