...
public class UIJsonHelper {
   ...
   private static final Map<String, Map<String, String>> platformFieldMap = new HashMap<>();
   public Map<String, String> settingValueMap = new HashMap<>();

   public UIJsonHelper(JSONObject uijson, String platform) {
      this.uijson = uijson != null ? uijson : new JSONObject();
   ...
   public boolean getFieldStatus(String fieldName) {
      ...
      if (value == null) {
         ...
         return "BackgroundAudio".equalsIgnoreCase(fieldName) ? value.equalsIgnoreCase("Custom") : value.equalsIgnoreCase(this.switchFlagOn);
      }
   }
   ...
   static {
      Map<String, String> platformGeneralFields = new HashMap<>();
      ...
      Map<String, String> platformTPM242HWWFields = new HashMap<>(platformGeneralFields);
