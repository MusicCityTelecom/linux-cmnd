...
public class ResponsePlayInfo {
   ...
   public ResponsePlayInfo.ServiceData data;
   ...
   public static class ServiceData {
      public ResponsePlayInfo.Services services;
   }

   public static class Services {
      List<ResponsePlayInfo.AVService> AVServices;
      List<ResponsePlayInfo.DataService> dataServices;
   }
}
