...
public class AjaxSessionTimeoutRedirectFilter extends GenericFilterBean {
   ...
   public AjaxSessionTimeoutRedirectFilter() {
      this.throwableAnalyzer = new AjaxSessionTimeoutRedirectFilter.DefaultThrowableAnalyzer();
      this.authenticationTrustResolver = new AuthenticationTrustResolverImpl();
   }

   @Override
   public void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse, final FilterChain filterChain) throws IOException, ServletException {
      Assert.notNull(servletRequest, DoFilterMessages.SERVLET_REQUEST_CAN_NOT_BE_NULL);
      Assert.notNull(servletResponse, DoFilterMessages.SERVLET_RESPONSE_CAN_NOT_BE_NULL);
      Assert.notNull(filterChain, DoFilterMessages.FILTER_CHAIN_CAN_NOT_BE_NULL);
      ...
      try {
         ...
         if (runtimeException != null) {
            ...
            if (runtimeException instanceof AccessDeniedException) {
               ...
               logger.debug("Ajax call detected, sending {} error code.", this.sessionExpiredErrorCode);
   ...
   public void setSessionExpiredErrorCode(final int sessionExpiredErrorCode) {
