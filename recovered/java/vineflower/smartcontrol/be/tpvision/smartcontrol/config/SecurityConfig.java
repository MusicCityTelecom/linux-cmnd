...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
   ...
   @Value("${cas.proxy.receptor-url}")
   private String casProxyReceptorUrl;
   @Value("${cas.proxy.callback-url}")
   ...
   protected void configure(final HttpSecurity httpSecurity) throws Exception {
      ((HttpSecurity)httpSecurity.exceptionHandling()
            ...
            .addFilterAfter(this.casHttpsRequestSupportFilter(), SecurityContextPersistenceFilter.class)
            .addFilterAfter(this.ajaxTimeoutRedirectFilter(), ExceptionTranslationFilter.class)
            .authorizeRequests()
            .anyRequest()
            .authenticated()
            .and())
