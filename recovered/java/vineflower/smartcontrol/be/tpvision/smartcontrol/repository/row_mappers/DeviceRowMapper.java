...
public class DeviceRowMapper implements RowMapper<DeviceDTO> {
   ...
   @Autowired
   public DeviceRowMapper(final AttributeConverter<InetSocketAddress, String> inetSocketAddressConverter) {
   ...
   public DeviceDTO mapRow(final ResultSet resultSet, final int rowNumber) throws SQLException {
      Assert.notNull(resultSet, MapRowMessages.RESULT_SET_CAN_NOT_BE_NULL);
      DeviceDTO deviceDTO = new DeviceDTO();
      long id = resultSet.getLong("id");
      deviceDTO.setId(id);
      String inetSocketAddressString = resultSet.getString("address");
      ...
      String serialCodeString = resultSet.getString("serial_code");
      StringWrapper serialCode = StringWrapperMapper.toStringWrapper(serialCodeString);
      deviceDTO.setSerialCode(serialCode);
      boolean ftpUseDefault = resultSet.getBoolean("ftp_settings_use_default");
      Object ftpPortObject = resultSet.getObject("ftp_settings_port");
      ...
      String ftpUsername = resultSet.getString("ftp_settings_username");
      String ftpPassword = resultSet.getString("ftp_settings_password");
