...
public class ContentRepositoryImpl extends AbstractRepository<String, Content> implements ContentRepository {
   public ContentRepositoryImpl() {
      super(Content.class);
   }

   @Override
   public SingularAttribute<? super Content, ?> getSingularAttribute(final OrderField<? super Content> orderField) {
