...
public class MainboardOriginPositionCodec extends Codec<MainboardOriginPosition> {
   ...
   public byte[] toProtocol(final MainboardOriginPosition mainboardOriginPosition) {
      Assert.notNull(mainboardOriginPosition, ToProtocolMessages.MAINBOARD_ORIGIN_POSITION_CAN_NOT_BE_NULL);
   ...
   public MainboardOriginPosition toDomain(final byte[] bytes) {
