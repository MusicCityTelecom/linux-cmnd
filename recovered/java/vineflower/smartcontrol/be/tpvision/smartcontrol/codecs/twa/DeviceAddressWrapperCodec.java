...
public class DeviceAddressWrapperCodec extends Codec<DeviceAddressWrapper> {
   ...
   public byte[] toProtocol(final DeviceAddressWrapper deviceAddressWrapper) {
      Assert.notNull(deviceAddressWrapper, ToProtocolMessages.DEVICE_ADDRESS_WRAPPER_CAN_NOT_BE_NULL);
   ...
   public DeviceAddressWrapper toDomain(final byte[] bytes) {
