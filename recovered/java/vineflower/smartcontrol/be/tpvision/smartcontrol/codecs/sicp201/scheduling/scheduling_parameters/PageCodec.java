...
public class PageCodec extends Codec<Page> {
   ...
   private static final Map<InputSource.Tag, Byte> domainTags = InputSourceCodec.getDomainTags();
   private static final Map<Byte, InputSource.Tag> protocolTags = InputSourceCodec.getProtocolTags();
