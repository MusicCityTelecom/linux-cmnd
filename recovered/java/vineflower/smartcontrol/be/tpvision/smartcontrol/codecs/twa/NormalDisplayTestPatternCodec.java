...
public class NormalDisplayTestPatternCodec extends SingleValueCodec<NormalDisplayTestPattern> {
   ...
   private NormalDisplayTestPatternCodec() {
      ...
      Map<NormalDisplayTestPattern, Byte> domainNormalDisplayTestPattern = super.getDeviceSettings();
   ...
   public NormalDisplayTestPattern toDomain(final byte[] bytes) {
