...
public class SetNormalDisplayTestPatternMessages {
   ...
   public static final String VIEW_MODEL_NORMAL_DISPLAY_TEST_PATTERN_CAN_NOT_BE_EMPTY = Messages.getCanNotBeEmptyMessage(
      "View model normal display / test pattern"
   );
