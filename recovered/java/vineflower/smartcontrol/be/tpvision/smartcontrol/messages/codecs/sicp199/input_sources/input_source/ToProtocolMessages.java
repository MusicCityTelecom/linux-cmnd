package be.tpvision.smartcontrol.messages.codecs.sicp199.input_sources.input_source;

import be.tpvision.smartcontrol.messages.Messages;

public class ToProtocolMessages {
   public static final String INPUT_SOURCE_CAN_NOT_BE_NULL_MESSAGE = Messages.getCanNotBeNullMessage("Input source");
