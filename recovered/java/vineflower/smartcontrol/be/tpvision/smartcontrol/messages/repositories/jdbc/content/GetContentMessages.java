...
public class GetContentMessages {
   public static final String CONTENT_ROW_MAPPER_CAN_NOT_BE_NULL = Messages.getCanNotBeNullMessage("Content row mapper");
