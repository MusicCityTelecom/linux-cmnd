package be.tpvision.smartcontrol.messages.repositories.hardware;
...
public class GetSingularAttributeMessages {
   ...
   public static String getOrderFieldIsNotSupportedMessage(final OrderField<Hardware> orderField) {
