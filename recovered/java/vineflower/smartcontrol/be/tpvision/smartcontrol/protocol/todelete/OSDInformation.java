...
public class OSDInformation implements Convertible {
   public static final int MINIMUM_VALUE = 0;
   public static final int MAXIMUM_VALUE = 60;
   private int osdInformation;

   public OSDInformation(final int osdInformation) {
   ...
   public void setOsdInformation(final int osdInformation) {
