...
public class SettingsController {
   ...
   public SettingsController(final SettingsService settingsService) {
      Assert.notNull(settingsService, ConstructorMessages.SETTINGS_SERVICE_CAN_NOT_BE_NULL);
   ...
   public ResponseWrapper<String> getServerIp() {
      ...
      return new ResponseWrapper<>(serverIp);
   }

   @PutMapping("/serverIp/{serverIp}")
   public void setServerIp(@PathVariable("serverIp") final String serverIp) {
      Assert.state(this.settingsService != null, SetServerIpMessages.SETTINGS_SERVICE_CAN_NOT_BE_NULL);
      Assert.notNull(serverIp, SetServerIpMessages.SERVER_IP_CAN_NOT_BE_NULL);
   ...
   @GetMapping("/defaultFtpSettings/port")
   public ResponseWrapper<Integer> getDefaultFtpSettingsPort() {
      ...
      return new ResponseWrapper<>(port);
   }

   @PutMapping("/defaultFtpSettings/port/{port}")
   public void setDefaultFtpSettingsPort(@PathVariable("port") final int port) {
   ...
   @GetMapping("/defaultFtpSettings/username")
   ...
   @PutMapping("/defaultFtpSettings/username/{username}")
   public void setDefaultFtpSettingsUsername(@PathVariable("username") final String username) {
      Assert.state(this.settingsService != null, SetDefaultFtpSettingsUsernameMessages.SETTINGS_SERVICE_CAN_NOT_BE_NULL);
      Assert.notNull(username, SetDefaultFtpSettingsUsernameMessages.USERNAME_CAN_NOT_BE_NULL);
      Settings settings = this.settingsService.getSettings();
   ...
   @PutMapping("/defaultFtpSettings/password")
   public void setDefaultFtpSettingsPassword(@RequestBody final DefaultFtpSettingsPasswordViewModel defaultFtpSettingsPasswordViewModel) {
      Assert.state(this.settingsService != null, SetDefaultFtpSettingsPasswordMessages.SETTINGS_SERVICE_CAN_NOT_BE_NULL);
      Assert.notNull(defaultFtpSettingsPasswordViewModel, SetDefaultFtpSettingsPasswordMessages.DEFAULT_FTP_SETTINGS_PASSWORD_VIEW_MODEL);
   ...
   @GetMapping("/detectDevicesTimeoutInMilliseconds")
   public ResponseWrapper<Integer> getDetectDevicesTimeoutInMilliseconds() {
      ...
      return new ResponseWrapper<>(detectDevicesTimeoutInMilliseconds);
   }

   @PutMapping("/detectDevicesTimeoutInMilliseconds/{detectDevicesTimeoutInMilliseconds}")
   public void setDetectDevicesTimeoutInMilliseconds(@PathVariable("detectDevicesTimeoutInMilliseconds") int detectDevicesTimeoutInMilliseconds) {
