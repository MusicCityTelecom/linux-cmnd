...
public class MainboardOriginPositionMapper {
   ...
   public static MainboardOriginPosition toMainboardOriginPosition(final MainboardOriginPositionViewModel mainboardOriginPositionViewModel) {
      Assert.notNull(mainboardOriginPositionViewModel, ToMainboardOriginPositionMessages.MAINBOARD_ORIGIN_POSITION_VIEW_MODEL_CAN_NOT_BE_NULL);
