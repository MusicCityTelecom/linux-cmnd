...
public class VGAVideoParametersMapper {
   ...
   public static VGAVideoParametersViewModel toVGAVideoParametersViewModel(final VGAVideoParameters vgaVideoParameters) {
      Assert.notNull(vgaVideoParameters, ToVgaVideoParametersViewModelMessages.VGA_VIDEO_PARAMETERS_CAN_NOT_BE_NULL);
   ...
   public static VGAVideoParameters toVGAVideoParameters(final VGAVideoParametersViewModel vgaVideoParametersViewModel) {
      Assert.notNull(vgaVideoParametersViewModel, ToVgaVideoParametersMessages.VGA_VIDEO_PARAMETERS_VIEW_MODEL_CAN_NOT_BE_NULL);
