...
public class ContentController {
   ...
   @Autowired
   public ContentController(final ContentService contentService, final ContentManagementService contentManagementService) {
      Assert.notNull(contentService, ConstructorMessages.CONTENT_SERVICE_CAN_NOT_BE_NULL);
      Assert.notNull(contentManagementService, ConstructorMessages.CONTENT_MANAGEMENT_SERVICE_CAN_NOT_BE_NULL);
