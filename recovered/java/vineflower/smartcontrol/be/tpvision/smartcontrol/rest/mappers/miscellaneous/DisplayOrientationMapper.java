...
public class DisplayOrientationMapper {
   ...
   public static DisplayOrientationViewModel toDisplayOrientationViewModel(final DisplayOrientation displayOrientation) {
      Assert.notNull(displayOrientation, ToDisplayOrientationViewModelMessages.DISPLAY_ORIENTATION_CAN_NOT_BE_NULL);
      DisplayOrientation.AutoRotate domainAutoRotate = displayOrientation.getAutoRotate();
      String viewModelAutoRotate = String.valueOf(domainAutoRotate);
      DisplayOrientation.OsdRotation domainOsdRotation = displayOrientation.getOsdRotation();
      String viewModelOsdRotation = String.valueOf(domainOsdRotation);
      DisplayOrientation.ImageAll domainImageAll = displayOrientation.getImageAll();
      String viewModelImageAll = String.valueOf(domainImageAll);
      DisplayOrientation.DisplayWindow1 domainDisplayWindow1 = displayOrientation.getDisplayWindow1();
      String viewModelDisplayWindow1 = String.valueOf(domainDisplayWindow1);
      DisplayOrientation.DisplayWindow2 domainDisplayWindow2 = displayOrientation.getDisplayWindow2();
      String viewModelDisplayWindow2 = String.valueOf(domainDisplayWindow2);
      DisplayOrientation.DisplayWindow3 domainDisplayWindow3 = displayOrientation.getDisplayWindow3();
      String viewModelDisplayWindow3 = String.valueOf(domainDisplayWindow3);
      DisplayOrientation.DisplayWindow4 domainDisplayWindow4 = displayOrientation.getDisplayWindow4();
      String viewModelDisplayWindow4 = String.valueOf(domainDisplayWindow4);
      return new DisplayOrientationViewModel(
         viewModelAutoRotate,
         viewModelOsdRotation,
         viewModelImageAll,
         viewModelDisplayWindow1,
         viewModelDisplayWindow2,
         viewModelDisplayWindow3,
         viewModelDisplayWindow4
      );
   }

   public static DisplayOrientation toDisplayOrientation(final DisplayOrientationViewModel displayOrientationViewModel) {
      Assert.notNull(displayOrientationViewModel, ToDisplayOrientationMessages.DISPLAY_ORIENTATION_VIEW_MODEL_CAN_NOT_BE_NULL);
