...
public class GroupResultMapper {
   ...
   public static ImportGroupResultViewModel toImportGroupResultViewModel(final AddGroupResult addGroupResult) {
      Assert.notNull(addGroupResult, ToImportGroupResultViewModelMessages.ADD_GROUP_RESULT_CAN_NOT_BE_NULL);
      ...
      ImportDeviceResultViewModelList importDeviceResultViewModelList = addGroupResult.getAddDeviceResults()
         .stream()
         .map(DeviceResultMapper::toImportDeviceResultViewModel)
