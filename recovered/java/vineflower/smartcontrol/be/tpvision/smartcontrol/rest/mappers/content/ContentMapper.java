...
public class ContentMapper {
   ...
   public static ContentViewModel toContentViewModel(final Content content) {
      Assert.notNull(content, ToContentViewModelMessages.CONTENT_CAN_NOT_BE_NULL);
   ...
   public static Content toContent(final ContentViewModel contentViewModel) {
      Assert.notNull(contentViewModel, ToContentMessages.CONTENT_VIEW_MODEL_CAN_NOT_BE_NULL);
   ...
   public static List<ContentViewModel> toContentViewModelList(final Collection<Content> contentCollection) {
      ...
      return contentCollection.stream()
         ...
         .map(ContentMapper::toContentViewModel)
         .filter(Objects::nonNull)
         .collect(Collectors.toCollection(ArrayList::new));
   }

   public static List<Content> toContentList(final Collection<ContentViewModel> contentViewModelCollection) {
