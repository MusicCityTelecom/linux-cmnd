...
public class DeviceAddressMapper {
   ...
   public static DeviceAddress toDeviceAddress(final DeviceAddressViewModel deviceAddressViewModel) {
      Assert.notNull(deviceAddressViewModel, ToDeviceAddressMessages.DEVICE_ADDRESS_VIEW_MODEL_CAN_NOT_BE_NULL);
