...
public class UserManagementSavedRequestAwareAuthenticationSuccessHandler
extends SimpleUrlAuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws ServletException, IOException {
        ...
        if (this.contextPath != null && (lastPart = targetUrl.substring(lastSlashIndex = targetUrl.lastIndexOf("/"), targetUrlLength = targetUrl.length())).equals(this.contextPath)) {
            targetUrl = targetUrl + "/";
        }
