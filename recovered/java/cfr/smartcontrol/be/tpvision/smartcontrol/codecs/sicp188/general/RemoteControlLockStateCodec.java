...
public class RemoteControlLockStateCodec
extends SingleValueCodec<RemoteControlLockState> {
    ...
    protected void initializeDeviceSettings() {
        EnumMap<RemoteControlLockState, Byte> domainRemoteControlLockState = new EnumMap<RemoteControlLockState, Byte>(RemoteControlLockState.class);
