...
public class MainboardSignalOutputCodec
extends SingleValueCodec<MainboardSignalOutput> {
    ...
    private MainboardSignalOutputCodec() {
        ...
        Map domainMainboardSignalOutput = super.getDeviceSettings();
    ...
    @Override
    public MainboardSignalOutput toDomain(byte[] bytes) {
