...
public class MonitorRestartCodec
extends SingleValueCodec<MonitorSystem> {
    ...
    protected void initializeDeviceSettings() {
        EnumMap<MonitorSystem, Byte> domainMonitorSystem = new EnumMap<MonitorSystem, Byte>(MonitorSystem.class);
    ...
    protected void initializeProtocolSettings() {
        Map protocolMonitorSystem = Collections.emptyMap();
