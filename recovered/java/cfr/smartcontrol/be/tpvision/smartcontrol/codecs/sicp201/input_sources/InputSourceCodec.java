...
extends Codec<InputSource> {
    ...
    public byte[] toProtocol(InputSource inputSource) {
        ...
        if (this.isTagSourceType(domainSourceType)) {
            ...
            protocolTag = domainTag != null ? domainTags.get((Object)domainTag) : domainTags.get((Object)InputSource.Tag.TAG_ONE);
    ...
    private boolean isTagSourceType(InputSource.SourceType sourceType) {
        List<InputSource.SourceType> tagSourceTypesList = Arrays.asList(InputSource.SourceType.BROWSER, InputSource.SourceType.MEDIA_PLAYER, InputSource.SourceType.PDF_PLAYER);
    ...
    static {
        ...
        domainTags = new EnumMap<InputSource.Tag, Byte>(InputSource.Tag.class);
