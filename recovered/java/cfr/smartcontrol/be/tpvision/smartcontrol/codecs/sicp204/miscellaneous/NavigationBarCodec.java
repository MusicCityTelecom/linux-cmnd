...
public class NavigationBarCodec
extends SingleValueCodec<NavigationBar> {
    ...
    protected void initializeDeviceSettings() {
        EnumMap<NavigationBar, Byte> domainNavigationBar = new EnumMap<NavigationBar, Byte>(NavigationBar.class);
