...
public class BootOnSourceCodec
extends Codec<BootOnSource> {
    ...
    private static final Map<BootOnSource.VideoSourceType, Byte> domainVideoSourceTypes = new EnumMap<BootOnSource.VideoSourceType, Byte>(BootOnSource.VideoSourceType.class);
    private static final Map<Byte, BootOnSource.VideoSourceType> protocolVideoSourceTypes;
    ...
    private static final Map<BootOnSource.Tag, Byte> domainTags;
    private static final Map<Byte, BootOnSource.Tag> protocolTags;
    ...
    @Override
    public byte[] toProtocol(BootOnSource bootOnSource) {
        Assert.notNull((Object)bootOnSource, ToProtocolMessages.BOOT_ON_SOURCE_CAN_NOT_BE_NULL_MESSAGE);
        ...
        Byte protocolVideoSourceType = domainVideoSourceTypes.get((Object)videoSourceType);
        ...
        Byte protocolTag = domainTag != null ? domainTags.get((Object)domainTag) : domainTags.get((Object)BootOnSource.Tag.TAG_ZERO);
    ...
    @Override
    public BootOnSource toDomain(byte[] bytes) {
    ...
    static {
        ...
        protocolVideoSourceTypes = MapUtilities.inverse(domainVideoSourceTypes);
        domainTags = new EnumMap<BootOnSource.Tag, Byte>(BootOnSource.Tag.class);
        ...
        protocolTags = MapUtilities.inverse(domainTags);
    }
}
