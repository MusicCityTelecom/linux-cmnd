...
extends Codec<PictureInPictureSource> {
    ...
    public PictureInPictureSource toDomain(byte[] bytes) {
        ...
        Byte protocolInputSourceSourceTypeQ3 = protocolPictureInPictureSourceSourceType == pictureInPictureSourceSourceTypeInputSource ? Byte.valueOf(bytes[2]) : null;
        ...
        Byte protocolInputSourceSourceTypeQ4 = protocolPictureInPictureSourceSourceType == pictureInPictureSourceSourceTypeInputSource ? Byte.valueOf(bytes[3]) : null;
