...
public abstract class SingleValueCodec<D extends TwaDeviceSetting>
extends Codec<D> {
    private Map<D, Byte> deviceSettings = new HashMap<D, Byte>();
    private Map<Byte, D> protocolSettings = new HashMap<Byte, D>();
    ...
    @Override
    public byte[] toProtocol(D twaDeviceSetting) {
    ...
    public D toDomain(byte[] bytes) {
        ...
        TwaDeviceSetting deviceSetting = (TwaDeviceSetting)this.protocolSettings.get(protocolSetting);
