...
public class ModelNumberFirmwareVersionBuildDateInfoCodec
extends SingleValueCodec<ModelNumberFirmwareVersionBuildDateInfo> {
    ...
    protected void initializeDeviceSettings() {
        EnumMap<ModelNumberFirmwareVersionBuildDateInfo, Byte> domainInfo = new EnumMap<ModelNumberFirmwareVersionBuildDateInfo, Byte>(ModelNumberFirmwareVersionBuildDateInfo.class);
    ...
    protected void initializeProtocolSettings() {
        Map protocolInfo = Collections.emptyMap();
