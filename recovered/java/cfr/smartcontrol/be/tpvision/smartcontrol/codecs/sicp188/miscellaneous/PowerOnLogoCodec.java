...
public class PowerOnLogoCodec
extends SingleValueCodec<PowerOnLogo> {
    ...
    protected void initializeDeviceSettings() {
        EnumMap<PowerOnLogo, Byte> domainPowerOnLogo = new EnumMap<PowerOnLogo, Byte>(PowerOnLogo.class);
