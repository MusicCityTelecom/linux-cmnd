...
public class TestPatternColorCodec
extends SingleValueCodec<TestPatternColor> {
    ...
    private TestPatternColorCodec() {
        ...
        Map domainTestPatternColor = super.getDeviceSettings();
    ...
    @Override
    public TestPatternColor toDomain(byte[] bytes) {
