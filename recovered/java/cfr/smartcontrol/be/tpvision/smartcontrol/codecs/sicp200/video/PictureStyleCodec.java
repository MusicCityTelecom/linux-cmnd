...
public class PictureStyleCodec
extends SingleValueCodec<PictureStyle> {
    ...
    protected void initializeDeviceSettings() {
        EnumMap<PictureStyle, Byte> domainPictureStyles = new EnumMap<PictureStyle, Byte>(PictureStyle.class);
