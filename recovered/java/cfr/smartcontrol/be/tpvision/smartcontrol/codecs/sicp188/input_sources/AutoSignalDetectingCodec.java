...
public class AutoSignalDetectingCodec
extends SingleValueCodec<AutoSignalDetecting> {
    ...
    protected void initializeDeviceSettings() {
        EnumMap<AutoSignalDetecting, Byte> domainAutoSignalDetecting = new EnumMap<AutoSignalDetecting, Byte>(AutoSignalDetecting.class);
