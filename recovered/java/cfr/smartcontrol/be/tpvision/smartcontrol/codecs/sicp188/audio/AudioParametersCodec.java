...
public class AudioParametersCodec
extends Codec<AudioParameters> {
    ...
    public byte[] toProtocol(AudioParameters audioParameters) {
        Assert.notNull((Object)audioParameters, ToProtocolMessages.AUDIO_PARAMETERS_CAN_NOT_BE_NULL);
