...
public class KeypadLockStateCodec
extends SingleValueCodec<KeypadLockState> {
    ...
    protected void initializeDeviceSettings() {
        EnumMap<KeypadLockState, Byte> domainKeypadLockState = new EnumMap<KeypadLockState, Byte>(KeypadLockState.class);
