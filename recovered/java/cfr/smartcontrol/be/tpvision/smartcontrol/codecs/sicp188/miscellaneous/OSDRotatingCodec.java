...
public class OSDRotatingCodec
extends SingleValueCodec<OSDRotating> {
    ...
    protected void initializeDeviceSettings() {
        EnumMap<OSDRotating, Byte> domainOSDRotating = new EnumMap<OSDRotating, Byte>(OSDRotating.class);
