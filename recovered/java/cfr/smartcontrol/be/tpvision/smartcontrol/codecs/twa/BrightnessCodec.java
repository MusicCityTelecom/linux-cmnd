...
public class BrightnessCodec
extends Codec<Brightness> {
    ...
    @Override
    public byte[] toProtocol(Brightness brightness) {
        Assert.notNull((Object)brightness, ToProtocolMessages.BRIGHTNESS_CAN_NOT_BE_NULL);
    ...
    @Override
    public Brightness toDomain(byte[] bytes) {
