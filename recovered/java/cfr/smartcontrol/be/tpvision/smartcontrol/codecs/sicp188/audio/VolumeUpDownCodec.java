...
public class VolumeUpDownCodec
extends Codec<VolumeUpDown> {
    static final byte VOLUME_DOWN_BYTE = 0;
    static final byte VOLUME_UP_BYTE = 1;
    static final byte VOLUME_UNCHANGED_BYTE = -1;
    private static final Map<VolumeUpDown.Volume, Byte> domainVolume = new EnumMap<VolumeUpDown.Volume, Byte>(VolumeUpDown.Volume.class);
    ...
    public byte[] toProtocol(VolumeUpDown volumeUpDown) {
        Assert.notNull((Object)volumeUpDown, ToProtocolMessages.VOLUME_UP_DOWN_CAN_NOT_BE_NULL);
        VolumeUpDown.Volume domainSpeakerOut = volumeUpDown.getSpeakerOut();
        Byte protocolSpeakerOut = domainVolume.get((Object)domainSpeakerOut);
        ...
        Byte protocolAudioOut = domainVolume.get((Object)domainAudioOut);
