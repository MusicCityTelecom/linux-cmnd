...
public class TeamviewerStatusCodec
extends SingleValueCodec<TeamviewerStatus> {
    ...
    protected void initializeDeviceSettings() {
        EnumMap<TeamviewerStatus, Byte> domainTouch = new EnumMap<TeamviewerStatus, Byte>(TeamviewerStatus.class);
