...
public class VideoAlignmentCodec
extends Codec<VideoAlignment> {
    static final byte AUTO_ADJUST_BYTE = 64;
    static final byte RESERVED_BYTE = 0;
    private static final Map<VideoAlignment.Item, Byte> domainItems = new EnumMap<VideoAlignment.Item, Byte>(VideoAlignment.Item.class);
    private static final Map<Byte, VideoAlignment.Item> protocolItems;
    ...
    public byte[] toProtocol(VideoAlignment videoAlignment) {
        ...
        Byte protocolItem = domainItems.get((Object)domainItem);
    ...
    static {
        ...
        protocolItems = MapUtilities.inverse(domainItems);
    }
}
