...
public class ColorTemperatureCodec
extends SingleValueCodec<ColorTemperature> {
    ...
    protected void initializeDeviceSettings() {
        EnumMap<ColorTemperature, Byte> domainColorTemperatures = new EnumMap<ColorTemperature, Byte>(ColorTemperature.class);
