...
import be.tpvision.smartcontrol.util.FailedToUploadFileToFtpException;
...
public class UploadUtilities {
    ...
    public static void uploadFile(Path filePath, String ip, int port, String username, String password) {
        Assert.notNull((Object)filePath, UploadFileMessages.FILE_PATH_CAN_NOT_BE_NULL);
        Assert.notNull((Object)ip, UploadFileMessages.IP_CAN_NOT_BE_NULL);
        Assert.notNull((Object)port, UploadFileMessages.PORT_CAN_NOT_BE_NULL);
        Assert.notNull((Object)username, UploadFileMessages.USERNAME_CAN_NOT_BE_NULL);
        Assert.notNull((Object)password, UploadFileMessages.PASSWORD_CAN_NOT_BE_NULL);
