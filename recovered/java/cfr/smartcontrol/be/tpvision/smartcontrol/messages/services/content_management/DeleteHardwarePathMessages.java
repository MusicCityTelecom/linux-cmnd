...
public class DeleteHardwarePathMessages {
    ...
    public static final String HARDWARE_FILE_CAN_NOT_BE_NULL = Messages.getCanNotBeNullMessage("Hardware file");

    private DeleteHardwarePathMessages() {
    }
}
