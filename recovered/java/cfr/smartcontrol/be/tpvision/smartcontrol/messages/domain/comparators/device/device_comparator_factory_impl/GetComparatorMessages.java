...
public class GetComparatorMessages {
    ...
    public static String getNoComparatorsFoundForOrderFieldMessage(OrderField orderField) {
        String orderFieldCanNotBeNullMessage = Messages.getCanNotBeNullMessage("Order field");
        Assert.notNull((Object)orderField, orderFieldCanNotBeNullMessage);
        return String.format("No comparators found for order field %s.", orderField);
    }

    public static String getOrderDirectionIsNotSupportedMessage(OrderDirection orderDirection) {
        String orderDirectionCanNotBeNullMessage = Messages.getCanNotBeNullMessage("Order direction");
        Assert.notNull((Object)orderDirection, orderDirectionCanNotBeNullMessage);
        return String.format("Order direction %s is not supported.", new Object[]{orderDirection});
    }
}
