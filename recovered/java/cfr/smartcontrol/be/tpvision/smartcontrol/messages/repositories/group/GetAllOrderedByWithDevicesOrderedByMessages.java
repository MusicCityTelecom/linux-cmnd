 ...
 */
package be.tpvision.smartcontrol.messages.repositories.group;

import be.tpvision.smartcontrol.messages.Messages;

public class GetAllOrderedByWithDevicesOrderedByMessages {
    public static final String GROUP_ORDER_FIELD_CAN_NOT_BE_NULL = Messages.getCanNotBeNullMessage("Group order field");
    public static final String GROUP_ORDER_DIRECTION_CAN_NOT_BE_NULL = Messages.getCanNotBeNullMessage("Group order direction");
    ...
    private GetAllOrderedByWithDevicesOrderedByMessages() {
    }
}
