...
import be.tpvision.smartcontrol.io.ip.twa.TwaInitializer;
...
public class NettyCommandSender {
    ...
    private final Bootstrap bootstrap = (Bootstrap)((Bootstrap)((Bootstrap)new Bootstrap().group(this.eventLoopGroup)).channel(NioDatagramChannel.class)).handler(new TwaInitializer());
    ...
    public void send(Request command, InetSocketAddress destination) {
        Assert.notNull((Object)command, SendMessages.COMMAND_CAN_NOT_BE_NULL);
