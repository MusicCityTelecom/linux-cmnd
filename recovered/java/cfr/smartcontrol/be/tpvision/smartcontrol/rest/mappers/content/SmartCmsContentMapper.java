...
public class SmartCmsContentMapper {
    ...
    public static Content toContent(SmartCmsContentViewModel smartCmsContentViewModel) {
        String publishDateString;
        String changedString;
        Assert.notNull((Object)smartCmsContentViewModel, ToContentMessages.SMART_CMS_CONTENT_VIEW_MODEL_CAN_NOT_BE_NULL);
        ...
        if ((changedString = smartCmsContentViewModel.getChanged()) != null) {
        ...
        if ((publishDateString = smartCmsContentViewModel.getPublishDate()) != null) {
    ...
    public static List<Content> toContentList(Collection<SmartCmsContentViewModel> smartCmsContentViewModelCollection) {
        ...
        return smartCmsContentViewModelCollection.stream().filter(Objects::nonNull).map(SmartCmsContentMapper::toContent).filter(Objects::nonNull).collect(Collectors.toList());
    }
}
