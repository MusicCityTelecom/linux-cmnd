...
public class IpDestinationMapper {
    ...
    public static IpDestinationViewModel toIpDestinationViewModel(IpDestination ipDestination) {
        Assert.notNull((Object)ipDestination, ToIpDestinationViewModelMessages.IP_DESTINATION_CAN_NOT_BE_NULL);
    ...
    public static IpDestination toIpDestination(IpDestinationViewModel ipDestinationViewModel) {
        Assert.notNull((Object)ipDestinationViewModel, ToIpDestinationMessages.IP_DESTINATION_CAN_NOT_BE_NULL);
