...
public class ImportExportGroupViewModel
implements ImportExportItemListViewModel {
    ...
    public ImportExportGroupViewModel(String name, List<ImportExportDeviceViewModel> devices) {
        this.name = name;
    ...
    public void setDevices(List<ImportExportDeviceViewModel> devices) {
        this.devices = devices;
    }
