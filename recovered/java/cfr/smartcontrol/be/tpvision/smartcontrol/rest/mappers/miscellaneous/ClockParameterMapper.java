...
public class ClockParameterMapper {
    ...
    public static String toClockParameterString(ClockParameter clockParameter) {
        LocalTime localTime = LocalTime.of(clockParameter.getHour(), clockParameter.getMinute());
        return String.valueOf(localTime);
    }

    public static ClockParameter toClockParameter(String clockParameterViewString) {
