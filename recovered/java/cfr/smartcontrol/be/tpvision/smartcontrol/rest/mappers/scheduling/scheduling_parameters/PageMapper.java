...
import be.tpvision.smartcontrol.rest.mappers.scheduling.scheduling_parameters.WorkingDayMapper;
...
public class PageMapper {
    ...
    public static PageViewModel toPageViewModel(Page page) {
        Assert.notNull((Object)page, ToPageViewModelMessages.PAGE_CAN_NOT_BE_NULL);
        ...
        String viewModelSourceType = domainSourceType != null ? String.valueOf((Object)domainSourceType) : null;
        ...
        String viewModelTag = domainTag != null ? String.valueOf((Object)domainTag) : null;
        pageViewModel.setTag(viewModelTag);
        return pageViewModel;
    }

    public static Page toPage(PageViewModel pageViewModel) {
        Assert.notNull((Object)pageViewModel, ToPageMessages.PAGE_VIEW_MODEL_CAN_NOT_BE_NULL);
        ...
        InputSource.SourceType domainSourceType = viewModelSourceType != null ? ValueUtilities.getEnumValue(InputSource.SourceType.class, viewModelSourceType) : null;
