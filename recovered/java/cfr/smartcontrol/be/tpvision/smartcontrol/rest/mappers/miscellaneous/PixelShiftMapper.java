...
public class PixelShiftMapper {
    ...
    public static PixelShiftViewModel toPixelShiftViewModel(PixelShift pixelShift) {
        Assert.notNull((Object)pixelShift, ToPixelShiftViewModelMessages.PIXEL_SHIFT_CAN_NOT_BE_NULL);
        ...
        String viewModelState = String.valueOf((Object)domainState);
    ...
    public static PixelShift toPixelShift(PixelShiftViewModel pixelShiftViewModel) {
        Assert.notNull((Object)pixelShiftViewModel, ToPixelShiftMessages.TILING_VIEW_MODEL_CAN_NOT_BE_NULL);
