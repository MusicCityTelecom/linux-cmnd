...
public class DeviceAddressWrapperMapper {
    ...
    public static DeviceAddressWrapper toDeviceAddressWrapper(DeviceAddressWrapperViewModel deviceAddressWrapperViewModel) {
        Assert.notNull((Object)deviceAddressWrapperViewModel, ToDeviceAddressWrapperMessages.DEVICE_ADDRESS_WRAPPER_VIEW_MODEL_CAN_NOT_BE_NULL);
