...
public class SettingsMapper {
    ...
    public static SettingsViewModel toSettingsViewModel(Settings settings) {
        Assert.notNull((Object)settings, ToSettingsViewModelMessages.SETTINGS_CAN_NOT_BE_NULL);
