...
public class TilingMapper {
    ...
    public static TilingViewModel toTilingViewModel(Tiling tiling) {
        Assert.notNull((Object)tiling, ToTilingViewModelMessages.TILING_CAN_NOT_BE_NULL);
        ...
        String viewModelEnable = String.valueOf((Object)domainEnable);
        ...
        String viewModelFrameComp = String.valueOf((Object)domainFrameComp);
    ...
    public static Tiling toTiling(TilingViewModel tilingViewModel) {
        Assert.notNull((Object)tilingViewModel, ToTilingMessages.TILING_VIEW_MODEL_CAN_NOT_BE_NULL);
