...
public class PixelShiftLimitsViewModel
extends IncrementalLimitsViewModel {
    private EnumLimitsViewModel<PixelShift.State> state = new EnumLimitsViewModel<PixelShift.State>(PixelShift.State.class);
