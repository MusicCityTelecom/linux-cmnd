...
public class VideoParametersMapper {
    ...
    public static VideoParametersViewModel toVideoParametersViewModel(VideoParameters videoParameters) {
        Assert.notNull((Object)videoParameters, ToVideoParametersViewModelMessages.VIDEO_PARAMETERS_CAN_NOT_BE_NULL);
        ...
        String viewModelGammaSelection = String.valueOf((Object)domainGammaSelection);
        return new VideoParametersViewModel(brightness, color, contrast, sharpness, hue, backlight, viewModelGammaSelection);
    }

    public static VideoParameters toVideoParameters(VideoParametersViewModel videoParametersViewModel) {
        Assert.notNull((Object)videoParametersViewModel, ToVideoParametersMessages.VIDEO_PARAMETERS_VIEW_MODEL_CAN_NOT_BE_NULL);
