...
public class PictureInPictureMapper {
    ...
    public static PictureInPictureViewModel toPictureInPictureViewModel(PictureInPicture pictureInPicture) {
        Assert.notNull((Object)pictureInPicture, ToPictureInPictureViewModelMessages.PICTURE_IN_PICTURE_CAN_NOT_BE_NULL);
        PictureInPicture.Status status = pictureInPicture.getStatus();
        String statusString = String.valueOf((Object)status);
        PictureInPicture.WindowPosition windowPosition = pictureInPicture.getWindowPosition();
        String windowPositionString = String.valueOf((Object)windowPosition);
        return new PictureInPictureViewModel(statusString, windowPositionString);
    }

    public static PictureInPicture toPictureInPicture(PictureInPictureViewModel pictureInPictureViewModel) {
        Assert.notNull((Object)pictureInPictureViewModel, ToPictureInPictureMessages.PICTURE_IN_PICTURE_VIEW_MODEL_CAN_NOT_BE_NULL);
