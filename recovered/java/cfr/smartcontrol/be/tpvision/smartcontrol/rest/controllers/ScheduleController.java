...
public class ScheduleController {
    ...
    @Autowired
    public ScheduleController(ContentManagementService contentManagementService) {
    ...
    public ResponseEntity<Void> headRevisionFile(@PathVariable(value="hardwareKey") String hardwareKey) throws IOException {
        Assert.state(this.contentManagementService != null, HeadRevisionFileMessages.CONTENT_MANAGEMENT_SERVICE_CAN_NOT_BE_NULL);
        Assert.notNull((Object)hardwareKey, HeadRevisionFileMessages.HARDWARE_KEY_CAN_NOT_BE_NULL);
        ...
        boolean revisionPathExists = Files.exists(revisionPath, new LinkOption[0]);
    ...
    @GetMapping(value={"/info_{hardwareKey}.txt"})
    public ResponseEntity<?> getRevisionFile(@PathVariable(value="hardwareKey") String hardwareKey) {
        Assert.state(this.contentManagementService != null, GetRevisionFileMessages.CONTENT_MANAGEMENT_SERVICE_CAN_NOT_BE_NULL);
        Assert.notNull((Object)hardwareKey, GetRevisionFileMessages.HARDWARE_KEY_CAN_NOT_BE_NULL);
    ...
    public ResponseEntity<Void> headScheduleFile(@PathVariable(value="hardwareKey") String hardwareKey) {
        Assert.state(this.contentManagementService != null, HeadScheduleFileMessages.CONTENT_MANAGEMENT_SERVICE_CAN_NOT_BE_NULL);
        Assert.notNull((Object)hardwareKey, HeadScheduleFileMessages.HARDWARE_KEY_CAN_NOT_BE_NULL);
    ...
    @GetMapping(value={"/{hardwareKey}.js"})
    public ResponseEntity<Void> getScheduleFile(@PathVariable(value="hardwareKey") String hardwareKey) {
        return this.headScheduleFile(hardwareKey);
    }

    @GetMapping(value={"/flag_{hardwareKey}.txt"})
    public ResponseEntity<Void> getFlag(@PathVariable(value="hardwareKey") String hardwareKey) {
        Assert.state(this.contentManagementService != null, GetFlagMessages.CONTENT_MANAGEMENT_SERVICE_CAN_NOT_BE_NULL);
        Assert.notNull((Object)hardwareKey, GetFlagMessages.HARDWARE_KEY_CAN_NOT_BE_NULL);
    ...
    public ResponseEntity<Void> headCmsSourceFile(@PathVariable(value="hardwareKey") String hardwareKey) throws IOException {
        Assert.state(this.contentManagementService != null, HeadCmsSourceFileMessages.CONTENT_MANAGEMENT_SERVICE_CAN_NOT_BE_NULL);
        Assert.notNull((Object)hardwareKey, HeadCmsSourceFileMessages.HARDWARE_KEY_CAN_NOT_BE_NULL);
        ...
        boolean hardwareCmsPathExists = Files.exists(cmsPath, new LinkOption[0]);
    ...
    @GetMapping(value={"/cms_data_{hardwareKey}.cms"})
    public ResponseEntity<?> getCmsSourceFile(@PathVariable(value="hardwareKey") String hardwareKey) {
        Assert.state(this.contentManagementService != null, GetCmsSourceFileMessages.CONTENT_MANAGEMENT_SERVICE_CAN_NOT_BE_NULL);
        Assert.notNull((Object)hardwareKey, GetCmsSourceFileMessages.HARDWARE_KEY_CAN_NOT_BE_NULL);
