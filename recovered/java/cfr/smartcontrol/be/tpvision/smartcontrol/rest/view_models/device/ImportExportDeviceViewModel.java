...
public class ImportExportDeviceViewModel
implements ImportExportItemListViewModel {
    ...
    public ImportExportDeviceViewModel(IpDestinationViewModel ipDestination, String sicpVersion, String serialCode, String modelNumber, String name) {
    ...
    public String toString() {
        return new ToStringBuilder(this).append("ipDestination", this.getIpDestination()).append("sicpVersion", this.getSicpVersion()).append("serialCode", this.getSerialCode()).append("modelNumber", this.getModelNumber()).append("name", this.getName()).toString();
    }
}
