...
@RestController
@RequestMapping(value={"/api/ledDevices"})
public class LedDeviceController {
    private static final int PORT = 8001;
    private final NettyCommandSender nettyCommandSender;

    @Autowired
    public LedDeviceController(NettyCommandSender nettyCommandSender) {
        Assert.notNull((Object)nettyCommandSender, ConstructorMessages.NETTY_COMMAND_SENDER_CAN_NOT_BE_NULL);
        this.nettyCommandSender = nettyCommandSender;
    }

    @PutMapping(value={"/{ipAddress}/mainboardOriginPosition"})
    public void setMainboardOriginPosition(@PathVariable(value="ipAddress") String ipAddress, @RequestBody TwaCommandViewModel twaCommandViewModel) {
        Assert.isTrue(StringUtils.hasText(ipAddress), SetMainboardOriginPositionMessages.IP_ADDRESS_CAN_NOT_BE_EMPTY);
        Assert.notNull((Object)twaCommandViewModel, SetMainboardOriginPositionMessages.TWA_COMMAND_VIEW_MODEL_CAN_NOT_BE_NULL);
        ...
        Assert.isInstanceOf(MainboardOriginPositionViewModel.class, (Object)twaDeviceSettingViewModel, "TWA device setting view model has to be an instance of mainboard origin position view model");
        ...
        Assert.notNull((Object)mainboardOriginPositionViewModel, SetMainboardOriginPositionMessages.MAINBOARD_ORIGIN_POSITION_VIEW_MODEL_CAN_NOT_BE_NULL);
    ...
    public void setMainboardSignalOutput(@PathVariable(value="ipAddress") String ipAddress, @RequestBody TwaCommandViewModel twaCommandViewModel) {
        Assert.isTrue(StringUtils.hasText(ipAddress), SetMainboardSignalOutputMessages.IP_ADDRESS_CAN_NOT_BE_EMPTY);
        Assert.notNull((Object)twaCommandViewModel, SetMainboardSignalOutputMessages.TWA_COMMAND_VIEW_MODEL_CAN_NOT_BE_NULL);
        DeviceAddressViewModel deviceAddressViewModel = twaCommandViewModel.getDeviceAddress();
        ...
        Assert.isInstanceOf(StringViewModel.class, (Object)twaDeviceSettingViewModel, "TWA device setting view model has to be an instance of string view model");
    ...
    @PutMapping(value={"/{ipAddress}/cascadeMode"})
    public void setCascadeMode(@PathVariable(value="ipAddress") String ipAddress, @RequestBody TwaCommandViewModel twaCommandViewModel) {
        Assert.isTrue(StringUtils.hasText(ipAddress), SetCascadeModeMessages.IP_ADDRESS_CAN_NOT_BE_EMPTY);
        Assert.notNull((Object)twaCommandViewModel, SetCascadeModeMessages.TWA_COMMAND_VIEW_MODEL_CAN_NOT_BE_NULL);
        DeviceAddressViewModel deviceAddressViewModel = twaCommandViewModel.getDeviceAddress();
    ...
    @PutMapping(value={"/{ipAddress}/normalDisplayTestPattern"})
    public void setNormalDisplayTestPattern(@PathVariable(value="ipAddress") String ipAddress, @RequestBody TwaCommandViewModel twaCommandViewModel) {
        Assert.isTrue(StringUtils.hasText(ipAddress), SetNormalDisplayTestPatternMessages.IP_ADDRESS_CAN_NOT_BE_EMPTY);
        Assert.notNull((Object)twaCommandViewModel, SetNormalDisplayTestPatternMessages.TWA_COMMAND_VIEW_MODEL_CAN_NOT_BE_NULL);
        DeviceAddressViewModel deviceAddressViewModel = twaCommandViewModel.getDeviceAddress();
        ...
        Assert.state(StringUtils.hasText(viewModelNormalDisplayTestPattern), SetNormalDisplayTestPatternMessages.VIEW_MODEL_NORMAL_DISPLAY_TEST_PATTERN_CAN_NOT_BE_EMPTY);
    ...
    @PutMapping(value={"/{ipAddress}/testPatternColor"})
    public void setTestPatternColor(@PathVariable(value="ipAddress") String ipAddress, @RequestBody TwaCommandViewModel twaCommandViewModel) {
        Assert.isTrue(StringUtils.hasText(ipAddress), SetTestPatternColorMessages.IP_ADDRESS_CAN_NOT_BE_EMPTY);
        Assert.notNull((Object)twaCommandViewModel, SetTestPatternColorMessages.TWA_COMMAND_VIEW_MODEL_CAN_NOT_BE_NULL);
        DeviceAddressViewModel deviceAddressViewModel = twaCommandViewModel.getDeviceAddress();
    ...
    @PutMapping(value={"/{ipAddress}/brightness"})
    public void setBrightness(@PathVariable(value="ipAddress") String ipAddress, @RequestBody TwaCommandViewModel twaCommandViewModel) {
        Assert.isTrue(StringUtils.hasText(ipAddress), SetBrightnessMessages.IP_ADDRESS_CAN_NOT_BE_EMPTY);
        Assert.notNull((Object)twaCommandViewModel, SetBrightnessMessages.TWA_COMMAND_VIEW_MODEL_CAN_NOT_BE_NULL);
        DeviceAddressViewModel deviceAddressViewModel = twaCommandViewModel.getDeviceAddress();
        ...
        Assert.isInstanceOf(IntegerViewModel.class, (Object)twaDeviceSettingViewModel, "TWA device setting view model has to be an instance of integer view model");
    ...
    @PutMapping(value={"/{ipAddress}/deviceAddress"})
    public void setDeviceAddress(@PathVariable(value="ipAddress") String ipAddress, @RequestBody DeviceAddressWrapperViewModel deviceAddressWrapperViewModel) {
        Assert.isTrue(StringUtils.hasText(ipAddress), SetDeviceAddressMessages.IP_ADDRESS_CAN_NOT_BE_EMPTY);
        Assert.notNull((Object)deviceAddressWrapperViewModel, SetDeviceAddressMessages.DEVICE_ADDRESS_WRAPPER_VIEW_MODEL_CAN_NOT_BE_NULL);
