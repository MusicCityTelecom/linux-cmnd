...
public class SchedulingParametersMapper {
    ...
    public static SchedulingParametersViewModel toSchedulingParametersViewModel(SchedulingParameters schedulingParameters) {
        Assert.notNull((Object)schedulingParameters, ToSchedulingParametersViewModelMessages.SCHEDULING_PARAMETERS_CAN_NOT_BE_NULL);
        SchedulingParametersViewModel schedulingParametersViewModel = new SchedulingParametersViewModel();
        ArrayList<Page> pages = schedulingParameters.getPages();
        Assert.state(pages != null, ToSchedulingParametersViewModelMessages.PAGES_CAN_NOT_BE_NULL);
        Page domainPage1 = (Page)pages.get(0);
        ...
        Page domainPage2 = (Page)pages.get(1);
        ...
        Page domainPage3 = (Page)pages.get(2);
        ...
        Page domainPage4 = (Page)pages.get(3);
        ...
        Page domainPage5 = (Page)pages.get(4);
        ...
        Page domainPage6 = (Page)pages.get(5);
        ...
        Page domainPage7 = (Page)pages.get(6);
