...
public abstract class TwaMessage
implements Request {
    ...
    public TwaMessage(byte direction, byte deviceAddressX, byte deviceAddressY) {
        this(direction, deviceAddressX, deviceAddressY, deviceAddressX, deviceAddressY);
    }

    public TwaMessage(byte direction, byte deviceAddressX, byte deviceAddressY, byte moduleAddressX, byte moduleAddressY) {
    ...
    public void setDeviceAddressX(byte deviceAddressX) {
        this.deviceAddressX = deviceAddressX;
    }
    ...
    public void setDeviceAddressY(byte deviceAddressY) {
        this.deviceAddressY = deviceAddressY;
    }
    ...
    public void setModuleAddressX(byte moduleAddressX) {
        this.moduleAddressX = moduleAddressX;
    }
    ...
    public void setModuleAddressY(byte moduleAddressY) {
        this.moduleAddressY = moduleAddressY;
    }
    ...
    public byte[] toBytes() {
        ...
        byte[] dataLength = TwaMessage.getDataLength();
        ...
        byte[] embeddedDataLength = TwaMessage.getEmbeddedDataLength();
    ...
    public boolean equals(Object object) {
        ...
        return new EqualsBuilder().append(this.getDirection(), that.getDirection()).append(this.getDeviceAddressX(), that.getDeviceAddressX()).append(this.getDeviceAddressY(), that.getDeviceAddressY()).append(this.getModuleAddressX(), that.getModuleAddressX()).append(this.getModuleAddressY(), that.getModuleAddressY()).isEquals();
    }
    ...
    public String toString() {
        ...
        return new ToStringBuilder(this).append("direction", directionHex).append("deviceAddressX", deviceAddressXHex).append("deviceAddressY", deviceAddressYHex).append("moduleAddressX", moduleAddressXHex).append("moduleAddressY", moduleAddressYHex).toString();
    }
}
