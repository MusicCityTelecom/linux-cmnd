...
extends SicpCommandFactoryImpl {
    ...
    private SicpCommandFactory() {
        super(SicpVersion._205, commands);
    }
    ...
    static {
        ...
        commands.add(new Command(Command.Type.GET, Command.Setting.BOOT_ON_SOURCE, -70, null, BootOnSourceCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.BOOT_ON_SOURCE, -69, BootOnSourceCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.GET_NUMBER_OF_INPUT_SOURCES, -85, NumberOfInputSourcesCodec.getInstance()));
    }
}
