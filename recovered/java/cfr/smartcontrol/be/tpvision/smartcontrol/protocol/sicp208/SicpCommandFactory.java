...
extends SicpCommandFactoryImpl {
    ...
    static {
        ...
        commands.add(new Command(Command.Type.GET, Command.Setting.CLOCK, -121, null, ClockParameterCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.CLOCK, -122, ClockParameterCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.DATE, -107, null, DateParameterCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.DATE, -106, DateParameterCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.AUTO_TIME_SYNC, -119, null, AutoTimeSyncCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.AUTO_TIME_SYNC, -120, AutoTimeSyncCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.TIME_ZONE, -117, null, TimeZoneCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.TIME_ZONE, -118, TimeZoneCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.AUTO_RESTART, -98, null, AutoRestartParameterCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.AUTO_RESTART, -97, AutoRestartParameterCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.LANGUAGE_OSD, -89, null, LanguageOSDCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.LANGUAGE_OSD, -88, LanguageOSDCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.AUDIO_SYNC, -115, null, AudioSyncCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.AUDIO_SYNC, -116, AudioSyncCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.SPEAKERS_STATUS, -113, null, SpeakersStatusCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.SPEAKERS_STATUS, -114, SpeakersStatusCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.TEAMVIEWER_STATUS, -109, null, TeamviewerStatusCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.TEAMVIEWER_STATUS, -108, TeamviewerStatusCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.RS232_ROUTING, -102, null, RS232RoutingCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.RS232_ROUTING, -101, RS232RoutingCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.SICP_SERIAL_PORT_FORWARDING, -66, null, SicpSerialPortForwardingCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.SICP_SERIAL_PORT_FORWARDING, -65, SicpSerialPortForwardingCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.WOL, -100, null, WOLCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.WOL, -99, WOLCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.HDMI_ONE_WIRE, -68, null, HdmiOneWireCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.HDMI_ONE_WIRE, -67, HdmiOneWireCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.OPS_SDM_SETTINGS, 110, null, OpsSdmSettingsCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.OPS_SDM_SETTINGS, 111, OpsSdmSettingsCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.POWER_LED, 72, null, PowerLEDCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.POWER_LED, 73, PowerLEDCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.FORCE_RESTART_CUSTOM_APP, 120, null, ForceRestartCustomAppCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.FORCE_RESTART_CUSTOM_APP, 121, ForceRestartCustomAppCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.OTA_UPDATE_SET, -31, OtaUpdateSetCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.OTA_UPDATE_GET, -30, OtaImageTypeCodec.getInstance(), OtaUpdateGetCodec.getInstance()));
        commands.add(new Command(Command.Type.GET, Command.Setting.OTA_GET_FW_VERSION, -29, OtaImageTypeCodec.getInstance(), StringWrapperCodec.getInstance()));
