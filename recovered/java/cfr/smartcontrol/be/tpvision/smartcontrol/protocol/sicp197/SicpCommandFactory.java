...
extends SicpCommandFactoryImpl {
    ...
    static {
        ...
        commands.add(new Command(Command.Type.GET, Command.Setting.PORT_STATUS, -14, null, PortStatusCodec.getInstance()));
        commands.add(new Command(Command.Type.SET, Command.Setting.PORT_STATUS, -15, PortStatusCodec.getInstance()));
