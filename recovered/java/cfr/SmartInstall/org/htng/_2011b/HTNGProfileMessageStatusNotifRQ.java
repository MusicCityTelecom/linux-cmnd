...
public class HTNGProfileMessageStatusNotifRQ
extends HTNGRequestBaseType {
    ...
    protected ProfileMessages profileMessages;
    ...
    public void setProfileMessages(ProfileMessages value) {
    ...
    public static class ProfileMessages {
        ...
        protected List<ProfileMessage> profileMessage;

        public List<ProfileMessage> getProfileMessage() {
            if (this.profileMessage == null) {
                this.profileMessage = new ArrayList<ProfileMessage>();
            }
