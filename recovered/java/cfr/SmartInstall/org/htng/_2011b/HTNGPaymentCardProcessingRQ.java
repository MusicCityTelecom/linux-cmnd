...
import org.opentravel.ota._2003._05.StayInfoType;
import org.opentravel.ota._2003._05.TPAExtensionsType;

@XmlAccessorType(value=XmlAccessType.FIELD)
@XmlType(name="", propOrder={"pos", "authorizationDetail", "stayInfo", "tpaExtensions"})
@XmlRootElement(name="HTNG_PaymentCardProcessingRQ")
public class HTNGPaymentCardProcessingRQ {
    @XmlElement(name="POS")
    ...
    protected StayInfoType stayInfo;
    ...
    public StayInfoType getStayInfo() {
        return this.stayInfo;
    }

    public void setStayInfo(StayInfoType value) {
        this.stayInfo = value;
    }
