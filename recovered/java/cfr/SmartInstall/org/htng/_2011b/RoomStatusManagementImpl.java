...
@WebService(serviceName="HTNG_GuestAndRoomStatusService", portName="RoomStatusManagement", targetNamespace="http://htng.org/2011B", wsdlLocation="classpath:/HTNG/services/HTNG_GuestAndRoomStatusService.wsdl", endpointInterface="org.htng._2011b.RoomStatusManagement")
public class RoomStatusManagementImpl
implements RoomStatusManagement {
    ...
    public HTNGHotelRoomStatusSearchRS searchRooms(HTNGHotelRoomStatusSearchRQ htngHotelRoomStatusSearchRQ) {
        ...
        try {
            ...
            List<Object> roomIds = new ArrayList<String>();
            ...
            ArrayList<HTNGHotelRoomStatusSearchRS.RoomInformationList.RoomInformation> _returnRoomInformationListRoomInformation = new ArrayList<HTNGHotelRoomStatusSearchRS.RoomInformationList.RoomInformation>();
            for (String string : roomIds) {
                ...
                HTNGRoomElementType roomType = HTNGHelper.generateRoom(string);
                roomInformation.setRoom(roomType);
                HotelReservationsType reservationsType = new HotelReservationsType();
                ArrayList<HotelReservationsType.HotelReservation> reservationList = new ArrayList<HotelReservationsType.HotelReservation>();
                List<Reservation> reservations = JpaManager.getReservationManager().findReservationByRooms(string);
    ...
    public HTNGResponseBaseType updateRoomStatus(HTNGHotelRoomStatusUpdateNotifRQ htngHotelRoomStatusUpdateNotifRQ) {
        ...
        try {
            ...
            ArrayList<WarningType> _returnWarningsWarning = new ArrayList<WarningType>();
            ...
            ArrayList<ErrorType> _returnErrorsError = new ArrayList<ErrorType>();
