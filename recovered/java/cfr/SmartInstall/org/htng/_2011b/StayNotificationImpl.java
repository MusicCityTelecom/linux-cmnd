...
@WebService(serviceName="HTNG_GuestAndRoomStatusService", portName="StayNotification", targetNamespace="http://htng.org/2011B", wsdlLocation="classpath:/HTNG/services/HTNG_GuestAndRoomStatusService.wsdl", endpointInterface="org.htng._2011b.StayNotification")
public class StayNotificationImpl
extends BaseHtngService
implements StayNotification {
    ...
    public HTNGResponseBaseType checkedIn(HTNGHotelCheckInNotifRQ htngHotelCheckInNotifRQ) {
        try {
            ...
            LOG.info("Executing HTNG checkedIn for {}", (Object)roomId);
    ...
    public HTNGResponseBaseType checkedOut(HTNGHotelCheckOutNotifRQ htngHotelCheckOutNotifRQ) {
        try {
            ...
            LOG.info("Executing HTNG checkedOut roomid:{}", (Object)roomid);
    ...
    public HTNGResponseBaseType roomMoved(HTNGHotelRoomMoveNotifRQ htngHotelRoomMoveNotifRQ) {
        try {
            ...
            LOG.info("room moved from {} to {}", (Object)srcRoomId, (Object)dstRoomId);
            if (!PmsUtils.isGuestCheckin(srcRoomId)) {
                HotelReservationsType.HotelReservation res = HTNGHelper.extractFirstReservation(htngHotelRoomMoveNotifRQ.getDestinationRoomInformation().getHotelReservations());
    ...
    public HTNGResponseBaseType stayUpdated(HTNGHotelStayUpdateNotifRQ htngHotelStayUpdateNotifRQ) {
        try {
            ...
            if (!updateContentObj.isEmpty()) {
                String guestName;
                String language;
                LOG.info("update content: {}", (Object)updateContentObj.toString());
                ...
                if (!"".equalsIgnoreCase(language = updateContentObj.optString("Language"))) {
                    PmsUtils.updateGuestInfo(roomId, PmsUtils.GuestInfoFieldType.GuestLanguage, language);
                }
                if (!"".equalsIgnoreCase(guestName = updateContentObj.optString("GuestName"))) {
