...
public final class GuestCommunicationsClient {
    ...
    public void updateMessageStatus(String roomId, String msgId, String msgStatus) {
        ...
        ArrayList<HTNGProfileMessageStatusNotifRQ.ProfileMessages.ProfileMessage> profileMessagesList = new ArrayList<HTNGProfileMessageStatusNotifRQ.ProfileMessages.ProfileMessage>();
    ...
    public static void main(String[] args) throws Exception {
        ...
        ArrayList<SourceType> _retrieveMessages_htngProfileMessageRQPOSSource = new ArrayList<SourceType>();
        ...
        _retrieveMessages_htngProfileMessageRQPOSSourceVal1BookingChannel.setCompanyName(_retrieveMessages_htngProfileMessageRQPOSSourceVal1BookingChannelCompanyName);
        ...
        ArrayList _retrieveMessages_htngProfileMessageRQRoomRoomTypeRoomDescriptionTextOrImageOrURL = new ArrayList();
        _retrieveMessages_htngProfileMessageRQRoomRoomTypeRoomDescription.getTextOrImageOrURL().addAll(_retrieveMessages_htngProfileMessageRQRoomRoomTypeRoomDescriptionTextOrImageOrURL);
        ...
        _retrieveMessages_htngProfileMessageRQRoomRoomTypeRoomDescription.setCreateDateTime(DatatypeFactory.newInstance().newXMLGregorianCalendar("2020-03-24T09:54:33.773+08:00"));
        _retrieveMessages_htngProfileMessageRQRoomRoomTypeRoomDescription.setCreatorID("CreatorID-1361881803");
        _retrieveMessages_htngProfileMessageRQRoomRoomTypeRoomDescription.setLastModifyDateTime(DatatypeFactory.newInstance().newXMLGregorianCalendar("2020-03-24T09:54:33.773+08:00"));
        _retrieveMessages_htngProfileMessageRQRoomRoomTypeRoomDescription.setLastModifierID("LastModifierID827872615");
        _retrieveMessages_htngProfileMessageRQRoomRoomTypeRoomDescription.setPurgeDate(DatatypeFactory.newInstance().newXMLGregorianCalendar("2020-03-24T09:54:33.773+08:00"));
        ...
        ArrayList _retrieveMessages_htngProfileMessageRQRoomRoomTypeAdditionalDetailsAdditionalDetail = new ArrayList();
        _retrieveMessages_htngProfileMessageRQRoomRoomTypeAdditionalDetails.getAdditionalDetail().addAll(_retrieveMessages_htngProfileMessageRQRoomRoomTypeAdditionalDetailsAdditionalDetail);
        ...
        ArrayList _retrieveMessages_htngProfileMessageRQRoomRoomTypeAmenitiesAmenity = new ArrayList();
        ...
        ArrayList _retrieveMessages_htngProfileMessageRQRoomRoomTypeOccupancy = new ArrayList();
        ...
        ArrayList _retrieveMessages_htngProfileMessageRQRoomRoomTypeTPAExtensionsAny = new ArrayList();
        ...
        ArrayList _retrieveMessages_htngProfileMessageRQRoomRoomTypeBedTypeCode = new ArrayList();
        ...
        ArrayList _retrieveMessages_htngProfileMessageRQRoomRoomTypePromotionVendorCode = new ArrayList();
        ...
        ArrayList _retrieveMessages_htngProfileMessageRQRoomTelephoneExtensionsTelephoneExtention = new ArrayList();
        _retrieveMessages_htngProfileMessageRQRoomTelephoneExtensions.getTelephoneExtention().addAll(_retrieveMessages_htngProfileMessageRQRoomTelephoneExtensionsTelephoneExtention);
        ...
        ArrayList _retrieveMessages_htngProfileMessageRQRoomTPAExtensionsAny = new ArrayList();
        ...
        ArrayList<Object> _retrieveMessages_htngProfileMessageRQTPAExtensionsAny = new ArrayList<Object>();
        Object _retrieveMessages_htngProfileMessageRQTPAExtensionsAnyVal1 = null;
        ...
        POSType _updateMessageStatus_htngProfileMessageStatusRQPOS = new POSType();
        ArrayList<SourceType> _updateMessageStatus_htngProfileMessageStatusRQPOSSource = new ArrayList<SourceType>();
        SourceType _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1 = new SourceType();
        SourceType.RequestorID _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorID = new SourceType.RequestorID();
        CompanyNameType _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorIDCompanyName = new CompanyNameType();
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorIDCompanyName.setValue("Value-1349068806");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorIDCompanyName.setDivision("Division-1638066773");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorIDCompanyName.setDepartment("Department-1431357598");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorIDCompanyName.setCompanyShortName("CompanyShortName768866186");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorIDCompanyName.setTravelSector("TravelSector201185619");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorIDCompanyName.setCode("Code673425919");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorIDCompanyName.setCodeContext("CodeContext324617814");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorID.setCompanyName(_updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorIDCompanyName);
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorID.setURL("URL819038768");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorID.setType("Type-1835205563");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorID.setInstance("Instance290504902");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorID.setIDContext("IDContext1651886211");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorID.setID("ID1669168893");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorID.setMessagePassword("MessagePassword1168442542");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1.setRequestorID(_updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1RequestorID);
        SourceType.Position _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1Position = new SourceType.Position();
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1Position.setLatitude("Latitude1309132172");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1Position.setLongitude("Longitude-272677049");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1Position.setAltitude("Altitude-1713382343");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1Position.setAltitudeUnitOfMeasureCode("AltitudeUnitOfMeasureCode-822769372");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1Position.setPositionAccuracy("PositionAccuracy-1281654943");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1.setPosition(_updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1Position);
        SourceType.BookingChannel _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1BookingChannel = new SourceType.BookingChannel();
        CompanyNameType _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1BookingChannelCompanyName = new CompanyNameType();
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1BookingChannelCompanyName.setValue("Value-1952980565");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1BookingChannelCompanyName.setDivision("Division-1789366088");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1BookingChannelCompanyName.setDepartment("Department24846120");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1BookingChannelCompanyName.setCompanyShortName("CompanyShortName-2125620479");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1BookingChannelCompanyName.setTravelSector("TravelSector1608742326");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1BookingChannelCompanyName.setCode("Code-1273764701");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1BookingChannelCompanyName.setCodeContext("CodeContext667391642");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1BookingChannel.setCompanyName(_updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1BookingChannelCompanyName);
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1BookingChannel.setType("Type58340149");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1BookingChannel.setPrimary(true);
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1.setBookingChannel(_updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1BookingChannel);
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1.setAgentSine("AgentSine112890494");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1.setPseudoCityCode("PseudoCityCode-567412624");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1.setISOCountry("ISOCountry2118712185");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1.setISOCurrency("ISOCurrency-316091772");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1.setAgentDutyCode("AgentDutyCode-867865499");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1.setAirlineVendorID("AirlineVendorID1695759522");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1.setAirportCode("AirportCode309588191");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1.setFirstDepartPoint("FirstDepartPoint-2059186246");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1.setERSPUserID("ERSPUserID-1343917672");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1.setTerminalID("TerminalID-1111495832");
        _updateMessageStatus_htngProfileMessageStatusRQPOSSource.add(_updateMessageStatus_htngProfileMessageStatusRQPOSSourceVal1);
        _updateMessageStatus_htngProfileMessageStatusRQPOS.getSource().addAll(_updateMessageStatus_htngProfileMessageStatusRQPOSSource);
        _updateMessageStatus_htngProfileMessageStatusRQ.setPOS(_updateMessageStatus_htngProfileMessageStatusRQPOS);
        UniqueIDType _updateMessageStatus_htngProfileMessageStatusRQUniqueID = new UniqueIDType();
        CompanyNameType _updateMessageStatus_htngProfileMessageStatusRQUniqueIDCompanyName = new CompanyNameType();
        _updateMessageStatus_htngProfileMessageStatusRQUniqueIDCompanyName.setValue("Value223196467");
        _updateMessageStatus_htngProfileMessageStatusRQUniqueIDCompanyName.setDivision("Division-812679451");
        _updateMessageStatus_htngProfileMessageStatusRQUniqueIDCompanyName.setDepartment("Department1487829050");
        _updateMessageStatus_htngProfileMessageStatusRQUniqueIDCompanyName.setCompanyShortName("CompanyShortName1074666919");
        _updateMessageStatus_htngProfileMessageStatusRQUniqueIDCompanyName.setTravelSector("TravelSector-80742306");
        _updateMessageStatus_htngProfileMessageStatusRQUniqueIDCompanyName.setCode("Code-2062152535");
        _updateMessageStatus_htngProfileMessageStatusRQUniqueIDCompanyName.setCodeContext("CodeContext511594325");
        _updateMessageStatus_htngProfileMessageStatusRQUniqueID.setCompanyName(_updateMessageStatus_htngProfileMessageStatusRQUniqueIDCompanyName);
        _updateMessageStatus_htngProfileMessageStatusRQUniqueID.setURL("URL487755944");
        _updateMessageStatus_htngProfileMessageStatusRQUniqueID.setType("Type1931252751");
        _updateMessageStatus_htngProfileMessageStatusRQUniqueID.setInstance("Instance814805728");
        _updateMessageStatus_htngProfileMessageStatusRQUniqueID.setIDContext("IDContext-2019197663");
        _updateMessageStatus_htngProfileMessageStatusRQUniqueID.setID("ID-644431606");
        _updateMessageStatus_htngProfileMessageStatusRQ.setUniqueID(_updateMessageStatus_htngProfileMessageStatusRQUniqueID);
        ...
        HTNGComponentRoomType _updateMessageStatus_htngProfileMessageStatusRQRoom = new HTNGComponentRoomType();
        RoomTypeType _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType = new RoomTypeType();
        ParagraphType _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeRoomDescription = new ParagraphType();
        ArrayList _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeRoomDescriptionTextOrImageOrURL = new ArrayList();
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeRoomDescription.getTextOrImageOrURL().addAll(_updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeRoomDescriptionTextOrImageOrURL);
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeRoomDescription.setName("Name-879400144");
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeRoomDescription.setParagraphNumber(new BigInteger("-65908027555515284602097276221629758290"));
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeRoomDescription.setCreateDateTime(DatatypeFactory.newInstance().newXMLGregorianCalendar("2020-03-24T09:54:33.777+08:00"));
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeRoomDescription.setCreatorID("CreatorID-1033579732");
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeRoomDescription.setLastModifyDateTime(DatatypeFactory.newInstance().newXMLGregorianCalendar("2020-03-24T09:54:33.778+08:00"));
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeRoomDescription.setLastModifierID("LastModifierID871005624");
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeRoomDescription.setPurgeDate(DatatypeFactory.newInstance().newXMLGregorianCalendar("2020-03-24T09:54:33.778+08:00"));
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeRoomDescription.setLanguage("Language1002310126");
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setRoomDescription(_updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeRoomDescription);
        AdditionalDetailsType _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeAdditionalDetails = new AdditionalDetailsType();
        ArrayList _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeAdditionalDetailsAdditionalDetail = new ArrayList();
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeAdditionalDetails.getAdditionalDetail().addAll(_updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeAdditionalDetailsAdditionalDetail);
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setAdditionalDetails(_updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeAdditionalDetails);
        RoomTypeType.Amenities _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeAmenities = new RoomTypeType.Amenities();
        ArrayList _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeAmenitiesAmenity = new ArrayList();
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeAmenities.getAmenity().addAll(_updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeAmenitiesAmenity);
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setAmenities(_updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeAmenities);
        ArrayList _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeOccupancy = new ArrayList();
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.getOccupancy().addAll(_updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeOccupancy);
        TPAExtensionsType _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeTPAExtensions = new TPAExtensionsType();
        ArrayList _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeTPAExtensionsAny = new ArrayList();
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeTPAExtensions.getAny().addAll(_updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeTPAExtensionsAny);
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setTPAExtensions(_updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeTPAExtensions);
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setNumberOfUnits(new BigInteger("75022197953638860516592507706462469426"));
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setIsRoom(false);
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setIsConverted(false);
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setIsAlternate(false);
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setReqdGuaranteeType("ReqdGuaranteeType-229511088");
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setRoomType("RoomType687732197");
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setRoomTypeCode("RoomTypeCode-948443766");
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setRoomCategory("RoomCategory2089985861");
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setRoomID("RoomID489754213");
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setFloor(-302616496);
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setInvBlockCode("InvBlockCode2091010639");
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setRoomLocationCode("RoomLocationCode-698413246");
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setRoomViewCode("RoomViewCode-2078071114");
        ArrayList _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeBedTypeCode = new ArrayList();
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.getBedTypeCode().addAll(_updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypeBedTypeCode);
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setNonSmoking(false);
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setConfiguration("Configuration-493869242");
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setSizeMeasurement("SizeMeasurement652106146");
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setQuantity(-1758942469);
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setComposite(false);
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setRoomClassificationCode("RoomClassificationCode-105854490");
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setRoomArchitectureCode("RoomArchitectureCode-1616998063");
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setRoomGender("RoomGender-804609907");
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setSharedRoomInd(true);
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.setPromotionCode("PromotionCode1492408654");
        ArrayList _updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypePromotionVendorCode = new ArrayList();
        _updateMessageStatus_htngProfileMessageStatusRQRoomRoomType.getPromotionVendorCode().addAll(_updateMessageStatus_htngProfileMessageStatusRQRoomRoomTypePromotionVendorCode);
        _updateMessageStatus_htngProfileMessageStatusRQRoom.setRoomType(_updateMessageStatus_htngProfileMessageStatusRQRoomRoomType);
        HTNGTelephoneExtensionType _updateMessageStatus_htngProfileMessageStatusRQRoomTelephoneExtensions = new HTNGTelephoneExtensionType();
        ArrayList _updateMessageStatus_htngProfileMessageStatusRQRoomTelephoneExtensionsTelephoneExtention = new ArrayList();
        _updateMessageStatus_htngProfileMessageStatusRQRoomTelephoneExtensions.getTelephoneExtention().addAll(_updateMessageStatus_htngProfileMessageStatusRQRoomTelephoneExtensionsTelephoneExtention);
        _updateMessageStatus_htngProfileMessageStatusRQRoom.setTelephoneExtensions(_updateMessageStatus_htngProfileMessageStatusRQRoomTelephoneExtensions);
        HTNGHousekeepingStatusType _updateMessageStatus_htngProfileMessageStatusRQRoomHKStatus = HTNGHousekeepingStatusType.PICKUP;
        _updateMessageStatus_htngProfileMessageStatusRQRoom.setHKStatus(_updateMessageStatus_htngProfileMessageStatusRQRoomHKStatus);
        TPAExtensionsType _updateMessageStatus_htngProfileMessageStatusRQRoomTPAExtensions = new TPAExtensionsType();
        ArrayList _updateMessageStatus_htngProfileMessageStatusRQRoomTPAExtensionsAny = new ArrayList();
        _updateMessageStatus_htngProfileMessageStatusRQRoomTPAExtensions.getAny().addAll(_updateMessageStatus_htngProfileMessageStatusRQRoomTPAExtensionsAny);
        _updateMessageStatus_htngProfileMessageStatusRQRoom.setTPAExtensions(_updateMessageStatus_htngProfileMessageStatusRQRoomTPAExtensions);
        _updateMessageStatus_htngProfileMessageStatusRQRoom.setRoomID("RoomID-769412807");
        _updateMessageStatus_htngProfileMessageStatusRQ.setRoom(_updateMessageStatus_htngProfileMessageStatusRQRoom);
        ...
        ArrayList<HTNGProfileMessageStatusNotifRQ.ProfileMessages.ProfileMessage> _updateMessageStatus_htngProfileMessageStatusRQProfileMessagesProfileMessage = new ArrayList<HTNGProfileMessageStatusNotifRQ.ProfileMessages.ProfileMessage>();
        ...
        ArrayList _updateMessageStatus_htngProfileMessageStatusRQProfileMessagesProfileMessageVal1TextOrImageOrURL = new ArrayList();
        _updateMessageStatus_htngProfileMessageStatusRQProfileMessagesProfileMessageVal1.getTextOrImageOrURL().addAll(_updateMessageStatus_htngProfileMessageStatusRQProfileMessagesProfileMessageVal1TextOrImageOrURL);
        _updateMessageStatus_htngProfileMessageStatusRQProfileMessagesProfileMessageVal1.setName("Name1443671912");
        _updateMessageStatus_htngProfileMessageStatusRQProfileMessagesProfileMessageVal1.setParagraphNumber(new BigInteger("-3395467251269966598533418702656212189"));
        _updateMessageStatus_htngProfileMessageStatusRQProfileMessagesProfileMessageVal1.setCreateDateTime(DatatypeFactory.newInstance().newXMLGregorianCalendar("2020-03-24T09:54:33.779+08:00"));
        _updateMessageStatus_htngProfileMessageStatusRQProfileMessagesProfileMessageVal1.setCreatorID("CreatorID2146666658");
        _updateMessageStatus_htngProfileMessageStatusRQProfileMessagesProfileMessageVal1.setLastModifyDateTime(DatatypeFactory.newInstance().newXMLGregorianCalendar("2020-03-24T09:54:33.779+08:00"));
        ...
        _updateMessageStatus_htngProfileMessageStatusRQProfileMessagesProfileMessageVal1.setPurgeDate(DatatypeFactory.newInstance().newXMLGregorianCalendar("2020-03-24T09:54:33.779+08:00"));
        ...
        _updateMessageStatus_htngProfileMessageStatusRQProfileMessagesProfileMessageVal1.setStatus(_updateMessageStatus_htngProfileMessageStatusRQProfileMessagesProfileMessageVal1Status);
        _updateMessageStatus_htngProfileMessageStatusRQProfileMessagesProfileMessage.add(_updateMessageStatus_htngProfileMessageStatusRQProfileMessagesProfileMessageVal1);
        _updateMessageStatus_htngProfileMessageStatusRQProfileMessages.getProfileMessage().addAll(_updateMessageStatus_htngProfileMessageStatusRQProfileMessagesProfileMessage);
        ...
        ArrayList<Object> _updateMessageStatus_htngProfileMessageStatusRQTPAExtensionsAny = new ArrayList<Object>();
        Object _updateMessageStatus_htngProfileMessageStatusRQTPAExtensionsAnyVal1 = null;
