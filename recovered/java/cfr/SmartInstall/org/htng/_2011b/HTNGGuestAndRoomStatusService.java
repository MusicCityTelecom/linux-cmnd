...
@WebServiceClient(name="HTNG_GuestAndRoomStatusService", wsdlLocation="classpath:HTNG/services/HTNG_GuestAndRoomStatusService.wsdl", targetNamespace="http://htng.org/2011B")
public class HTNGGuestAndRoomStatusService
extends Service {
    public static final URL WSDL_LOCATION;
    public static final QName SERVICE;
    public static final QName RoomStatusManagement;
    public static final QName StayNotification;
    public static final QName WakeupSchedulingManagement;
    public static final QName GuestCommunications;
    ...
    static {
        SERVICE = new QName("http://htng.org/2011B", "HTNG_GuestAndRoomStatusService");
        RoomStatusManagement = new QName("http://htng.org/2011B", "RoomStatusManagement");
        StayNotification = new QName("http://htng.org/2011B", "StayNotification");
        WakeupSchedulingManagement = new QName("http://htng.org/2011B", "WakeupSchedulingManagement");
        GuestCommunications = new QName("http://htng.org/2011B", "GuestCommunications");
        URL url = HTNGGuestAndRoomStatusService.class.getClassLoader().getResource("HTNG/services/HTNG_GuestAndRoomStatusService.wsdl");
        if (url == null) {
            Logger.getLogger(HTNGGuestAndRoomStatusService.class.getName()).log(Level.INFO, "Can not initialize the default wsdl from {0}", "classpath:HTNG/services/HTNG_GuestAndRoomStatusService.wsdl");
        }
        WSDL_LOCATION = url;
    }
}
