...
public class SellableProductsType {
    ...
    public List<SellableProduct> getSellableProduct() {
        if (this.sellableProduct == null) {
            this.sellableProduct = new ArrayList<SellableProduct>();
        }
    ...
    public static class SellableProduct {
        ...
        public void setDestinationSystemCodes(DestinationSystemCodes value) {
        ...
        public void setInventoryBlock(InventoryBlock value) {
