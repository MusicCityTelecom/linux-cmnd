...
import org.opentravel.ota._2003._05.VideoItemType;
import org.opentravel.ota._2003._05.VideoItemsType;

@XmlAccessorType(value=XmlAccessType.FIELD)
@XmlType(name="VideoDescriptionType", propOrder={"videoFormat"})
@XmlSeeAlso(value={VideoItemsType.VideoItem.class})
public class VideoDescriptionType {
    ...
    public List<VideoFormat> getVideoFormat() {
        if (this.videoFormat == null) {
            this.videoFormat = new ArrayList<VideoFormat>();
        }
