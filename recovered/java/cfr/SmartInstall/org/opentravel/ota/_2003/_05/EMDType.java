...
import org.opentravel.ota._2003._05.ETFareInfo;
import org.opentravel.ota._2003._05.FareAmountType;
import org.opentravel.ota._2003._05.FareComponentType;
...
public class EMDType {
    ...
    public List<UniqueIDType> getAgentID() {
        if (this.agentID == null) {
            this.agentID = new ArrayList<UniqueIDType>();
        }
        return this.agentID;
    }
    ...
    public List<PaymentDetailType> getPaymentDetail() {
        if (this.paymentDetail == null) {
            this.paymentDetail = new ArrayList<PaymentDetailType>();
        }
    ...
    public List<UniqueIDType> getAddReferenceID() {
        if (this.addReferenceID == null) {
            this.addReferenceID = new ArrayList<UniqueIDType>();
        }
    ...
    public List<BaseFare> getBaseFare() {
        if (this.baseFare == null) {
            this.baseFare = new ArrayList<BaseFare>();
        }
    ...
    public List<TotalFare> getTotalFare() {
        if (this.totalFare == null) {
            this.totalFare = new ArrayList<TotalFare>();
        }
    ...
    public List<UnstructuredFareCalc> getUnstructuredFareCalc() {
        if (this.unstructuredFareCalc == null) {
            this.unstructuredFareCalc = new ArrayList<UnstructuredFareCalc>();
        }
    ...
    public List<TicketDocument> getTicketDocument() {
        if (this.ticketDocument == null) {
            this.ticketDocument = new ArrayList<TicketDocument>();
        }
    ...
    public void setCarrierFeeInfo(CarrierFeeInfo value) {
    ...
    public List<ExchResidualFareComponent> getExchResidualFareComponent() {
        if (this.exchResidualFareComponent == null) {
            this.exchResidualFareComponent = new ArrayList<ExchResidualFareComponent>();
        }
    ...
    public List<ReissuedFlown> getReissuedFlown() {
        if (this.reissuedFlown == null) {
            this.reissuedFlown = new ArrayList<ReissuedFlown>();
        }
    ...
    public void setPresentInfo(PresentInfo value) {
    ...
    public void setReasonForIssuance(ReasonForIssuance value) {
    ...
    public void setValidatingAirline(ValidatingAirline value) {
    ...
    public void setTaxCouponInformation(TaxCouponInformation value) {
    ...
    public static class TicketDocument {
        ...
        public static class CouponInfo {
            ...
            public void setExcessBaggage(ExcessBaggage value) {
            ...
            public void setFiledFeeInfo(FiledFeeInfo value) {
        ...
        public static class TicketDocument {
            ...
            public List<CouponNumber> getCouponNumber() {
                if (this.couponNumber == null) {
                    this.couponNumber = new ArrayList<CouponNumber>();
                }
            ...
            public static class CouponNumber {
                ...
                public void setTaxCouponInfo(TaxCouponInfo value) {
    ...
    extends ETFareInfo {
        ...
        public List<VoluntaryChangesType> getPenaltyAmount() {
            if (this.penaltyAmount == null) {
                this.penaltyAmount = new ArrayList<VoluntaryChangesType>();
            }
    ...
    public static class CarrierFeeInfo {
        ...
        public List<CarrierFee> getCarrierFee() {
            if (this.carrierFee == null) {
                this.carrierFee = new ArrayList<CarrierFee>();
            }
        ...
        public static class CarrierFee {
            ...
            public List<FeeAmount> getFeeAmount() {
                if (this.feeAmount == null) {
                    this.feeAmount = new ArrayList<FeeAmount>();
                }
            ...
            public static class FeeAmount {
                ...
                public List<String> getApplicationCode() {
                    if (this.applicationCode == null) {
                        this.applicationCode = new ArrayList<String>();
                    }
