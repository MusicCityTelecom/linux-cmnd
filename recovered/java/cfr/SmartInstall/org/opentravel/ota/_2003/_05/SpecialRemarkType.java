...
@XmlSeeAlso(value={SpecialReqDetailsType.SpecialRemarks.SpecialRemark.class})
public class SpecialRemarkType {
    ...
    public List<FlightRefNumber> getFlightRefNumber() {
        if (this.flightRefNumber == null) {
            this.flightRefNumber = new ArrayList<FlightRefNumber>();
        }
    ...
    public List<CompanyNameType> getAirline() {
        if (this.airline == null) {
            this.airline = new ArrayList<CompanyNameType>();
        }
        return this.airline;
    }
    ...
    public void setAuthorizedViewers(AuthorizedViewers value) {
