...
import org.opentravel.ota._2003._05.MeetingRoomCapacityType;
import org.opentravel.ota._2003._05.MeetingRoomCodeType;
...
@XmlSeeAlso(value={FacilityInfoType.MeetingRooms.class})
public class MeetingRoomsType {
    ...
    public List<MeetingRoom> getMeetingRoom() {
        if (this.meetingRoom == null) {
            this.meetingRoom = new ArrayList<MeetingRoom>();
        }
    ...
    public static class MeetingRoom {
        ...
        public void setAvailableCapacities(AvailableCapacities value) {
        ...
        public static class Codes {
            ...
            public List<MeetingRoomCodeType> getCode() {
                if (this.code == null) {
                    this.code = new ArrayList<MeetingRoomCodeType>();
                }
                return this.code;
            }
        }
        ...
        public static class AvailableCapacities {
            ...
            public List<MeetingRoomCapacityType> getMeetingRoomCapacity() {
                if (this.meetingRoomCapacity == null) {
                    this.meetingRoomCapacity = new ArrayList<MeetingRoomCapacityType>();
                }
                return this.meetingRoomCapacity;
            }
        }
