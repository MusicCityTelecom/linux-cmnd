...
import org.opentravel.ota._2003._05.BankAcctType;
...
import org.opentravel.ota._2003._05.HotelPaymentFormType;
import org.opentravel.ota._2003._05.PaymentCardType;
import org.opentravel.ota._2003._05.PaymentDetailType;
import org.opentravel.ota._2003._05.PaymentResponseType;
...
@XmlSeeAlso(value={CustomerType.PaymentForm.class, CompanyInfoType.PaymentForm.class, HotelPaymentFormType.class, PaymentDetailType.class, PaymentResponseType.class, GuaranteeType.GuaranteesAccepted.GuaranteeAccepted.class})
    ...
    public static class Ticket {
        ...
        public List<ConjunctionTicketNbr> getConjunctionTicketNbr() {
            if (this.conjunctionTicketNbr == null) {
                this.conjunctionTicketNbr = new ArrayList<ConjunctionTicketNbr>();
            }
        ...
        public List<String> getCouponRPHs() {
            if (this.couponRPHs == null) {
                this.couponRPHs = new ArrayList<String>();
            }
    ...
    public static class LoyaltyRedemption {
        ...
        public List<LoyaltyCertificate> getLoyaltyCertificate() {
            if (this.loyaltyCertificate == null) {
                this.loyaltyCertificate = new ArrayList<LoyaltyCertificate>();
            }
