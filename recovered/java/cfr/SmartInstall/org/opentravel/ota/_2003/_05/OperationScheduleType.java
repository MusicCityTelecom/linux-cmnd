...
import org.opentravel.ota._2003._05.OperationSchedulePlusChargeType;
import org.opentravel.ota._2003._05.PeriodPriceType;

@XmlAccessorType(value=XmlAccessType.FIELD)
@XmlType(name="OperationScheduleType", propOrder={"operationTimes"})
@XmlSeeAlso(value={OperationSchedulePlusChargeType.class, PeriodPriceType.class})
    ...
    public static class OperationTimes {
        ...
        public List<OperationTime> getOperationTime() {
            if (this.operationTime == null) {
                this.operationTime = new ArrayList<OperationTime>();
            }
