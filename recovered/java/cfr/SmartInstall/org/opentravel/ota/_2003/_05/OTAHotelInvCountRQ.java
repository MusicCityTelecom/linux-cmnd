...
@XmlType(name="", propOrder={"pos", "hotelInvCountRequests"})
...
public class OTAHotelInvCountRQ {
    ...
    protected HotelInvCountRequests hotelInvCountRequests;
    ...
    public HotelInvCountRequests getHotelInvCountRequests() {
        return this.hotelInvCountRequests;
    }

    public void setHotelInvCountRequests(HotelInvCountRequests value) {
    ...
    @XmlAccessorType(value=XmlAccessType.FIELD)
    @XmlType(name="", propOrder={"hotelInvCountRequest"})
    public static class HotelInvCountRequests {
        @XmlElement(name="HotelInvCountRequest", required=true)
        protected List<HotelInvCountRequest> hotelInvCountRequest;

        public List<HotelInvCountRequest> getHotelInvCountRequest() {
            if (this.hotelInvCountRequest == null) {
                this.hotelInvCountRequest = new ArrayList<HotelInvCountRequest>();
            }
            return this.hotelInvCountRequest;
        }

        @XmlAccessorType(value=XmlAccessType.FIELD)
        @XmlType(name="", propOrder={"dateRange", "roomTypeCandidates", "hotelRef", "tpaExtensions"})
