...
import org.opentravel.ota._2003._05.TransportInfoType;

@XmlAccessorType(value=XmlAccessType.FIELD)
@XmlType(name="ResGuestType", propOrder={"profiles", "specialRequests", "comments", "serviceRPHs", "profileRPHs", "arrivalTransport", "departureTransport", "guestCounts", "inHouseTimeSpan", "tpaExtensions"})
public class ResGuestType {
    ...
    public void setProfileRPHs(ProfileRPHs value) {
    ...
    public static class ProfileRPHs {
        ...
        public List<ProfileRPH> getProfileRPH() {
            if (this.profileRPH == null) {
                this.profileRPH = new ArrayList<ProfileRPH>();
            }
