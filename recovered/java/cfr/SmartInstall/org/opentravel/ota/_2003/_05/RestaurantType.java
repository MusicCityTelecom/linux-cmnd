...
import org.opentravel.ota._2003._05.RestaurantsType;

@XmlAccessorType(value=XmlAccessType.FIELD)
@XmlType(name="RestaurantType", propOrder={"multimediaDescriptions", "relativePosition", "operationSchedules", "infoCodes", "cuisineCodes", "descriptiveText"})
@XmlSeeAlso(value={RestaurantsType.Restaurant.class})
public class RestaurantType {
    ...
    public void setInfoCodes(InfoCodes value) {
    ...
    public void setCuisineCodes(CuisineCodes value) {
    ...
    public static class InfoCodes {
        ...
        public List<InfoCode> getInfoCode() {
            if (this.infoCode == null) {
                this.infoCode = new ArrayList<InfoCode>();
            }
    ...
    public static class CuisineCodes {
        ...
        public List<CuisineCode> getCuisineCode() {
            if (this.cuisineCode == null) {
                this.cuisineCode = new ArrayList<CuisineCode>();
            }
