...
import org.opentravel.ota._2003._05.CommonPrefType;
import org.opentravel.ota._2003._05.HotelPrefType;
import org.opentravel.ota._2003._05.OtherSrvcPrefType;
import org.opentravel.ota._2003._05.TPAExtensionsType;
import org.opentravel.ota._2003._05.VehicleProfileRentalPrefType;
...
public class PreferencesType {
    ...
    public List<PrefCollection> getPrefCollection() {
        if (this.prefCollection == null) {
            this.prefCollection = new ArrayList<PrefCollection>();
        }
    ...
    public static class PrefCollection {
        ...
        public List<CommonPrefType> getCommonPref() {
            if (this.commonPref == null) {
                this.commonPref = new ArrayList<CommonPrefType>();
            }
        ...
        public List<VehicleProfileRentalPrefType> getVehicleRentalPref() {
            if (this.vehicleRentalPref == null) {
                this.vehicleRentalPref = new ArrayList<VehicleProfileRentalPrefType>();
            }
        ...
        public List<AirlinePrefType> getAirlinePref() {
            if (this.airlinePref == null) {
                this.airlinePref = new ArrayList<AirlinePrefType>();
            }
        ...
        public List<HotelPrefType> getHotelPref() {
            if (this.hotelPref == null) {
                this.hotelPref = new ArrayList<HotelPrefType>();
            }
        ...
        public List<OtherSrvcPrefType> getOtherSrvcPref() {
            if (this.otherSrvcPref == null) {
                this.otherSrvcPref = new ArrayList<OtherSrvcPrefType>();
            }
