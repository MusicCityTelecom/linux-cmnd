...
@XmlType(name="VehicleRetrieveResRQAdditionalInfoType", propOrder={"pickUpLocation", "returnLocation", "telephone", "vendor", "vehPref", "email", "remark", "searchDateRange", "tpaExtensions"})
@XmlSeeAlso(value={OTAVehRetResRQ.VehRetResRQInfo.class})
public class VehicleRetrieveResRQAdditionalInfoType {
    ...
    protected List<SearchDateRange> searchDateRange;
    ...
    public List<SearchDateRange> getSearchDateRange() {
        if (this.searchDateRange == null) {
            this.searchDateRange = new ArrayList<SearchDateRange>();
        }
