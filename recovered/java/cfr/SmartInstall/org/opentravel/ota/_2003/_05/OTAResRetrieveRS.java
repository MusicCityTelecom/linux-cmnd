...
import org.opentravel.ota._2003._05.CruiseReservationType;
...
import org.opentravel.ota._2003._05.RailReservationSummaryType;
...
public class OTAResRetrieveRS {
    ...
    @XmlAccessorType(value=XmlAccessType.FIELD)
    @XmlType(name="", propOrder={"airReservation", "hotelReservation", "packageReservation", "golfReservation", "vehicleReservation", "globalReservation", "cruiseReservation", "railReservation"})
    public static class ReservationsList {
        ...
        public List<AirReservation> getAirReservation() {
            if (this.airReservation == null) {
                this.airReservation = new ArrayList<AirReservation>();
            }
        ...
        public List<HotelReservationType> getHotelReservation() {
            if (this.hotelReservation == null) {
                this.hotelReservation = new ArrayList<HotelReservationType>();
            }
            return this.hotelReservation;
        }

        public List<PackageReservation> getPackageReservation() {
            if (this.packageReservation == null) {
                this.packageReservation = new ArrayList<PackageReservation>();
            }
            return this.packageReservation;
        }

        public List<GolfReservation> getGolfReservation() {
            if (this.golfReservation == null) {
                this.golfReservation = new ArrayList<GolfReservation>();
            }
        ...
        public List<VehicleReservation> getVehicleReservation() {
            if (this.vehicleReservation == null) {
                this.vehicleReservation = new ArrayList<VehicleReservation>();
            }
            return this.vehicleReservation;
        }

        public List<GlobalReservation> getGlobalReservation() {
            if (this.globalReservation == null) {
                this.globalReservation = new ArrayList<GlobalReservation>();
            }
        ...
        public List<CruiseReservationType> getCruiseReservation() {
            if (this.cruiseReservation == null) {
                this.cruiseReservation = new ArrayList<CruiseReservationType>();
            }
        ...
        public List<RailReservationSummaryType> getRailReservation() {
            if (this.railReservation == null) {
                this.railReservation = new ArrayList<RailReservationSummaryType>();
            }
        ...
        public static class VehicleReservation {
            ...
            public List<VehicleReservationSummaryType> getVehResSummary() {
                if (this.vehResSummary == null) {
                    this.vehResSummary = new ArrayList<VehicleReservationSummaryType>();
                }
        ...
        public static class AirReservation {
            ...
            public List<PersonNameType> getTravelerName() {
                if (this.travelerName == null) {
                    this.travelerName = new ArrayList<PersonNameType>();
                }
                return this.travelerName;
            }
            ...
            public List<String> getSupplierBookingInfoList() {
                if (this.supplierBookingInfoList == null) {
                    this.supplierBookingInfoList = new ArrayList<String>();
                }
