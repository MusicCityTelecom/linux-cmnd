...
@XmlSeeAlso(value={HTNGPaymentCardType.class, DonationType.CreditCardInfo.class})
public class PaymentCardType {
    ...
    public void setSignatureOnFile(SignatureOnFile value) {
    ...
    public void setMagneticStripe(MagneticStripe value) {
