...
@XmlType(name="", propOrder={"success", "warnings", "ratePlanCrossRefs", "errors"})
...
public class OTAHotelRatePlanNotifRS {
    ...
    protected RatePlanCrossRefs ratePlanCrossRefs;
    ...
    public RatePlanCrossRefs getRatePlanCrossRefs() {
        return this.ratePlanCrossRefs;
    }

    public void setRatePlanCrossRefs(RatePlanCrossRefs value) {
    ...
    @XmlAccessorType(value=XmlAccessType.FIELD)
    @XmlType(name="", propOrder={"ratePlanCrossRef"})
    public static class RatePlanCrossRefs {
        @XmlElement(name="RatePlanCrossRef", required=true)
        protected List<RatePlanCrossRef> ratePlanCrossRef;

        public List<RatePlanCrossRef> getRatePlanCrossRef() {
            if (this.ratePlanCrossRef == null) {
                this.ratePlanCrossRef = new ArrayList<RatePlanCrossRef>();
            }
