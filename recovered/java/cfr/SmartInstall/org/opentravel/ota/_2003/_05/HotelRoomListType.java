...
import org.opentravel.ota._2003._05.RoomSharesType;
...
public class HotelRoomListType {
    ...
    public void setMasterContact(MasterContact value) {
    ...
    public void setMasterAccount(MasterAccount value) {
    ...
    extends ContactPersonType {
        ...
        public void setUniqueIDs(UniqueIDs value) {
            this.uniqueIDs = value;
        }

        public List<Loyalty> getLoyalty() {
            if (this.loyalty == null) {
                this.loyalty = new ArrayList<Loyalty>();
            }
            return this.loyalty;
        }
        ...
        extends ContactPersonType {
            ...
            public List<GuaranteePayment> getGuaranteePayment() {
                if (this.guaranteePayment == null) {
                    this.guaranteePayment = new ArrayList<GuaranteePayment>();
                }
