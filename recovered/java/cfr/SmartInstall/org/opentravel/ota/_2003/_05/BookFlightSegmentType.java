...
@XmlSeeAlso(value={OriginDestinationOptionType.FlightSegment.class, PTCFareBreakdownType.PricingUnit.FareComponent.FlightLeg.class})
...
extends FlightSegmentType {
    ...
    public List<BookingClassAvails> getBookingClassAvails() {
        if (this.bookingClassAvails == null) {
            this.bookingClassAvails = new ArrayList<BookingClassAvails>();
        }
    ...
    public static class BookingClassAvails {
        ...
        public List<BookingClassAvail> getBookingClassAvail() {
            if (this.bookingClassAvail == null) {
                this.bookingClassAvail = new ArrayList<BookingClassAvail>();
            }
