...
public class OTAHotelAvailGetRQ {
    ...
    protected HotelAvailRequests hotelAvailRequests;
    ...
    public HotelAvailRequests getHotelAvailRequests() {
        return this.hotelAvailRequests;
    }

    public void setHotelAvailRequests(HotelAvailRequests value) {
    ...
    public static class HotelAvailRequests {
        ...
        protected List<HotelAvailRequest> hotelAvailRequest;

        public List<HotelAvailRequest> getHotelAvailRequest() {
            if (this.hotelAvailRequest == null) {
                this.hotelAvailRequest = new ArrayList<HotelAvailRequest>();
            }
            return this.hotelAvailRequest;
        }

        @XmlAccessorType(value=XmlAccessType.FIELD)
        @XmlType(name="", propOrder={"dateRange", "destinationSystemsCode", "ratePlanCandidates", "roomTypeCandidates", "offers", "restrictionStatusCandidates", "lengthsOfStayCandidates", "bestAvailableRateCandidate", "hurdleRateCandidate", "deltaCandidate", "hotelRef", "rebatePrograms", "tpaExtensions"})
        public static class HotelAvailRequest {
            ...
            protected RoomTypeCandidates roomTypeCandidates;
            @XmlElement(name="Offers")
            protected Offers offers;
            @XmlElement(name="RestrictionStatusCandidates")
            protected RestrictionStatusCandidates restrictionStatusCandidates;
            @XmlElement(name="LengthsOfStayCandidates")
            protected LengthsOfStayCandidates lengthsOfStayCandidates;
            @XmlElement(name="BestAvailableRateCandidate")
            protected BestAvailableRateCandidate bestAvailableRateCandidate;
            @XmlElement(name="HurdleRateCandidate")
            protected HurdleRateCandidate hurdleRateCandidate;
            @XmlElement(name="DeltaCandidate")
            protected DeltaCandidate deltaCandidate;
            ...
            public RoomTypeCandidates getRoomTypeCandidates() {
                return this.roomTypeCandidates;
            }

            public void setRoomTypeCandidates(RoomTypeCandidates value) {
            ...
            public RestrictionStatusCandidates getRestrictionStatusCandidates() {
                return this.restrictionStatusCandidates;
            }

            public void setRestrictionStatusCandidates(RestrictionStatusCandidates value) {
                this.restrictionStatusCandidates = value;
            }

            public LengthsOfStayCandidates getLengthsOfStayCandidates() {
                return this.lengthsOfStayCandidates;
            }

            public void setLengthsOfStayCandidates(LengthsOfStayCandidates value) {
                this.lengthsOfStayCandidates = value;
            }

            public BestAvailableRateCandidate getBestAvailableRateCandidate() {
                return this.bestAvailableRateCandidate;
            }

            public void setBestAvailableRateCandidate(BestAvailableRateCandidate value) {
                this.bestAvailableRateCandidate = value;
            }

            public HurdleRateCandidate getHurdleRateCandidate() {
                return this.hurdleRateCandidate;
            }

            public void setHurdleRateCandidate(HurdleRateCandidate value) {
                this.hurdleRateCandidate = value;
            }

            public DeltaCandidate getDeltaCandidate() {
                return this.deltaCandidate;
            }

            public void setDeltaCandidate(DeltaCandidate value) {
            ...
            public static class RoomTypeCandidates {
                ...
                protected List<RoomTypeCandidate> roomTypeCandidate;

                public List<RoomTypeCandidate> getRoomTypeCandidate() {
                    if (this.roomTypeCandidate == null) {
                        this.roomTypeCandidate = new ArrayList<RoomTypeCandidate>();
                    }
            ...
            public static class RestrictionStatusCandidates {
                ...
                protected List<RestrictionStatusCandidate> restrictionStatusCandidate;
                @XmlAttribute(name="SendAllRestrictions")
                protected Boolean sendAllRestrictions;

                public List<RestrictionStatusCandidate> getRestrictionStatusCandidate() {
                    if (this.restrictionStatusCandidate == null) {
                        this.restrictionStatusCandidate = new ArrayList<RestrictionStatusCandidate>();
                    }
            ...
            public static class LengthsOfStayCandidates {
                ...
                protected List<LengthOfStayCandidate> lengthOfStayCandidate;
                ...
                public List<LengthOfStayCandidate> getLengthOfStayCandidate() {
                    if (this.lengthOfStayCandidate == null) {
                        this.lengthOfStayCandidate = new ArrayList<LengthOfStayCandidate>();
                    }
