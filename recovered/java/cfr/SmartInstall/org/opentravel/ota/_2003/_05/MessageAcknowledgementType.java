...
@XmlType(name="MessageAcknowledgementType", propOrder={"success", "warnings", "errors", "uniqueID", "tpaExtensions"})
@XmlSeeAlso(value={OTANotifReportRQ.class, OTAHotelInvCountNotifRS.class})
