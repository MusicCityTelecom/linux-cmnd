...
@XmlType(name="HotelSearchCriterionType", propOrder={"hotelAmenity", "roomAmenity", "hotelFeature", "award", "recreation", "service", "transportation", "stayDateRange", "rateRange", "ratePlanCandidates", "profiles", "roomStayCandidates", "acceptedPayments", "media", "hotelMeetingFacility", "mealPlan", "rebatePrograms", "tpaExtensions"})
@XmlSeeAlso(value={HotelSearchCriteriaType.Criterion.class})
...
extends ItemSearchCriterionType {
    ...
    protected HotelMeetingFacility hotelMeetingFacility;
    ...
    public List<HotelFeature> getHotelFeature() {
        if (this.hotelFeature == null) {
            this.hotelFeature = new ArrayList<HotelFeature>();
        }
    ...
    public HotelMeetingFacility getHotelMeetingFacility() {
        return this.hotelMeetingFacility;
    }

    public void setHotelMeetingFacility(HotelMeetingFacility value) {
    ...
    public static class RoomStayCandidates {
        ...
        public List<RoomStayCandidateType> getRoomStayCandidate() {
            if (this.roomStayCandidate == null) {
                this.roomStayCandidate = new ArrayList<RoomStayCandidateType>();
            }
