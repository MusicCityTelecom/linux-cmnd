...
public class CruiseReservationType {
    ...
    public List<CruiseProfileType> getSailingProfile() {
        if (this.sailingProfile == null) {
            this.sailingProfile = new ArrayList<CruiseProfileType>();
        }
    ...
    public void setPaymentsDue(PaymentsDue value) {
        this.paymentsDue = value;
    }

    public List<ParagraphType> getInformation() {
        if (this.information == null) {
            this.information = new ArrayList<ParagraphType>();
        }
    ...
    public static class PaymentsDue {
        ...
        protected List<PaymentDue> paymentDue;

        public List<PaymentDue> getPaymentDue() {
            if (this.paymentDue == null) {
                this.paymentDue = new ArrayList<PaymentDue>();
            }
