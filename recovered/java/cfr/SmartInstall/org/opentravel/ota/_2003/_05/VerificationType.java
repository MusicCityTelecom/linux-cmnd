...
@XmlSeeAlso(value={HotelResModifyType.HotelResModify.Verification.class})
public class VerificationType {
    ...
    public List<CompanyNameType> getVendor() {
        if (this.vendor == null) {
            this.vendor = new ArrayList<CompanyNameType>();
        }
        return this.vendor;
    }
    ...
    public List<AssociatedQuantity> getAssociatedQuantity() {
        if (this.associatedQuantity == null) {
            this.associatedQuantity = new ArrayList<AssociatedQuantity>();
        }
