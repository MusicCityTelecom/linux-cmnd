...
import org.opentravel.ota._2003._05.RailAvailPrefsType;
import org.opentravel.ota._2003._05.RailAvailScheduleQueryType;
...
public class RailAvailQueryType {
    ...
    public List<RailAvailScheduleQueryType> getAvailBaseQueryCriteria() {
        if (this.availBaseQueryCriteria == null) {
            this.availBaseQueryCriteria = new ArrayList<RailAvailScheduleQueryType>();
        }
    ...
    public List<PassengerType> getPassengerType() {
        if (this.passengerType == null) {
            this.passengerType = new ArrayList<PassengerType>();
        }
