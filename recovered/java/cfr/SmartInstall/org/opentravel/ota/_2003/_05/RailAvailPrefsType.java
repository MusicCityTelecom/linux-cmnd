...
import org.opentravel.ota._2003._05.RailAmenityType;
...
public class RailAvailPrefsType {
    ...
    protected List<TransportModes> transportModes;
    ...
    public List<CompanyNamePrefType> getOperatorPref() {
        if (this.operatorPref == null) {
            this.operatorPref = new ArrayList<CompanyNamePrefType>();
        }
        return this.operatorPref;
    }

    public List<TransportModes> getTransportModes() {
        if (this.transportModes == null) {
            this.transportModes = new ArrayList<TransportModes>();
        }
    ...
    public List<DiscountType> getDiscountType() {
        if (this.discountType == null) {
            this.discountType = new ArrayList<DiscountType>();
        }
    ...
    public List<ClassCodeType> getClassCodes() {
        if (this.classCodes == null) {
            this.classCodes = new ArrayList<ClassCodeType>();
        }
