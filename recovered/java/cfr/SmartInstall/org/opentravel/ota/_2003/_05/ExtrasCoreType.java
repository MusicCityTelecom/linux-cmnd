...
import org.opentravel.ota._2003._05.ExtrasInfoType;
import org.opentravel.ota._2003._05.ExtrasType;

@XmlAccessorType(value=XmlAccessType.FIELD)
@XmlType(name="ExtrasCoreType", propOrder={"subCategory"})
@XmlSeeAlso(value={ExtrasInfoType.class, ExtrasType.class})
public class ExtrasCoreType {
    ...
    public List<String> getListOfInventoryItemRPH() {
        if (this.listOfInventoryItemRPH == null) {
            this.listOfInventoryItemRPH = new ArrayList<String>();
        }
    ...
    public List<String> getListofRoomRPH() {
        if (this.listofRoomRPH == null) {
            this.listofRoomRPH = new ArrayList<String>();
        }
