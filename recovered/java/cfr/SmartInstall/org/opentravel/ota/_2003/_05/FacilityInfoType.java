...
import org.opentravel.ota._2003._05.MeetingRoomsType;
...
public class FacilityInfoType {
    ...
    public void setMeetingRooms(MeetingRooms value) {
    ...
    public static class GuestRooms {
        ...
        public List<GuestRoom> getGuestRoom() {
            if (this.guestRoom == null) {
                this.guestRoom = new ArrayList<GuestRoom>();
            }
        ...
        public static class GuestRoom {
            ...
            protected List<TypeRoom> typeRoom;
            ...
            public List<TypeRoom> getTypeRoom() {
                if (this.typeRoom == null) {
                    this.typeRoom = new ArrayList<TypeRoom>();
                }
