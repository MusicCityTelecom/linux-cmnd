...
@XmlType(name="ItemSearchCriterionType", propOrder={"position", "address", "telephone", "refPoint", "codeRef", "hotelRef", "radius", "mapArea", "additionalContents"})
@XmlSeeAlso(value={HotelSearchCriterionType.class})
public class ItemSearchCriterionType {
    ...
    protected AdditionalContents additionalContents;
    ...
    public List<RefPoint> getRefPoint() {
        if (this.refPoint == null) {
            this.refPoint = new ArrayList<RefPoint>();
        }
    ...
    public void setAdditionalContents(AdditionalContents value) {
    ...
    public static class AdditionalContents {
        ...
        public List<AdditionalContent> getAdditionalContent() {
            if (this.additionalContent == null) {
                this.additionalContent = new ArrayList<AdditionalContent>();
            }
