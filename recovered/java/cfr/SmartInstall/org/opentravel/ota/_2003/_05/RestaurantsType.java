...
public class RestaurantsType {
    ...
    public void setSrvcInfoCodes(SrvcInfoCodes value) {
    ...
    public static class SrvcInfoCodes {
        ...
        protected List<SrvcInfoCode> srvcInfoCode;

        public List<SrvcInfoCode> getSrvcInfoCode() {
            if (this.srvcInfoCode == null) {
                this.srvcInfoCode = new ArrayList<SrvcInfoCode>();
            }
