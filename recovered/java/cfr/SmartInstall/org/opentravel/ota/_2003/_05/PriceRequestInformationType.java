...
@XmlSeeAlso(value={TravelerInfoSummaryType.PriceRequestInformation.class})
public class PriceRequestInformationType {
    ...
    public List<NegotiatedFareCode> getNegotiatedFareCode() {
        if (this.negotiatedFareCode == null) {
            this.negotiatedFareCode = new ArrayList<NegotiatedFareCode>();
        }
    ...
    public List<RebookOption> getRebookOption() {
        if (this.rebookOption == null) {
            this.rebookOption = new ArrayList<RebookOption>();
        }
