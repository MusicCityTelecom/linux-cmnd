...
@XmlType(name="AuthorizationType", propOrder={"checkAuthorization", "creditCardAuthorization", "accountAuthorization", "driversLicenseAuthorization", "bookingReferenceID"})
public class AuthorizationType {
    ...
    public void setCheckAuthorization(CheckAuthorization value) {
    ...
    public void setAccountAuthorization(AccountAuthorization value) {
