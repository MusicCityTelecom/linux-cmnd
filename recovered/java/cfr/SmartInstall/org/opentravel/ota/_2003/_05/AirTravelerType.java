...
@XmlType(name="AirTravelerType", propOrder={"profileRef", "personName", "telephone", "email", "address", "custLoyalty", "document", "passengerTypeQuantity", "travelerRefNumber", "flightSegmentRPHs"})
@XmlSeeAlso(value={TravelerInfoType.AirTraveler.class})
public class AirTravelerType {
    ...
    public static class FlightSegmentRPHs {
        ...
        public List<String> getFlightSegmentRPH() {
            if (this.flightSegmentRPH == null) {
                this.flightSegmentRPH = new ArrayList<String>();
            }
