...
import org.opentravel.ota._2003._05.StatisticApplicationSetType;
...
public class StatisticType {
    ...
    protected StatisticApplicationSets statisticApplicationSets;
    ...
    public StatisticApplicationSets getStatisticApplicationSets() {
        return this.statisticApplicationSets;
    }

    public void setStatisticApplicationSets(StatisticApplicationSets value) {
    ...
    public static class StatisticApplicationSets {
        ...
        public List<StatisticApplicationSetType> getStatisticApplicationSet() {
            if (this.statisticApplicationSet == null) {
                this.statisticApplicationSet = new ArrayList<StatisticApplicationSetType>();
            }
