...
import org.opentravel.ota._2003._05.VehicleLocationAdditionalFeesType;

@XmlAccessorType(value=XmlAccessType.FIELD)
@XmlType(name="VehicleChargeType", propOrder={"taxAmounts", "minMax", "calculation"})
@XmlSeeAlso(value={VehicleChargePurposeType.class, VehicleLocationAdditionalFeesType.Fees.Fee.class, VehicleLocationAdditionalFeesType.Surcharges.Surcharge.class, VehicleLocationAdditionalFeesType.MiscellaneousCharges.MiscellaneousCharge.class})
public class VehicleChargeType {
    ...
    public void setTaxAmounts(TaxAmounts value) {
    ...
    public List<Calculation> getCalculation() {
        if (this.calculation == null) {
            this.calculation = new ArrayList<Calculation>();
        }
