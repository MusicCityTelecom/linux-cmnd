...
@XmlSeeAlso(value={HTNGProfileMessageStatusNotifRQ.ProfileMessages.ProfileMessage.class, HTNGProfileMessageRS.ProfileMessages.ProfileMessage.class, CommentType.Comment.class, SpecialRequestType.SpecialRequest.class, ProfileType.Comments.Comment.class, InvBlockType.BlockDescriptions.BlockDescription.class, AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramDescription.class, AffiliationInfoType.LoyalPrograms.LoyalProgram.ProgramRestriction.class, DescriptionType.class})
public class ParagraphType {
    @XmlElementRefs(value={@XmlElementRef(name="Text", namespace="http://www.opentravel.org/OTA/2003/05", type=JAXBElement.class, required=false), @XmlElementRef(name="Image", namespace="http://www.opentravel.org/OTA/2003/05", type=JAXBElement.class, required=false), @XmlElementRef(name="URL", namespace="http://www.opentravel.org/OTA/2003/05", type=JAXBElement.class, required=false), @XmlElementRef(name="ListItem", namespace="http://www.opentravel.org/OTA/2003/05", type=JAXBElement.class, required=false)})
