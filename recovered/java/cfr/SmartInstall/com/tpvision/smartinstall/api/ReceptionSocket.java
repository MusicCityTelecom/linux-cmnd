...
@ServerEndpoint(value="/api/reception/socket")
public class ReceptionSocket {
    private static final Logger log = LoggerFactory.getLogger(ReceptionSocket.class);
    private static final Set<ReceptionSocket> connections = new CopyOnWriteArraySet<ReceptionSocket>();
    ...
    private static void broadcast(String msg) {
        for (ReceptionSocket client : connections) {
            try {
                ReceptionSocket receptionSocket = client;
                synchronized (receptionSocket) {
    ...
    public static void notifyPmsGuestInfoUpdate() {
        ...
        ReceptionSocket.broadcast(obj.toString());
    }
