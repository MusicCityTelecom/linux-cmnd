...
public class ReceptionController {
    ...
    private GatewayManager.GatewayState formatGatewayState() {
        ...
        if (!PlayoutUtils.getInstance().isPlayoutStopped()) {
            ...
            } else if (GatewayManager.getInstance().getState() == GatewayManager.GatewayState.STARTING || GatewayManager.getInstance().getState() == GatewayManager.GatewayState.INITIATING || GatewayManager.getInstance().getState() == GatewayManager.GatewayState.IDLE) {
