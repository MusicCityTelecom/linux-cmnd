...
public class ConfigurationGenerator {
    ...
    public static void generate(Map<String, String> parameters) {
        ...
        Config conf = ConfigurationGenerator.loadConfig();
        ...
        LOG.info("processTSCreation-> cpCatalog -> 0001 ConfigurationGenerator platformId = {}", (Object)platformId);
        ...
        if (null != conf) {
            ...
            ConfigurationGenerator.generate(conf);
        }
    }
    ...
    private static void generate(Config conf) {
        try {
            ...
            String configFileLocation = ConfigurationGenerator.getConfigFile();
            File output = new File(configFileLocation);
            marshaller.marshal((Object)conf, output);
        }
    ...
    private static Config loadConfig() {
        ...
        try {
            ...
            File file = new File(ConfigurationGenerator.getConfigFile());
