...
public final class CommonConstants {
    ...
    public static final List<Integer> TV_WIXP_ALL_PORTS = Collections.unmodifiableList(Stream.of(TV_WIXP_HTTPS_PORTS, TV_WIXP_HTTP_PORTS).flatMap(Collection::stream).collect(Collectors.toList()));
    ...
    public static final String[] cloneItems = new String[]{"TVSettings", "ChannelList", "WelcomeLogo", "SmartInfoShow", "SmartInfoBrowser", "AndroidApps", "RoomSpecificSettings", "LocalCustomDashboard", "Script", "MediaChannels", "WeatherForecast", "HTVCfg", "Banner", "PMS", "AndroidAppsData", "ProfessionalApps", "ProfessionalAppsData", "Schedules", "MyChoice", "Vsecure"};
    ...
    public static enum CloneItemType {
        AndroidApps,
        ChannelList,
        LocalCustomDashboard,
        MediaChannels,
