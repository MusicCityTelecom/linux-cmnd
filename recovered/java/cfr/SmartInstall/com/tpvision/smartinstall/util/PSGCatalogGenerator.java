...
import com.tpvision.smartinstall.util.PSGCatalogGeneratorService;
...
public class PSGCatalogGenerator {
    ...
    public static void generateCatalog(String platformId, String versionFolder, HashMap<String, String> output) {
        PSGCatalogGeneratorService srv = CatalogFactory.get(platformId, versionFolder, output);
        if (null != srv) {
    ...
    public static void GenMediaEasySuite_2K15_MediaSuite(String productName, String upgPath, String versionFolder, String hasPlayOut) {
        if (hasPlayOut.equalsIgnoreCase("CF")) {
            ...
            PSGCatalogGenerator.catalogFileGen(catalog);
    ...
    public static void GenMediaEasySuite(String productName, String upgPath, String versionFolder, String hasPlayOut) {
        if (productName.contains("2K15_MediaSuite")) {
            PSGCatalogGenerator.GenMediaEasySuite_2K15_MediaSuite(productName, upgPath, versionFolder, hasPlayOut);
    ...
    public static void catalogFileGen(Catalog catalog) {
        try {
            ...
            String catalogFileLocation = PSGCatalogGenerator.getCatalogFileLocation();
            File output = new File(catalogFileLocation);
            marshaller.marshal((Object)catalog, output);
        }
    ...
    public static String getCatalogFileLocation() {
        String ret = null;
        Map<Object, Object> mapEnv = new HashMap();
        try {
        ...
        Set<Object> keys = mapEnv.keySet();
        for (String string : keys) {
            if (!string.equalsIgnoreCase("APPDATA")) continue;
            ret = (String)mapEnv.get(string);
        }
        ret = CommonConstants.SISERVER_PSG_CATALOG_FILE;
        return ret;
    }

    public static class MS2K14CatalogGenerator
    implements PSGCatalogGeneratorService {
    ...
    public static class MS2K15CatalogGenerator
    implements PSGCatalogGeneratorService {
        private String versionFolder = null;
        private HashMap<String, String> outPut = null;
