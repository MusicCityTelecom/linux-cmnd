...
public class Location {
    ...
    public Location(String hotelName, String country, String city, String geonameid, String pin, String addressLine1, String addressLine2, String name, String phoneNumber, String phoneWebsite) {
        this.country = country;
        this.city = city;
        this.geonameid = geonameid;
        this.pin = pin;
