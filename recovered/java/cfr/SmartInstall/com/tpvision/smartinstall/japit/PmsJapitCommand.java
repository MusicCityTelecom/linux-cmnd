...
extends JapitCommand {
    ...
    public static JSONObject getGuestBill(Devices tv, GuestInfo gi, JSONArray billItems) {
        ...
        String balance = Optional.ofNullable(gi.getBalance()).orElseGet(() -> Optional.ofNullable(JpaManager.getBillitemManager().getBillAmount(TpvStringUtils.getPureTvRoomId(gi.getRoomid()))).orElse("0"));
    ...
    public void newGuestBill(Devices tv, GuestInfo gi, JSONArray billItems) {
        JSONObject guestBill = PmsJapitCommand.getGuestBill(tv, gi, billItems);
    ...
    public void updateGuestBill(Devices tv, GuestInfo gi, JSONArray billItems) {
        JSONObject guestBill = PmsJapitCommand.getGuestBill(tv, gi, billItems);
        this.pmsParameters.put("GuestBill", guestBill);
        this.pmsParameters.put("Action", PMSAction.UpdateGuestBill.name());
    }
    ...
    public void updatePMSFeatures(CheckInVO checkinVO) {
        this.pmsParameters.put("PMSFeaturesSupported", PmsJapitCommand.getPmsFeatureSupported(checkinVO));
        this.pmsParameters.put("Action", PMSAction.UpdatePMSFeatures.name());
    }

    public void updateRoomStatus(CheckInVO checkinVO) {
        this.pmsParameters.put("RoomStatus", PmsJapitCommand.getDepartureDate(checkinVO));
        this.pmsParameters.put("Action", PMSAction.RoomStatusUpdate.name());
    }

    public void updateGuestPreference(CheckInVO checkinVO) {
        this.pmsParameters.put("GuestPreferences", PmsJapitCommand.getGuestPreferences(checkinVO));
        this.pmsParameters.put("Action", PMSAction.UpdateGuestPreferences.name());
    }

    public void updateGuestDetails(CheckInVO checkinVO) {
        if (checkinVO.isGuestDetailsEnabled()) {
            this.pmsParameters.put("GuestDetails", PmsJapitCommand.getGuestDetails(checkinVO));
        }
        this.pmsParameters.put("Action", PMSAction.UpdateGuestDetails.name());
    }

    public void checkin(CheckInVO checkinVO) {
        this.pmsParameters.put("Action", PMSAction.CheckIn.name());
        this.pmsParameters.put("PMSFeaturesSupported", PmsJapitCommand.getPmsFeatureSupported(checkinVO));
        this.pmsParameters.put("GuestPreferences", PmsJapitCommand.getGuestPreferences(checkinVO));
        this.pmsParameters.put("RoomStatus", PmsJapitCommand.getRoomStatus(checkinVO));
        if (checkinVO.isGuestDetailsEnabled()) {
            this.pmsParameters.put("GuestDetails", PmsJapitCommand.getGuestDetails(checkinVO));
        }
    }
    ...
    public void checkout() {
        this.pmsParameters.put("Action", PMSAction.CheckOut.name());
        this.pmsParameters.put("PMSFeaturesSupported", PmsJapitCommand.getPmsFeatureSupported(null));
        this.pmsParameters.put("RoomStatus", PmsJapitCommand.getRoomStatus(null));
    }

    public void newGuestMessage(JSONArray array) {
        this.pmsParameters.put("GuestMessages", array);
        this.pmsParameters.put("Action", PMSAction.NewGuestMessage.name());
    }

    public void updateGuestMessage(JSONArray array) {
        this.pmsParameters.put("GuestMessages", array);
        this.pmsParameters.put("Action", PMSAction.UpdateGuestMessage.name());
    }

    public void expressCheckOutError(String reason) {
        this.pmsParameters.put("Action", PMSAction.ExpressCheckOutError.name());
    ...
    public static String responsePmsParameters(CheckInVO checkinVO, JSONObject parameters) {
        PmsJapitCommand cmd = PmsJapitCommand.responsePmsJapitCommand();
    ...
    public static List<String> getGuestBills(Devices tv, GuestInfo gi, JSONArray billItems) {
        ArrayList<String> guestBillList = new ArrayList<String>();
        guestBillList.add(PmsJapitCommand.getNewGuestBill(tv, gi, billItems));
    ...
    public static enum PMSFeatures {
        ...
        private PMSFeatures(String type) {
            this.type = type;
        }
