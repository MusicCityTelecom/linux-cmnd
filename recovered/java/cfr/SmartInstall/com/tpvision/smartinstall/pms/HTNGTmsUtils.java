...
extends TmsUtils {
    ...
    protected void doLoadConfigs() {
        ...
        if (pmsconfigs != null) {
            ...
            LOG.info("pms configs:{}", (Object)config);
    ...
    public String getMappedLanguage(String srcLanguage) {
        if ("en-US".equalsIgnoreCase(srcLanguage) || "zh-Hant".equalsIgnoreCase(srcLanguage) || "zh-TW".equalsIgnoreCase(srcLanguage) || "pt-BR".equalsIgnoreCase(srcLanguage)) {
            return srcLanguage;
        }
        Locale locale = Locale.forLanguageTag(srcLanguage = srcLanguage.split("-")[0].toUpperCase());
        String language = locale.getISO3Language();
        if ("fra".equalsIgnoreCase(language)) {
            language = "fre";
        }
        LOG.info("map language from {} to {}", (Object)srcLanguage, (Object)language);
        if (language == null) {
            LOG.info("language map for {} not found, using default as english", (Object)srcLanguage);
            language = "eng";
        }
        return language;
    }
