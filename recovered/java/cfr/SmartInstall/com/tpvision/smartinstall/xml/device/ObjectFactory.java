...
public class ObjectFactory {
    ...
    public JAXBElement<String> createSW(String value) {
        return new JAXBElement<String>(_SW_QNAME, String.class, null, value);
    }
    ...
    public JAXBElement<String> createCTN(String value) {
        return new JAXBElement<String>(_CTN_QNAME, String.class, null, value);
    }

    @XmlElementDecl(namespace="", name="RID")
    public JAXBElement<BigInteger> createRID(BigInteger value) {
        return new JAXBElement<BigInteger>(_RID_QNAME, BigInteger.class, null, value);
    }
    ...
    public JAXBElement<String> createClone(String value) {
        return new JAXBElement<String>(_Clone_QNAME, String.class, null, value);
    }
}
