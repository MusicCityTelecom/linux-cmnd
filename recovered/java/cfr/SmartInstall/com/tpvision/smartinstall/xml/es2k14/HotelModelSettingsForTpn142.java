...
@XmlType(name="", propOrder={"switchOnSrc", "switchOnChn", "switchOnVol", "maximumVol", "switchOnFeature", "switchOnPicFmt", "powerOn", "lowPowerStandby", "smartPower", "rebootEveryDay", "displayWelcomeMsg", "welcomeMsgLine1", "welcomeMsgLine2", "welcomeMsgTimeOut", "displayLogo", "smartInfo", "smartInfoIconLabel", "kbLock", "rcLock", "osdDisplay", "highSecurity", "autoScart", "usbBreakIn", "enableUSB", "sxpBaudRate", "enableTeletext", "enableMHEG", "enableEPG", "enableSubtitles", "subtitleOnStartup", "blueMute", "enableCISlot", "scrambledProgramOSD", "easylinkBreakIn", "easylinkControl", "digitTimeout", "selectableAV", "watchTV", "externalClk", "clkBrighDimlight", "clkBrighIntenselight", "clkLightSensor", "timeDownload", "timeSetting", "clkDownloadProgram", "clkDownloadCountry", "clkTimeZone", "daylightSaving", "clkTimeOffset", "referenceDate", "referenceTime", "mainSpkrEnable", "indMainSpkrMute", "defMainSpkrVol", "autoChnUpdate", "autoSwUpdate", "skipScrambled", "multiRC", "myChoice", "askForPIN", "smartPay", "av", "vsecOverRFEnable", "eraseKeyOption", "vsecFrequency", "vsecMedium", "vsecSymbolRate", "rfclFrequency", "rfclMedium", "rfclSymbolRate", "upgradeMode", "autoUpgrade", "installationMode", "cloneMultiRC"})
