...
@WebServlet(value={"/CustomerSatisfactionSurvey"})
...
extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String content = "<!DOCTYPE html>\r\n<html>\r\n  <body>\r\n    Hello,\r\n    <p>The guest in room " + roomID + " gave " + star + " stars on the \"" + title + "\" question.\r\n    <p>\r\n      Kind regards,\r\n      <br/>\r\n      CMND\r\n      <br/><b>Ref:" + ApiLicenseChecker.getInstance().getSerialNumber() + "</b>\r\n      <br/>\r\n    </p>\r\n  </body>\r\n</html>";
        if (StringUtils.contains((CharSequence)mailAddress, "@")) {
            EmailUtils.sendEmailByAmazonService(subject, content, mailAddress);
        } else {
            LOG.warn("no valid email<{}> need to be sent", (Object)mailAddress);
        }
