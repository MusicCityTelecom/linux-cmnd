...
import com.tpvision.smartinstall.xml.channel.v6.TvContents;
...
public class SettingChannelBean {
    ...
    private com.tpvision.smartinstall.xml.channel.v4.TvContents v4Channel;
    private TvContents v5Channel;
    ...
    public SettingChannelBean(Settings setttings, com.tpvision.smartinstall.xml.channel.v4.TvContents v4Channel, TvContents v5Channel, String channelVersion, DIAGNOSTICANALYTIC diagnosticAnalytic, RoomSpecificSettings roomSpecificSettings) {
    ...
    public void updateThemeTvs(JSONObject themeTvObj) {
        switch (this.channelVersion.toLowerCase()) {
            ...
            case "v6": {
                TvContents.ThemeTV v6themetv = new Gson().fromJson(themeTvObj.toString(), TvContents.ThemeTV.class);
    ...
    public JSONObject getThemeTvJson() {
        ...
        switch (this.channelVersion.toLowerCase()) {
            ...
            case "v6": {
                TvContents.ThemeTV v6themetv = this.getV6Channel().getThemeTV();
    ...
    public String getChannelClassName() {
        ...
        switch (this.channelVersion.toLowerCase()) {
            ...
            case "v6": {
                channelClass = TvContents.ChannelMap.Channel.class.getName();
                break;
            }
        }
        return channelClass;
    ...
    public List channelListFromJson(String json) {
        ...
        switch (this.channelVersion.toLowerCase()) {
            case "v4": {
                newList = (List)new Gson().fromJson(json, new TypeToken<List<Channel>>(){}.getType());
                break;
            }
            case "v5": {
                newList = (List)new Gson().fromJson(json, new TypeToken<List<com.tpvision.smartinstall.xml.channel.v5.Channel>>(){}.getType());
                break;
            }
            case "v6": {
                newList = (List)new Gson().fromJson(json, new TypeToken<List<TvContents.ChannelMap.Channel>>(){}.getType());
                break;
            }
        }
        return newList;
    ...
    public List applicationListFromJson(String json) {
        ...
        switch (this.channelVersion.toLowerCase()) {
            case "v4": {
                newList = (List)new Gson().fromJson(json, new TypeToken<List<Application>>(){}.getType());
                break;
            }
            case "v5": {
                newList = (List)new Gson().fromJson(json, new TypeToken<List<com.tpvision.smartinstall.xml.channel.v5.Application>>(){}.getType());
                break;
            }
            case "v6": {
                newList = (List)new Gson().fromJson(json, new TypeToken<List<TvContents.ApplicationMap.Application>>(){}.getType());
                break;
            }
        }
        return newList;
    ...
    public TvContents getV5Channel() {
        return this.v5Channel;
    }

    public void setV5Channel(TvContents vChannel) {
        this.v5Channel = vChannel;
    }

    public com.tpvision.smartinstall.xml.channel.v4.TvContents getV4Channel() {
        return this.v4Channel;
    }

    public void setV4Channel(com.tpvision.smartinstall.xml.channel.v4.TvContents v4Channel) {
        this.v4Channel = v4Channel;
    }
}
