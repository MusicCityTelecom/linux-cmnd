...
implements EntityTuplizer {
    ...
    protected void linkToSession(Object entity, SharedSessionContractImplementor session) {
        ...
        if (entity instanceof PersistentAttributeInterceptable && (interceptor = this.getEntityMetamodel().getBytecodeEnhancementMetadata().extractLazyInterceptor(entity)) != null) {
