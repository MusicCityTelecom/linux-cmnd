...
extends ProxyVisitor {
    ...
    final Object processArrayOrNewCollection(Object collection, CollectionType collectionType) throws HibernateException {
        ...
        if (this.entity instanceof PersistentAttributeInterceptable && ((PersistentAttributeInterceptable)this.entity).$$_hibernate_getInterceptor() instanceof EnhancementAsProxyLazinessInterceptor) {
            return null;
        }
