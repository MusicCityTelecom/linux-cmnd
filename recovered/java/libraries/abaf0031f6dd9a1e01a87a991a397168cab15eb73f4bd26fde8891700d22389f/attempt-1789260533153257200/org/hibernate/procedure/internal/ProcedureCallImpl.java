...
ResultContext {
    ...
    public ProcedureCallImplementor<R> setParameter(String name, Object value) {
        this.paramBindings.getBinding(this.getParameterMetadata().getQueryParameter(name)).setBindValue(value);
        return this;
    }

    @Override
    public ProcedureCallImplementor<R> setParameter(int position, Object value) {
        this.paramBindings.getBinding(this.getParameterMetadata().getQueryParameter(position)).setBindValue(value);
        return this;
    }
