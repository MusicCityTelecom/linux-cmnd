    ...
    private boolean isUnequivocallyNonDirty(Object entity) {
        ...
        if (entity instanceof SelfDirtinessTracker) {
            ...
            if (entity instanceof PersistentAttributeInterceptable) {
                PersistentAttributeInterceptable interceptable2 = (PersistentAttributeInterceptable)entity;
            ...
            return uninitializedProxy || !this.persister.hasCollections() && !this.persister.hasMutableProperties() && !((SelfDirtinessTracker)entity).$$_hibernate_hasDirtyAttributes();
        }
        if (entity instanceof PersistentAttributeInterceptable && (interceptor = (interceptable = (PersistentAttributeInterceptable)entity).$$_hibernate_getInterceptor()) instanceof EnhancementAsProxyLazinessInterceptor) {
            return true;
        }
