...
implements PersistenceContext {
    ...
    public void clear() {
        ...
        for (Map.Entry<Object, EntityEntry> objectEntityEntryEntry : this.entityEntryContext.reentrantSafeEntityEntries()) {
            ...
            if (!(objectEntityEntryEntry.getKey() instanceof PersistentAttributeInterceptable) || !((interceptor = ((PersistentAttributeInterceptable)objectEntityEntryEntry.getKey()).$$_hibernate_getInterceptor()) instanceof LazyAttributeLoadingInterceptor)) continue;
    ...
    public boolean reassociateIfUninitializedProxy(Object value) throws MappingException {
        if (!Hibernate.isInitialized(value)) {
            ...
            if (value instanceof PersistentAttributeInterceptable) {
                PersistentAttributeInterceptable bytecodeProxy = (PersistentAttributeInterceptable)value;
                BytecodeLazyAttributeInterceptor interceptor = (BytecodeLazyAttributeInterceptor)bytecodeProxy.$$_hibernate_getInterceptor();
                if (interceptor != null) {
    ...
    public Object unproxyAndReassociate(Object maybeProxy) throws HibernateException {
        ...
        if (maybeProxy instanceof PersistentAttributeInterceptable) {
            PersistentAttributeInterceptable interceptable = (PersistentAttributeInterceptable)maybeProxy;
    ...
    public void initializeNonLazyCollections() throws HibernateException {
        this.initializeNonLazyCollections(PersistentCollection::forceInitialization);
    }
