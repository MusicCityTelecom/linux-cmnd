...
ParameterBinder.NamedParameterSource {
    ...
    protected void prepareFromClauseInputTree(AST fromClauseInput) {
        if (!this.isSubQuery() && this.isFilter()) {
            ...
            AST fromElement = inputAstFactory.create(80, collectionElementEntityName);
            ASTUtil.createSibling(inputAstFactory, 74, "this", fromElement);
            ...
            ParameterNode collectionFilterKeyParameter = (ParameterNode)this.astFactory.create(130, "?");
    ...
    private AST generateSyntheticDotNodeForNonQualifiedPropertyRef(AST property, FromElement fromElement) {
        ...
        IdentNode syntheticAlias = (IdentNode)this.getASTFactory().create(110, "{synthetic-alias}");
    ...
    protected void postProcessInsert(AST insert) throws SemanticException, QueryException {
        ...
        if (!insertStatement.getIntoClause().isExplicitIdInsertion()) {
            ...
            if (fragment != null) {
                AST fragmentNode = this.getASTFactory().create(148, fragment);
        ...
        if (includeVersionProperty) {
            ...
            if (this.sessionFactoryHelper.getFactory().getDialect().supportsParametersInInsertSelect()) {
                ...
                versionValueNode = this.getASTFactory().create(130, "?");
                ...
                if (this.sessionFactoryHelper.getFactory().getDialect().requiresCastingOfParametersInSelectClause()) {
                    MethodNode versionMethodNode = (MethodNode)this.getASTFactory().create(85, "(");
                    AST methodIdentNode = this.getASTFactory().create(110, "cast");
                    versionMethodNode.addChild(methodIdentNode);
                    versionMethodNode.initializeMethodNode(methodIdentNode, true);
                    AST castExprListNode = this.getASTFactory().create(79, "exprList");
                    methodIdentNode.setNextSibling(castExprListNode);
                    castExprListNode.addChild(versionValueNode);
                    versionValueNode.setNextSibling(this.getASTFactory().create(110, this.sessionFactoryHelper.getFactory().getDialect().getTypeName(sqlTypes[0])));
                ...
                try {
                    ...
                    versionValueNode = this.getASTFactory().create(148, seedValue.toString());
                }
                catch (Throwable t) {
                ...
                versionValueNode = this.getASTFactory().create(148, functionName);
            } else {
        ...
        if (insertStatement.getIntoClause().isDiscriminated()) {
            ...
            AST discrimValue = this.getASTFactory().create(148, sqlValue);
    ...
    private void createSelectClauseFromFromClause(QueryNode qn) throws SemanticException {
        AST select = this.astFactory.create(143, "{derived select clause}");
    ...
    protected AST generatePositionalParameter(AST delimiterNode, AST numberNode) throws SemanticException {
        ...
        ParameterNode parameter = (ParameterNode)this.astFactory.create(130, positionString);
        parameter.setText("?");
    ...
    protected AST generateNamedParameter(AST delimiterNode, AST nameNode) throws SemanticException {
        ...
        ParameterNode parameter = (ParameterNode)this.astFactory.create(154, name);
        parameter.setText("?");
    ...
    protected boolean isOrderExpressionResultVariableRef(AST orderExpressionNode) throws SemanticException {
        return !this.isSubQuery() && orderExpressionNode.getType() == 110 && this.selectExpressionsByResultVariable.containsKey(orderExpressionNode.getText());
    }

    @Override
    protected boolean isGroupExpressionResultVariableRef(AST groupExpressionNode) throws SemanticException {
        return this.getDialect().supportsSelectAliasInGroupByClause() && !this.isSubQuery() && groupExpressionNode.getType() == 110 && this.selectExpressionsByResultVariable.containsKey(groupExpressionNode.getText());
    }
    ...
    protected void prepareVersioned(AST updateNode, AST versioned) throws SemanticException {
        ...
        if (versioned != null) {
            ...
            AST eq = this.getASTFactory().create(107, "=");
            ...
            if (this.isTimestampBasedVersion(versionType)) {
                versionIncrementNode = this.getASTFactory().create(130, "?");
                VersionTypeSeedParameterSpecification paramSpec = new VersionTypeSeedParameterSpecification(versionType);
                ((ParameterNode)versionIncrementNode).setHqlParameterSpecification(paramSpec);
                this.parameterSpecs.add(0, paramSpec);
            } else {
                versionIncrementNode = this.getASTFactory().create(121, "+");
                versionIncrementNode.setFirstChild(this.generateVersionPropertyNode(persister));
                versionIncrementNode.addChild(this.getASTFactory().create(110, "1"));
            }
    ...
    private AST generateVersionPropertyNode(Queryable persister) throws SemanticException {
        ...
        AST versionPropertyRef = this.getASTFactory().create(110, versionPropertyName);
    ...
    public Dialect getDialect() {
        return this.sessionFactoryHelper.getFactory().getServiceRegistry().getService(JdbcServices.class).getDialect();
    }
