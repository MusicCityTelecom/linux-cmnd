...
implements BinaryOperatorNode {
    ...
    private boolean isNodeAcceptable(Node rhsNode) {
        return rhsNode == null || rhsNode instanceof LiteralNode || rhsNode instanceof ParameterNode || rhsNode.getType() == 97;
    }
    ...
    private void mutateRowValueConstructorSyntaxInInListSyntax(int lhsColumnSpan, int rhsColumnSpan) {
        ...
        boolean bl = negated = this.getType() == 87;
        if (rhsNode != null && rhsNode.getNextSibling() == null) {
            ...
            this.translate(lhsColumnSpan, negated ? 114 : 107, negated ? "<>" : "=", lhsElementTexts, rhsElementTexts, lhsEmbeddedCompositeParameterSpecification, rhsEmbeddedCompositeParameterSpecification, (AST)this);
        } else {
            ...
            for (rhsNode = (Node)this.getInList().getFirstChild(); rhsNode != null; rhsNode = (Node)rhsNode.getNextSibling()) {
                ...
                ParameterSpecification rhsEmbeddedCompositeParameterSpecification = rhsNode == null || !ParameterNode.class.isInstance((Object)rhsNode) ? null : ((ParameterNode)rhsNode).getHqlParameterSpecification();
                this.translate(lhsColumnSpan, negated ? 114 : 107, negated ? "<>" : "=", lhsElementTexts, rhsElementTexts, lhsEmbeddedCompositeParameterSpecification, rhsEmbeddedCompositeParameterSpecification, group);
