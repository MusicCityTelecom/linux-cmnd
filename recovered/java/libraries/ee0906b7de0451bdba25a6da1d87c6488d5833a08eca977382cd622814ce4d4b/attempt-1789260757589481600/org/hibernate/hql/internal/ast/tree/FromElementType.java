...
class FromElementType {
    ...
    private boolean isInsertQuery() {
        return this.fromElement.getWalker().getStatementType() == 29;
    }

    private boolean isUpdateQuery() {
        return this.fromElement.getWalker().getStatementType() == 50;
    }

    private boolean isManipulationQuery() {
        return this.fromElement.getWalker().getStatementType() == 50 || this.fromElement.getWalker().getStatementType() == 13;
    }

    private boolean inWhereClause() {
        return this.fromElement.getWalker().getCurrentTopLevelClauseType() == 52;
    }
