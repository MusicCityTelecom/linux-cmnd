...
implements SelectExpression {
    ...
    public final SelectClause getSelectClause() {
        return (SelectClause)ASTUtil.findTypeInChildren((AST)this, 143);
    }
    ...
    public final OrderByClause getOrderByClause() {
        if (this.orderByClause == null) {
            ...
            if (this.orderByClause == null) {
                ...
                this.orderByClause = (OrderByClause)this.getWalker().getASTFactory().create(41, "ORDER");
                AST prevSibling = ASTUtil.findTypeInChildren((AST)this, 52);
                if (prevSibling == null) {
