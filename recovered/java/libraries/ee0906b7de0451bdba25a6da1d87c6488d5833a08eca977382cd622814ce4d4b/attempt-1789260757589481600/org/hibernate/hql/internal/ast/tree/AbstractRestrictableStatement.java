...
implements RestrictableStatement {
    ...
    public final FromClause getFromClause() {
        if (this.fromClause == null) {
            this.fromClause = (FromClause)ASTUtil.findTypeInChildren((AST)this, 22);
        }
    ...
    public final AST getWhereClause() {
        if (this.whereClause == null) {
            ...
            if (this.whereClause == null) {
                ...
                this.whereClause = this.getWalker().getASTFactory().create(52, "WHERE");
    ...
    protected AST locateWhereClause() {
        return ASTUtil.findTypeInChildren((AST)this, 52);
    }
}
