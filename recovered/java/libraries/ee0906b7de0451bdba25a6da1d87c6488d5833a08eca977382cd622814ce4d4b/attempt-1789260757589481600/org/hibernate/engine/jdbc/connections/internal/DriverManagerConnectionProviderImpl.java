...
ConnectionValidator {
    ...
    private static ConnectionCreator buildCreator(Map configurationValues, ServiceRegistryImplementor serviceRegistry) {
        ConnectionCreatorBuilder connectionCreatorBuilder = new ConnectionCreatorBuilder(serviceRegistry);
        String driverClassName = (String)configurationValues.get("hibernate.connection.driver_class");
        connectionCreatorBuilder.setDriver(DriverManagerConnectionProviderImpl.loadDriverIfPossible(driverClassName, serviceRegistry));
