...
implements GraphImplementor<J> {
    ...
    protected AbstractGraph(boolean mutable, GraphImplementor<J> original) {
        ...
        original.visitAttributeNodes(node -> {
            AttributeNodeImplementor cfr_ignored_0 = (AttributeNodeImplementor)this.attrNodeMap.put((PersistentAttributeDescriptor<?, ?>)node.getAttributeDescriptor(), (AttributeNodeImplementor<?>)node.makeCopy(mutable));
        });
    }
