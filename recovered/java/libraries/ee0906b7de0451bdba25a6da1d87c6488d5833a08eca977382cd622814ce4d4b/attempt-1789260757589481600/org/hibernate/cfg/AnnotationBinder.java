...
public final class AnnotationBinder {
        ...
        block86: {
            ...
            if (property.isAnnotationPresent(Version.class)) {
                ...
                if (property.isAnnotationPresent(ManyToOne.class)) {
                    ...
                    AnnotationBinder.matchIgnoreNotFoundWithFetchType(propertyHolder.getEntityName(), property.getName(), ignoreNotFound, ann.fetch());
                    ...
                    AnnotationBinder.bindManyToOne(AnnotationBinder.getCascadeStrategy(ann.cascade(), hibernateCascade, false, forcePersist), joinColumns, !mandatory, ignoreNotFound, onDeleteCascade, ToOneBinder.getTargetEntity(inferredData, context), propertyHolder, inferredData, false, isIdentifierMapper, inSecondPass, propertyBinder, context);
                    ...
                    PropertyData propertyData2 = propertyData = isJPA2ForValueMapping ? inferredData : new WrappedInferredData(inferredData, "element");
                    if (property.isAnnotationPresent(javax.persistence.Column.class) || property.isAnnotationPresent(Formula.class)) {
                        ...
                        elementColumns = Ejb3Column.buildColumnFromAnnotation(new javax.persistence.Column[]{ann}, formulaAnn, (Comment)property.getAnnotation(Comment.class), nullability, propertyHolder, propertyData, entityBinder.getSecondaryTables(), context);
                    } else if (property.isAnnotationPresent(Columns.class)) {
                        Columns anns = (Columns)property.getAnnotation(Columns.class);
                        elementColumns = Ejb3Column.buildColumnFromAnnotation(anns.columns(), null, (Comment)property.getAnnotation(Comment.class), nullability, propertyHolder, propertyData, entityBinder.getSecondaryTables(), context);
                    } else {
                        elementColumns = Ejb3Column.buildColumnFromAnnotation(null, null, (Comment)property.getAnnotation(Comment.class), nullability, propertyHolder, propertyData, entityBinder.getSecondaryTables(), context);
                    }
                    ...
                    Ejb3Column[] mapColumns = Ejb3Column.buildColumnFromAnnotation(keyColumns, null, (Comment)property.getAnnotation(Comment.class), Nullability.FORCED_NOT_NULL, propertyHolder, isJPA2.booleanValue() ? inferredData : mapKeyVirtualProperty, isJPA2.booleanValue() ? "_KEY" : null, entityBinder.getSecondaryTables(), context);
                    ...
                    Ejb3JoinColumn[] mapJoinColumns = Ejb3JoinColumn.buildJoinColumnsWithDefaultColumnSuffix(joinKeyColumns, (Comment)property.getAnnotation(Comment.class), null, entityBinder.getSecondaryTables(), propertyHolder, isJPA2.booleanValue() ? inferredData.getPropertyName() : mapKeyVirtualProperty.getPropertyName(), isJPA2.booleanValue() ? "_KEY" : null, context);
                    ...
                    AnnotationBinder.bindJoinedTableAssociation(property, context, entityBinder, collectionBinder, propertyHolder, inferredData, mappedBy);
                    OnDelete onDeleteAnn = (OnDelete)property.getAnnotation(OnDelete.class);
                    boolean onDeleteCascade = onDeleteAnn != null && OnDeleteAction.CASCADE.equals((Object)onDeleteAnn.action());
    ...
    private static void bindOneToOne(String cascadeStrategy, Ejb3JoinColumn[] joinColumns, boolean optional, FetchMode fetchMode, boolean ignoreNotFound, boolean cascadeOnDelete, XClass targetEntity, PropertyHolder propertyHolder, PropertyData inferredData, String mappedBy, boolean trueOneToOne, boolean isIdentifierMapper, boolean inSecondPass, PropertyBinder propertyBinder, MetadataBuildingContext context) {
        ...
        if (trueOneToOne || mapToPK || !BinderHelper.isEmptyAnnotationValue(mappedBy)) {
            ...
            AnnotationBinder.bindManyToOne(cascadeStrategy, joinColumns, optional, ignoreNotFound, cascadeOnDelete, targetEntity, propertyHolder, inferredData, true, isIdentifierMapper, inSecondPass, propertyBinder, context);
        }
    }
    ...
    private static void matchIgnoreNotFoundWithFetchType(String entity, String association, boolean ignoreNotFound, FetchType fetchType) {
