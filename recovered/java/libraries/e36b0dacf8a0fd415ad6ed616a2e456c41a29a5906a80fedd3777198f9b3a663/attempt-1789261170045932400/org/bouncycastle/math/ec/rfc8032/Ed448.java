...
public abstract class Ed448 {
    ...
    private static void pointLookup15(int[] nArray, PointExt pointExt) {
        int n = 336;
        F.copy(nArray, n, pointExt.x, 0);
        F.copy(nArray, n += 16, pointExt.y, 0);
        F.copy(nArray, n += 16, pointExt.z, 0);
    }
    ...
    private static void scalarMult(byte[] byArray, PointExt pointExt, PointExt pointExt2) {
        int[] nArray = new int[14];
        Ed448.decodeScalar(byArray, 0, nArray);
        int n = Nat.cadd(14, ~nArray[0] & 1, nArray, L, nArray);
        Nat.shiftDownBit(14, nArray, n);
        int[] nArray2 = Ed448.pointPrecompute(pointExt, 8);
        PointExt pointExt3 = new PointExt();
        Ed448.pointLookup15(nArray2, pointExt2);
        Ed448.pointAdd(pointExt, pointExt2);
        int n2 = 111;
        block0: while (true) {
            Ed448.pointLookup(nArray, n2, nArray2, pointExt3);
            Ed448.pointAdd(pointExt3, pointExt2);
            if (--n2 < 0) break;
            int n3 = 0;
            while (true) {
