...
implements GroovyObject {
    ...
    public ConfigObject parse(Properties properties) {
        ...
        if (iterator != null) {
            while (iterator.hasNext()) {
                key = iterator.next();
                callSiteArray[11].callCurrent(this, key, config, properties);
            }
        }
        return config;
    }

    private void parseKey(Object key, ConfigObject config, Properties properties) {
        CallSite[] callSiteArray = ConfigSlurper.$getCallSiteArray();
        Object tokens = callSiteArray[12].call(key, "\\.");
        ...
        Object token = null;
        Iterator iterator = (Iterator)ScriptBytecodeAdapter.castToType(callSiteArray[13].call(tokens), Iterator.class);
        if (iterator != null) {
            while (iterator.hasNext()) {
                Object object;
                token = iterator.next();
                if (DefaultTypeTransformation.booleanUnbox(foundBase)) {
                    callSiteArray[14].call(lastToken, callSiteArray[15].call((Object)".", (Object)token));
                    Object var12_12 = last.get();
                    current = var12_12;
                    continue;
                }
                ConfigObject configObject = current;
                last.set(configObject);
                Object var14_14 = token;
                lastToken = var14_14;
        ...
        if (current instanceof ConfigObject) {
            if (DefaultTypeTransformation.booleanUnbox(callSiteArray[16].call(last.get(), lastToken))) {
                Object flattened = callSiteArray[17].call(last.get());
                callSiteArray[18].call(last.get());
                public final class _parseKey_closure1
                extends Closure
                implements GeneratedClosure {
                    ...
                    public _parseKey_closure1(Object _outerInstance, Object _thisObject, Reference last) {
                        Reference reference;
                        CallSite[] callSiteArray = _parseKey_closure1.$getCallSiteArray();
                    ...
                    protected /* synthetic */ MetaClass $getStaticMetaClass() {
                        if (this.getClass() != _parseKey_closure1.class) {
                    ...
                    private static /* synthetic */ CallSiteArray $createCallSiteArray() {
                        ...
                        _parseKey_closure1.$createCallSiteArray_1(stringArray);
                        return new CallSiteArray(_parseKey_closure1.class, stringArray);
                    }

                    private static /* synthetic */ CallSite[] $getCallSiteArray() {
                        CallSiteArray callSiteArray;
                        if ($callSiteArray == null || (callSiteArray = (CallSiteArray)$callSiteArray.get()) == null) {
                            callSiteArray = _parseKey_closure1.$createCallSiteArray();
                            $callSiteArray = new SoftReference<CallSiteArray>(callSiteArray);
                        }
                        return callSiteArray.array;
                    }
                }
                callSiteArray[19].call(flattened, new _parseKey_closure1(this, this, last));
                Object object = callSiteArray[20].call((Object)properties, key);
                callSiteArray[21].call(last.get(), lastToken, object);
            } else {
                Object object = callSiteArray[22].call((Object)properties, key);
                callSiteArray[23].call(last.get(), lastToken, object);
            }
        }
    }
    ...
    public ConfigObject parse(String script) {
        CallSite[] callSiteArray = ConfigSlurper.$getCallSiteArray();
        return (ConfigObject)ScriptBytecodeAdapter.castToType(callSiteArray[24].callCurrent((GroovyObject)this, callSiteArray[25].call((Object)this.classLoader, script)), ConfigObject.class);
    }

    public ConfigObject parse(Class scriptClass) {
        CallSite[] callSiteArray = ConfigSlurper.$getCallSiteArray();
        return (ConfigObject)ScriptBytecodeAdapter.castToType(callSiteArray[26].callCurrent((GroovyObject)this, callSiteArray[27].call(scriptClass)), ConfigObject.class);
    }

    public ConfigObject parse(Script script) {
        CallSite[] callSiteArray = ConfigSlurper.$getCallSiteArray();
        return (ConfigObject)ScriptBytecodeAdapter.castToType(callSiteArray[28].callCurrent(this, script, null), ConfigObject.class);
    }

    public ConfigObject parse(URL scriptLocation) {
        CallSite[] callSiteArray = ConfigSlurper.$getCallSiteArray();
        return (ConfigObject)ScriptBytecodeAdapter.castToType(callSiteArray[29].callCurrent(this, callSiteArray[30].call(callSiteArray[31].call((Object)this.classLoader, callSiteArray[32].callGetProperty(scriptLocation))), scriptLocation), ConfigObject.class);
    }

    public ConfigObject parse(Script script, URL location) {
        CallSite[] callSiteArray = ConfigSlurper.$getCallSiteArray();
        Reference<Stack> currentConditionalBlock = new Reference<Stack>((Stack)ScriptBytecodeAdapter.castToType(callSiteArray[33].callConstructor(Stack.class), Stack.class));
        Reference<ConfigObject> config = new Reference<ConfigObject>(DefaultTypeTransformation.booleanUnbox(location) ? (ConfigObject)ScriptBytecodeAdapter.castToType(callSiteArray[34].callConstructor(ConfigObject.class, location), ConfigObject.class) : (ConfigObject)ScriptBytecodeAdapter.castToType(callSiteArray[35].callConstructor(ConfigObject.class), ConfigObject.class));
        callSiteArray[36].call(callSiteArray[37].callGetProperty(GroovySystem.class), callSiteArray[38].callGroovyObjectGetProperty(script));
        Reference<Object> mc = new Reference<Object>(callSiteArray[39].callGetProperty(callSiteArray[40].callGroovyObjectGetProperty(script)));
        Reference<String> prefix = new Reference<String>("");
        Reference<LinkedList> stack = new Reference<LinkedList>((LinkedList)ScriptBytecodeAdapter.castToType(callSiteArray[41].callConstructor(LinkedList.class), LinkedList.class));
        callSiteArray[42].call((Object)stack.get(), ScriptBytecodeAdapter.createMap(new Object[]{"config", config.get(), "scope", ScriptBytecodeAdapter.createMap(new Object[0])}));
        public final class _parse_closure2
        extends Closure
        implements GeneratedClosure {
        ...
        public final class _parse_closure3
        extends Closure
        implements GeneratedClosure {
            private /* synthetic */ Reference stack;
            private static /* synthetic */ ClassInfo $staticClassInfo;
        ...
        public final class _parse_closure4
        extends Closure
        implements GeneratedClosure {
            private /* synthetic */ Reference stack;
        ...
        Reference<ConfigObject> overrides = new Reference<ConfigObject>((ConfigObject)ScriptBytecodeAdapter.castToType(callSiteArray[43].callConstructor(ConfigObject.class), ConfigObject.class));
        public final class _parse_closure5
        extends Closure
        implements GeneratedClosure {
                    ...
                    block15: {
                        ...
                        block18: {
                            block16: {
                                ...
                                result = null;
                                if (!(ScriptBytecodeAdapter.compareEqual(callSiteArray[0].callGetProperty(args), 1) && callSiteArray[1].call(args, 0) instanceof Closure)) break block15;
                                if (!ScriptBytecodeAdapter.isCase(name, callSiteArray[2].call(callSiteArray[3].callGroovyObjectGetProperty(this)))) break block16;
                                try {
                            ...
                            if (!ScriptBytecodeAdapter.compareGreaterThan(callSiteArray[27].call(this.currentConditionalBlock.get()), 0)) break block18;
                            String conditionalBlockKey = ShortTypeHandling.castToString(callSiteArray[28].call(this.currentConditionalBlock.get()));
                            if (!ScriptBytecodeAdapter.compareEqual(name, callSiteArray[29].call(callSiteArray[30].callGroovyObjectGetProperty(this), conditionalBlockKey))) break block17;
        ...
        public final class _parse_closure6
        extends Closure
        implements GeneratedClosure {
            private /* synthetic */ Reference assignName;
            private /* synthetic */ Reference prefix;
        ...
        Object binding = callSiteArray[44].callConstructor(ConfigBinding.class, setProperty);
        if (DefaultTypeTransformation.booleanUnbox(this.bindingVars)) {
            callSiteArray[45].call(callSiteArray[46].callGetProperty(binding), this.bindingVars);
        }
        Object object2 = binding;
        ScriptBytecodeAdapter.setGroovyObjectProperty(object2, ConfigSlurper.class, script, "binding");
        callSiteArray[47].call(script);
        callSiteArray[48].call((Object)config.get(), overrides.get());
    ...
    private static /* synthetic */ void $createCallSiteArray_1(String[] stringArray) {
        ...
        stringArray[27] = "newInstance";
        stringArray[28] = "parse";
        stringArray[29] = "parse";
        stringArray[30] = "newInstance";
        stringArray[31] = "parseClass";
        stringArray[32] = "text";
        stringArray[33] = "<$constructor$>";
        stringArray[34] = "<$constructor$>";
        stringArray[35] = "<$constructor$>";
        stringArray[36] = "removeMetaClass";
        stringArray[37] = "metaClassRegistry";
        stringArray[38] = "class";
        stringArray[39] = "metaClass";
        stringArray[40] = "class";
        stringArray[41] = "<$constructor$>";
        stringArray[42] = "leftShift";
        stringArray[43] = "<$constructor$>";
        stringArray[44] = "<$constructor$>";
        stringArray[45] = "putAll";
        stringArray[46] = "variables";
        stringArray[47] = "run";
        stringArray[48] = "merge";
    }
