...
public @interface ToString {
    ...
    public boolean allProperties() default true;
    ...
    public String leftDelimiter() default "(";

    public String rightDelimiter() default ")";

    public String nameValueSeparator() default ":";
