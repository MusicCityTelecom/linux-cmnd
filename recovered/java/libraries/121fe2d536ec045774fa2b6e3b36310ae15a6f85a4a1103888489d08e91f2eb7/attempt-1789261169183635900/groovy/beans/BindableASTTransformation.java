...
Opcodes {
    ...
    private static void wrapSetterMethod(ClassNode classNode, PropertyNode propertyNode) {
        ...
        if (setter != null) {
            ...
            block.addStatement(GeneralUtils.stmt(GeneralUtils.callThisX("firePropertyChange", GeneralUtils.args(GeneralUtils.constX(propertyNode.getName()), oldValue, newValue))));
    ...
    private void createListenerSetter(ClassNode classNode, PropertyNode propertyNode) {
        ...
        if (classNode.getMethods(setterName).isEmpty()) {
            ...
            BindableASTTransformation.wrapSetterMethod(classNode, propertyNode);
        }
    }
