...
public abstract class ATNState {
    ...
    protected List<Transition> optimizedTransitions = this.transitions;
    ...
    public int getNumberOfOptimizedTransitions() {
        return this.optimizedTransitions.size();
    }

    public Transition getOptimizedTransition(int i) {
        return this.optimizedTransitions.get(i);
    }

    public void addOptimizedTransition(Transition e) {
        if (!this.isOptimized()) {
            this.optimizedTransitions = new ArrayList<Transition>();
        }
    ...
    public void setOptimizedTransition(int i, Transition e) {
        ...
        this.optimizedTransitions.set(i, e);
    }
    ...
    public void removeOptimizedTransition(int i) {
        ...
        this.optimizedTransitions.remove(i);
    }
}
