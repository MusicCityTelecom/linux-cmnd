...
import org.glassfish.jersey.internal.guava.AbstractIterator;
...
import org.glassfish.jersey.internal.guava.ForwardingMapEntry;
    ...
    extends Maps.ImprovedAbstractMap<R, V> {
        ...
        boolean removeFromColumnIf(Predicate<? super Map.Entry<R, V>> predicate) {
            ...
            while (iterator.hasNext()) {
                ...
                if (value == null || !predicate.test(Maps.immutableEntry(entry.getKey(), value))) continue;
