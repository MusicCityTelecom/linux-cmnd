...
ResourceService.WelcomeFactory {
    ...
    public String getWelcomeFile(String pathInContext) {
        ...
        for (String s : this._welcomes) {
            ...
            if (!this._welcomeServlets && !this._welcomeExactServlets || welcomeServlet != null || (entry = this._servletHandler.getMappedServlet(welcomeInContext)) == null || entry.getResource().getServletInstance() == this || !this._welcomeServlets && (!this._welcomeExactServlets || !entry.getPathSpec().getDeclaration().equals(welcomeInContext))) continue;
