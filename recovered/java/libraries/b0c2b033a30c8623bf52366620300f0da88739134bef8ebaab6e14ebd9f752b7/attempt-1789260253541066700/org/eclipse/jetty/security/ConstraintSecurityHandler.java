...
implements ConstraintAware {
    ...
    public void setConstraintMappings(List<ConstraintMapping> constraintMappings, Set<String> roles) {
        ...
        this.setRoles(roles);
        if (this.isStarted()) {
            this._constraintMappings.stream().forEach(m -> this.processConstraintMapping((ConstraintMapping)m));
        }
    }
    ...
    public void dump(Appendable out, String indent) throws IOException {
        this.dumpObjects(out, indent, DumpableCollection.from("roles", this._roles), DumpableCollection.from("constraints", this._constraintMap.entrySet()));
    }
