...
class ContextFinder {
    ...
    static JAXBContext find(String factoryId, String contextPath, ClassLoader classLoader, Map properties) throws JAXBException {
        ...
        return ContextFinder.newInstance(contextPath, contextPathClasses, "com.sun.xml.internal.bind.v2.ContextFactory", classLoader, properties);
    }
    ...
    static JAXBContext find(Class<?>[] classes, Map<String, ?> properties) throws JAXBException {
        ...
        logger.fine("Trying to create the platform default provider");
        return ContextFinder.newInstance((Class[])classes, properties, "com.sun.xml.internal.bind.v2.ContextFactory");
    }
