...
extends ClientErrorException {
    ...
    public ForbiddenException(Response response) {
        super(ForbiddenException.validate(response, Response.Status.FORBIDDEN));
    }

    public ForbiddenException(String message, Response response) {
        super(message, ForbiddenException.validate(response, Response.Status.FORBIDDEN));
    }
    ...
    public ForbiddenException(Response response, Throwable cause) {
        super(ForbiddenException.validate(response, Response.Status.FORBIDDEN), cause);
    }

    public ForbiddenException(String message, Response response, Throwable cause) {
        super(message, ForbiddenException.validate(response, Response.Status.FORBIDDEN), cause);
    }
}
