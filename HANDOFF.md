...
Tests: 18 unit/integration tests pass on Python 3.9.7. Static `innounp` 0.50 integrity and full extraction both returned exit 0; the isolated extracted copy contains all five WARs. Private reports/staging remain ignored.
