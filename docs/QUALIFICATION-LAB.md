...
Development checkpoint: 2026-09-08 UTC, tooling 0.3.0. This is not a production acceptance report.

## Environment

A new, disposable VirtualBox VM, `CMND-Ubuntu24-Qualification-20260908`, runs Ubuntu 24.04 amd64 with 8 GiB RAM, four virtual CPUs, and a 40 GiB virtual disk. No server4 or production-TV connection was made. Windows host networking was not changed. VM NAT forwards bind to Windows loopback only.
...
Startup took approximately 440 seconds in this VM. Readiness checks must inspect application responses and actual migration history; SmartInstall catches migration exceptions and can appear started anyway.
